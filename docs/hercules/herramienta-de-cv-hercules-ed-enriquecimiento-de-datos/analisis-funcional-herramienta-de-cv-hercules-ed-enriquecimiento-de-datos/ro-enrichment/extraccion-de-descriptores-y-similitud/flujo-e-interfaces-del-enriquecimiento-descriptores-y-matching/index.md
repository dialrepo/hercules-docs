...
* [Introducción](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-Introducción)
* [Extracción de descriptores](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-Extraccióndedescriptores)
  + [Taxonomías para descriptores temáticos](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-Taxonomíasparadescriptorestemáticos)
  + [Extracción en ROs de fuentes externas](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-ExtracciónenROsdefuentesexternas)
  + [ROs introducidos por el usuario](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-ROsintroducidosporelusuario)
  + [ROs procesados masivamente](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-ROsprocesadosmasivamente)
* [Matching](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-Matching)
  + [Configuración y Funcionamiento](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-ConfiguraciónyFuncionamiento)
  + [Presentación y uso del matching](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-Presentaciónyusodelmatching)
  + [Implementación de Matching (entity linking)](#Flujoeinterfacesdelenriquecimiento.DescriptoresyMatching-ImplementacióndeMatching(entitylinking))
...
* Extracción de descriptores temáticos, alineados con la [taxonomía unificada](/hercules/herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/analisis-funcional-herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/ro-enrichment/taxonomia-unificada-de-descriptores-tematicos-para-hercules)
...
* Las fuentes consultadas en la elaboración de la taxonomía están descritas en el [Análisis de taxonomías (](https://confluence.um.es/confluence/pages/viewpage.action?pageId=222822823)[Confluence](https://confluence.um.es/confluence/pages/viewpage.action?pageId=222822823)[).](https://confluence.um.es/confluence/pages/viewpage.action?pageId=222822823)
* El proceso de unificación y su resultado se puede consultar en [Taxonomía unificada de descriptores temáticos para Hércules (](https://confluence.um.es/confluence/pages/viewpage.action?pageId=306774073)[Confluence](https://confluence.um.es/confluence/pages/viewpage.action?pageId=306774073)[).](https://confluence.um.es/confluence/pages/viewpage.action?pageId=306774073)
...
* SPARQL Enpoint. Ver descripción en [About - AGROVOC Thesaurus - Organizations - "FAO catalog"](https://data.apps.fao.org/catalog/organization/about/agrovoc)
