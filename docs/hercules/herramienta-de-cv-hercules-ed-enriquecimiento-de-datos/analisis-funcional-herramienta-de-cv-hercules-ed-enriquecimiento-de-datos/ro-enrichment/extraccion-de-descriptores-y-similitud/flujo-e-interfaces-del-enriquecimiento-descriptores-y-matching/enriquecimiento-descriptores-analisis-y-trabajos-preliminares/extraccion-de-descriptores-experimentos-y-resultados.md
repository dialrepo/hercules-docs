# Extracción de descriptores. Experimentos y resultados

* [Preparación de datasets](#Extraccióndedescriptores.Experimentosyresultados-Preparacióndedatasets)
  + [Dataset de ROs de bioprotocolos](#Extraccióndedescriptores.Experimentosyresultados-DatasetdeROsdebioprotocolos)
  + [Dataset de descripciones de proyectos de código](#Extraccióndedescriptores.Experimentosyresultados-Datasetdedescripcionesdeproyectosdecódigo)
  + [Dataset de artículos científicos](#Extraccióndedescriptores.Experimentosyresultados-Datasetdeartículoscientíficos)
* [Entrenamiento y evaluación de clasificadores multi-etiqueta para identificación de descriptores temáticos](#Extraccióndedescriptores.Experimentosyresultados-Entrenamientoyevaluacióndeclasificadoresmulti-etiquetaparaidentificacióndedescriptorestemáticos)
* [Entrenamiento y evaluación de sistema para identificación de descriptores específicos](#Extraccióndedescriptores.Experimentosyresultados-Entrenamientoyevaluacióndesistemaparaidentificacióndedescriptoresespecíficos)
...
Se ha creado un dataset mediante scraping de las páginas de [bio-protocol.org](http://bio-protocol.org). Hemos recuperado 6.473 protocolos, obteniendo los siguientes metadatos para cada uno de ellos: título, autores, DOI, publicación, resumen, palabras clave, background, materiales, equipamiento, software, procedimiento, análisis de datos, notas, recetas, reconocimientos, declaración de intereses, ética, referencias y categorías.
...
Se ha creado un dataset que incluye descripciones de proyectos de código enlazados con los correspondientes descriptores temáticos (21) a partir de [sourceforge.net](http://sourceforge.net). En un primer paso, se han descargado los nombres de los proyectos alojados en sourceforge mediante scraping a partir del directorio <https://sourceforge.net/directory>. Posteriormente, se han obtenido los metadatos (que incluyen los descriptores temáticos) de cada nombre utilizando el API [sourceforge.net/projects/codeblocks](http://sourceforge.net/projects/codeblocks).). Se muestra, a continuación, las estadísticas para los descriptores de primer nivel:
