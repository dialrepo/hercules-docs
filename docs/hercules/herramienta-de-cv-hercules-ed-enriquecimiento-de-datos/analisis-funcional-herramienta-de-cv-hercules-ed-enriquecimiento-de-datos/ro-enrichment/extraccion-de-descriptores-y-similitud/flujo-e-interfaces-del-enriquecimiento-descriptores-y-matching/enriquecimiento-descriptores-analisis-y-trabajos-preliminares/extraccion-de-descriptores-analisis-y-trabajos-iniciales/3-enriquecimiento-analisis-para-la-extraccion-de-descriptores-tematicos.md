...
* [3.1 Análisis de taxonomías](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.1Análisisdetaxonomías)
  + [3.1.1 Publicaciones o artículos científicos](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.1.1Publicacionesoartículoscientíficos)
    - [ASJC de Scopus](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-ASJCdeScopus)
      * [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento)
    - [LCC de DOAJ](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-LCCdeDOAJ)
      * [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento.1)
    - [Clasificación de la plataforma de datos de la BNE](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-ClasificacióndelaplataformadedatosdelaBNE)
      * [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento.2)
    - [Nomenclatura de Ciencia y Tecnología de la UNESCO](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-NomenclaturadeCienciayTecnologíadelaUNESCO)
      * [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento.3)
    - [Clasificaciones de la Web of Science](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-ClasificacionesdelaWebofScience)
      * [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento.4)
  + [3.1.2 Taxonomías para protocolos](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.1.2Taxonomíasparaprotocolos)
    - [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento.5)
  + [3.1.3 Taxonomías para proyectos de código](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.1.3Taxonomíasparaproyectosdecódigo)
    - [Dataset de entrenamiento](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-Datasetdeentrenamiento.6)
  + [3.1.4 Comparación de taxonomías](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.1.4Comparacióndetaxonomías)
  + [3.1.5 Conclusiones sobre la comparación de taxonomías](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.1.5Conclusionessobrelacomparacióndetaxonomías)
* [3.2 Enfoques para extracción de descriptores temáticos de ROs](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.2EnfoquesparaextraccióndedescriptorestemáticosdeROs)
  + [3.2.1 Extracción de descriptores temáticos a partir de APIs](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.2.1ExtraccióndedescriptorestemáticosapartirdeAPIs)
    - [APIs de la Web of Science](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-APIsdelaWebofScience)
    - [Otras fuentes de datos vía API](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-OtrasfuentesdedatosvíaAPI)
  + [3.2.2 Extracción de descriptores temáticos vía web scraping](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.2.2Extraccióndedescriptorestemáticosvíawebscraping)
  + [3.2.3 Extracción de descriptores temáticos mediante un clasificador supervisado](#id-3.Enriquecimiento.Análisisparalaextraccióndedescriptorestemáticos-3.2.3Extraccióndedescriptorestemáticosmedianteunclasificadorsupervisado)
...
[Bio-protocol.org](http://Bio-protocol.org)**15** usa descriptores específicos de texto libre y dispone de una categorización de hasta 3 niveles.
...
Existen otras iniciativas como [Protocols.io](http://Protocols.io)**18** que ofrece una API**19** para consultar su repositorio de protocolos, pero aparentemente no dispone de ninguna clasificación para los mismos ni almacena ningún metadato sobre áreas de conocimiento.
...
Dos de las fuentes identificadas para protocolos, [Protocol Exchange](https://protocolexchange.researchsquare.com/) y [bio-protocol](https://bio-protocol.org/default.aspx), carecen de un API del que recuperar la información del RO reclamado por el usuario. De partida, esto obliga a realizar un proceso de scraping para obtener la información del RO en estas fuentes, lo que se aprovechará para obtener los descriptores temáticos de las dos fuentes indicadas, siempre que mantengan las condiciones y permisos de reutilización actuales. En Protocol Exchange las condiciones dependen de cada protocolo, mientras que todo [el contenido de bio-protocols es Open Access](https://bio-protocol.org/Copyright_Permissions.aspx).
