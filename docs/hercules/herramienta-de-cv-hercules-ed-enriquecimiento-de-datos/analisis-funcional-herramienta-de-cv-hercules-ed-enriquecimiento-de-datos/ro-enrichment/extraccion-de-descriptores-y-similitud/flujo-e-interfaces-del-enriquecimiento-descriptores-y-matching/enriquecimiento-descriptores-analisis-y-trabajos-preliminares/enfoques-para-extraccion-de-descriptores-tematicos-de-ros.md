# Enfoques para extracción de descriptores temáticos de ROs
...
* [2.1 Extracción de descriptores temáticos a partir de APIs](#EnfoquesparaextraccióndedescriptorestemáticosdeROs-2.1ExtraccióndedescriptorestemáticosapartirdeAPIs)
  + [2.1.1 APIs de la Web of Science](#EnfoquesparaextraccióndedescriptorestemáticosdeROs-2.1.1APIsdelaWebofScience)
  + [2.1.2 Otras fuentes de datos vía API](#EnfoquesparaextraccióndedescriptorestemáticosdeROs-2.1.2OtrasfuentesdedatosvíaAPI)
* [2.2 Extracción de descriptores temáticos vía web scraping](#EnfoquesparaextraccióndedescriptorestemáticosdeROs-2.2Extraccióndedescriptorestemáticosvíawebscraping)
* [2.3 Extracción de descriptores temáticos mediante un clasificador supervisado](#EnfoquesparaextraccióndedescriptorestemáticosdeROs-2.3Extraccióndedescriptorestemáticosmedianteunclasificadorsupervisado)
* [2.4 Propuesta](#EnfoquesparaextraccióndedescriptorestemáticosdeROs-2.4Propuesta)
...
Tras realizar una búsqueda en la web y encontrar lo que parece ser una versión más reciente de WoS-RA[[1]](#_ftn1) en la que aparecen los valores contenidos en los “subject” con “ascatype=traditional”, pero con 2 categorías más (254), y otra clasificación en áreas de investigación parecidas a las de IPRA[[2]](#_ftn2), parece que los valores de los elementos “subheading” se corresponden con las 5 “research areas” de la columna derecha de la siguiente tabla:
...
[[1]](#_ftnref1) <https://images.webofknowledge.com/WOKRS56B5/help/WOS/hp_subject_category_terms_tasca.html>

[[2]](#_ftnref2) <https://images.webofknowledge.com/images/help/WOS/hp_research_areas_easca.html>