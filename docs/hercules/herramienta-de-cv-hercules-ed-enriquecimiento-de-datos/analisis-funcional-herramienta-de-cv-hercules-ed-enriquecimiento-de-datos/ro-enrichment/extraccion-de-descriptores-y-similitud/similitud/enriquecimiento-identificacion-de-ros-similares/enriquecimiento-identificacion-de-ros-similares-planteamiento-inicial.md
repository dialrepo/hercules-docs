# Enriquecimiento. Identificación de ROs similares. Planteamiento inicial

El contenido de este apartado es:

* [1 Descripción de módulo de identificación de ROs similares](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-1DescripcióndemódulodeidentificacióndeROssimilares)
* [2. Estimación de similitud semántica entre contenidos textuales](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-2.Estimacióndesimilitudsemánticaentrecontenidostextuales)
* [3 Identificación de descriptores relevantes a relación de similitud entre dos contenidos textuales](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-3Identificacióndedescriptoresrelevantesarelacióndesimilitudentredoscontenidostextuales)
* [4 Trabajos a realizar y planificación](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-4Trabajosarealizaryplanificación)
  + [Implementación de enfoques para similitud semántica](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-Implementacióndeenfoquesparasimilitudsemántica)
  + [Implementación de extracción de descriptores relevantes en relación de similitud](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-Implementacióndeextraccióndedescriptoresrelevantesenrelacióndesimilitud)
  + [Evaluación cualitativa de descriptores relevantes en relaciones de similitud](#Enriquecimiento.IdentificacióndeROssimilares.Planteamientoinicial-Evaluacióncualitativadedescriptoresrelevantesenrelacionesdesimilitud)
...
* Representación de texto basado en entidades de base de conocimiento multilingüe (BCM) y BM25 para similitud. Para implementar esta estrategia reutilizaremos el software ICTdocsim[[i]](#_edn1) financiado por el Plan de Impulso de las Tecnologías del Lenguaje del Gobierno de España.
...
[[i]](#_ednref1) <https://www.plantl.gob.es/tecnologias-lenguaje/actividades/desarrollos/Paginas/vigilancia-tecnologica.aspx>