...
* [add\_ro (POST)](#APIdeSimilitud-add_ro(POST))
* [query\_similar (GET)](#APIdeSimilitud-query_similar(GET))

El API de Similitud y su documentación se mantienen en el repositorio GiitHub del proyecto:

[HerculesED/src/Hercules.ED.Enrichment/Similitud at main · HerculesCRUE/HerculesED (github.com)](https://github.com/HerculesCRUE/HerculesED/tree/main/src/Hercules.ED.Enrichment/Similitud)

Los métodos del API son:

### [add\_ro (POST)](https://github.com/HerculesCRUE/HerculesED/tree/main/src/Hercules.ED.Enrichment/Similitud#add_ro-post)
...
### [query\_similar (GET)](https://github.com/HerculesCRUE/HerculesED/tree/main/src/Hercules.ED.Enrichment/Similitud#query_similar-get)
