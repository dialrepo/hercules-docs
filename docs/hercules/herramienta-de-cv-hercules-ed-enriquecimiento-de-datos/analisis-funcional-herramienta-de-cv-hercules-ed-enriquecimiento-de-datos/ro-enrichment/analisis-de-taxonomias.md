...
* [1.1 Publicaciones o artículos científicos](#Análisisdetaxonomías-1.1Publicacionesoartículoscientíficos)
  + [1.1.1 ASJC de Scopus](#Análisisdetaxonomías-1.1.1ASJCdeScopus)
    - [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento)
  + [1.1.2 LCC de DOAJ](#Análisisdetaxonomías-1.1.2LCCdeDOAJ)
    - [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento.1)
  + [1.1.3 Clasificación de la plataforma de datos de la BNE](#Análisisdetaxonomías-1.1.3ClasificacióndelaplataformadedatosdelaBNE)
    - [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento.2)
  + [1.1.4 Nomenclatura de Ciencia y Tecnología de la UNESCO](#Análisisdetaxonomías-1.1.4NomenclaturadeCienciayTecnologíadelaUNESCO)
    - [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento.3)
  + [1.1.5 Clasificaciones de la Web of Science](#Análisisdetaxonomías-1.1.5ClasificacionesdelaWebofScience)
    - [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento.4)
* [1.2 Taxonomías para protocolos](#Análisisdetaxonomías-1.2Taxonomíasparaprotocolos)
  + [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento.5)
* [1.3 Taxonomías para proyectos de código](#Análisisdetaxonomías-1.3Taxonomíasparaproyectosdecódigo)
  + [Dataset de entrenamiento](#Análisisdetaxonomías-Datasetdeentrenamiento.6)
* [1.4 Comparación de taxonomías](#Análisisdetaxonomías-1.4Comparacióndetaxonomías)
* [1.5 Conclusiones sobre la comparación de taxonomías](#Análisisdetaxonomías-1.5Conclusionessobrelacomparacióndetaxonomías)
* [1.6 Actualización de las conclusiones sobre la comparación de taxonomías](#Análisisdetaxonomías-1.6Actualizacióndelasconclusionessobrelacomparacióndetaxonomías)
...
Dispone de una taxonomía basada en 5 áreas temáticas (Physical Sciences, Health Sciences, Social Sciences, Life Sciences y Multidisciplinary) con una clasificación de primer nivel de 27 entradas[[1]](#_ftn1) y un segundo nivel de 307 entradas[[2]](#_ftn2).
...
Existen dos clasificaciones: la Nomenclatura de Ciencia y Tecnología de la UNESCO[[5]](#_ftn5) y el Tesauro de la UNESCO[[6]](#_ftn6), ambas con 3 niveles.
...
Dos de los repositorios de código más utilizados por la comunidad científica y que son mencionados en el pliego de HERCULES son GitHub[[20]](#_ftn20) y Bitbucket[[21]](#_ftn21).

GitHub solamente usa descriptores específicos de texto libre que denomina “topics”[[22]](#_ftn22) para clasificar y realizar búsquedas de repositorios de código. Este metadato y otros pueden ser recuperados a través de su API[[23]](#_ftn23).

Bitbucket parece que no utiliza ninguna clasificación. En la descripción de su API[[24]](#_ftn24) tampoco aparece ningún metadato sobre un repositorio que se pueda interpretar como elemento de clasificación.

Sin embargo, en SourceForge[[25]](#_ftn25) sí parece que se utiliza una clasificación de varios niveles para el catálogo de aplicaciones que ofrece, dado que en su directorio permite realizar búsquedas por categorías[[26]](#_ftn26). No hemos encontrado documentación sobre el número de niveles ni sobre el número de categorías en cada nivel.
...
| ASJC - Scopus | ·      Clasificación significativa de categorías.  ·      Dataset disponible para publicaciones y protocolos. | 2 | Nivel 1: 27  Nivel 2: 307 | 2020 | Scopus y otras aplicaciones de Elsevier |
| LCC - DOAJ | ·      Categorías muy generales hasta el nivel 2.  ·      Dataset de publicaciones a elaborar mediante web scrapping. | 5 | Nivel 1: 21 Nivel 2: 228 | 2021 | DOAJ |
| Clasificación de la plataforma de datos de la BNE | ·      Categorías muy genéricas y planas.  ·      Dataset de publicaciones a elaborar y quizá de baja calidad. | ¿3? | Difícil de saber en concreto. | ¿? | [datos.bne.es](http://datos.bne.es) |
| Nomenclatura de Ciencia y Tecnología de la UNESCO | ·      Categorías obsoletas.  ·      Tradición en la universidad española.  ·      Dataset de publicaciones anotado quizá de algún repositorio de la universidad española. | 3 | Nivel 1: 24  Nivel 2: 248 | 1973-1988-2021 | CVN-FECYT |
| WoS-CT | ·      Categorización completa y actualizada.  ·      Dataset de publicaciones con abstract y metadatos de categorías si se solicita acceso a InCites API. | 3 | Nivel 1: 10  Nivel 2: 326 | 2019-2021 | WoS y otras de Clarivate Analytics |
...
| WoS-IPRA | ·      Categorización completa y actualizada.  ·      Dataset de publicaciones con abstract y metadatos de categorías. | 2 | Nivel 1: 6  Nivel 2: 267 | 2009-2021 | WoS y otras de Clarivate Analytics |
...
Dada la imposibilidad de obtener un *dataset* de entrenamiento ya etiquetado con las clasificaciones más interesante identificadas, así como el resto de problemas legales y restricciones en el uso de varias fuentes de datos relacionadas con dichas taxonomías, finalmente se propone desarrollar una taxonomía unificada para el proyecto Hércules a partir de las **fuentes de datos** que sí están **disponibles** y que han permitido elaborar los *datasets* etiquetados necesarios para implementar la propuesta o estrategia híbrida descrita en la sección de [Enfoques para extracción de descriptores temáticos de ROs](https://confluence.um.es/confluence/pages/viewpage.action?pageId=222822824):

* Dataset interno creado en el marco de un proyecto del Plan de Impulso de la Lengua y utilizado en el *Challenge.*
* Dataset [arXiv](https://arxiv.org/) con pre-publicaciones de artículos científicos en el campo de las matemáticas, física, ciencias de la computación y biología cuantitativa. En muchos campos de las matemáticas y la física, casi todos los artículos científicos se colocan en arXiv.
* Dataset [PubMed](https://pubmed.ncbi.nlm.nih.gov/) de publicaciones de investigación biomédica almacenadas en la base de datos MEDLINE. También posee entradas sobre publicaciones de revistas científicas de similar calidad, pero que no son parte de MEDLINE.
* Dataset [SourceForge](https://sourceforge.net/) de repositorios de código clasificados por temas.
* Dataset [Bio-Protocol](https://bio-protocol.org/) de protocolos experimentales en el área de ciencias de la vida (*Life Sciences*).

[[1]](#_ftnref1) <https://service.elsevier.com/app/answers/detail/a_id/12007/supporthub/scopus/related/1/>

[[2]](#_ftnref2) <https://service.elsevier.com/app/answers/detail/a_id/15181/supporthub/scopus/>

[[3]](#_ftnref3) <https://www.loc.gov/catdir/cpso/lcc.html>

[[4]](#_ftnref4) <https://en.wikipedia.org/wiki/Library_of_Congress_Classification>

[[5]](#_ftnref5) <https://skos.um.es/unesco6/view.php?fmt=1>

[[6]](#_ftnref6) <https://skos.um.es/unescothes/view.php?fmt=1>

[[7]](#_ftnref7) <https://biblioguias.biblioteca.deusto.es/c.php?g=149255&p=4751722>

[[8]](#_ftnref8) <https://incites.help.clarivate.com/Content/Research-Areas/research-areas.htm>

[[9]](#_ftnref9) <https://incites.help.clarivate.com/Content/Research-Areas/citation-topics.htm>

[[10]](#_ftnref10) <https://www.leidenranking.com/>

[[11]](#_ftnref11) <https://incites.help.clarivate.com/Content/Research-Areas/wos-research-areas.htm>

[[12]](#_ftnref12) <https://incites.help.clarivate.com/Content/Research-Areas/essential-science-indicators.htm>

[[13]](#_ftnref13) <https://incites.help.clarivate.com/Content/Research-Areas/ip-research-areas.htm>

[[14]](#_ftnref14) <https://clarivate.com/webofsciencegroup/solutions/xml-and-apis/>

[[15]](#_ftnref15) <https://bio-protocol.org>

[[16]](#_ftnref16) <https://protocolexchange.researchsquare.com/>

[[17]](#_ftnref17) <https://protocolexchange.researchsquare.com/browse>

[[18]](#_ftnref18) <https://www.protocols.io/>

[[19]](#_ftnref19) <https://apidoc.protocols.io/#protocol-object>

[[20]](#_ftnref20) <https://github.com/>

[[21]](#_ftnref21) <https://bitbucket.org/>

[[22]](#_ftnref22) <https://docs.github.com/en/github/administering-a-repository/classifying-your-repository-with-topics>

[[23]](#_ftnref23) <https://docs.github.com/en/rest/reference/repos#get-all-repository-topics>

[[24]](#_ftnref24) <https://developer.atlassian.com/bitbucket/api/2/reference/resource/repositories>

[[25]](#_ftnref25) <https://sourceforge.net/>

[[26]](#_ftnref26) <https://sourceforge.net/directory/?clear>