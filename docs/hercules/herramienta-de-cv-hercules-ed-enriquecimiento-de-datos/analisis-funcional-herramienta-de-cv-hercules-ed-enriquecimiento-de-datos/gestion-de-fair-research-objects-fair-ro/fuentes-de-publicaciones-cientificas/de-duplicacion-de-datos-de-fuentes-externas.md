# De-duplicación de datos de fuentes externas
...
* En segundo lugar, aplicamos la deduplicación contra el grafo de datos cargados, según lo comentado en el apartado [Deduplicación descrito en de la carga inicial](/hercules/herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/analisis-funcional-herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/servicios-centrales-core-services/proceso-de-carga-inicial-de-datos-para-la-umu#ProcesodecargainicialdedatosparalaUMU-Deduplicaci%C3%B3n).