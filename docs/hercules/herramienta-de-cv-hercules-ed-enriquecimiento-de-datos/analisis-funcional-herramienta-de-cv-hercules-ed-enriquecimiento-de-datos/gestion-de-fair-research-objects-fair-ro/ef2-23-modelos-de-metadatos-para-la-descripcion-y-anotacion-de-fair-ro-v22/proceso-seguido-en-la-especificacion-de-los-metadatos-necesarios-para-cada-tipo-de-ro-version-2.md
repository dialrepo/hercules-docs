# Proceso seguido en la especificación de los metadatos necesarios para cada tipo de RO – versión 2
...
Como se comentó en las secciones de RO de tipo Software, y RO de tipo procedimientos experimentales, y se comentará en la sección de RO de tipo repositorio, ha sido necesario añadir dos nuevas subentidades a bibo:Document: Readme y ExperimentalProtocolResult. Estas dos entidades permiten, respectivamente, definir la estructura y funcionalidad de un código o software y describir el proceso específico con resultados concretos de la realización de un protocolo experimental.
...
Las anotaciones se modelizan en ROH mediante diversas entidades y propiedades importadas de la ontología *oa* [https://www.w3.org/TR/annotation-model/![](images/icons/linkext7.gif)](https://www.w3.org/TR/annotation-model/). Estas entidades son oa:Annotation, oa:Motivation y las propiedades oa:hasTarget y oa:hasBody. Para más información sobre el uso de estas entidades y propiedades se aconseja leer las indicaciones de los autores de la ontología.
