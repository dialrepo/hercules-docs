...
* URI                            [{+}](http://purl.org/roh_edma/mirror/obo/bfo#BFO_0000015)[http://w3id.org/roh/mirror/obo/bfo#BFO\_0000015+![](images/icons/linkext7.gif)](http://w3id.org/roh/mirror/obo/bfo#BFO_0000015+)
* Label                        process
...
* URI                                [{+}](http://purl.org/roh_edma#ReservableSoftware)[http://w3id.org/roh#ReservableSoftware+![](images/icons/linkext7.gif)](http://w3id.org/roh#ReservableSoftware+)
...
* URI                            [{+}](http://purl.org/roh_edma#ExperimentalProtocol)[http://w3id.org/roh#ExperimentalProtocol+![](images/icons/linkext7.gif)](http://w3id.org/roh#ExperimentalProtocol+)
...
* URI                                [{+}](http://purl.org/roh_edma#README)[http://w3id.org/roh#README+![](images/icons/linkext7.gif)](http://w3id.org/roh#README+)
* Label                        README
* In Data                         :README
...
* URI                                [{+}](http://purl.org/roh_edma#Repository)[http://w3id.org/roh#Repository+![](images/icons/linkext7.gif)](http://w3id.org/roh#Repository+)
* Label                         Repository
* In Data                     :Repository
...
* URI                                [{+}](http://purl.org/roh_edma#BitBucketRepository)[http://w3id.org/roh#BitBucketRepository+![](images/icons/linkext7.gif)](http://w3id.org/roh#BitBucketRepository+)
* Label                        BitBucket Repository
* In Data                         : BitBucketRepository

Esta entidad define un tipo específico de repositorio. Es una subclase de Repository. El tipo de repositorio que se quiere modelizar aquí son aquellos que se encuentran en[ |https://bitbucket.org/][{+}](https://bitbucket.org/)[https://bitbucket.org/+![](images/icons/linkext7.gif)](https://bitbucket.org/+).

### GitHub Repository

* URI                                [{+}](http://purl.org/roh_edma#GitHubRepository)[http://w3id.org/roh#GitHubRepository+![](images/icons/linkext7.gif)](http://w3id.org/roh#GitHubRepository+)
* Label                        GitHub Repository
* In Data                         : GitHubRepository

Esta entidad define un tipo específico de repositorio. Es una subclase de la entidad Repository. El tipo de repositorio que se quiere modelizar aquellos que se encuentran en[ |https://github.com/][{+}](https://github.com/)[https://github.com/+![](images/icons/linkext7.gif)](https://github.com/+) .

### Zenodo Repository

* URI                                [{+}](http://purl.org/roh_edma#ZenodoRepository)[http://w3id.org/roh#ZenodoRepository+![](images/icons/linkext7.gif)](http://w3id.org/roh#ZenodoRepository+)
* Label                        Zenodo Repository
* In Data                         : ZenodoRepository

Esta entidad define un tipo específico de repositorio. Es una subclase de la entidad Repository. El tipo de repositorio que se quiere modelizar son aquellos que se encuentran en[ |https://zenodo.org/][{+}](https://zenodo.org/)[https://zenodo.org/+![](images/icons/linkext7.gif)](https://zenodo.org/+) .

## **Bfo:Role**

●URI [{+}](http://w3id.org/roh/mirror/obo/bfo#BFO_0000023)[http://w3id.org/roh/mirror/obo/bfo#BFO\_0000023+![](images/icons/linkext7.gif)](http://w3id.org/roh/mirror/obo/bfo#BFO_0000023+)   
●Label Role  
...
* URI                                [{+}](http://purl.org/roh_edma#ResearchResult)[http://w3id.org/roh#ResearchResult+![](images/icons/linkext7.gif)](http://w3id.org/roh#ResearchResult+)
...
* URI                                [{+}](http://purl.org/roh_edma#ResearchObject)[http://w3id.org/roh#ResearchObject+![](images/icons/linkext7.gif)](http://w3id.org/roh#ResearchObject+)
...
* URI                                [{+}](http://w3id.org/roh#JournalMetric)[http://w3id.org/roh#JournalMetric+![](images/icons/linkext7.gif)](http://w3id.org/roh#JournalMetric+)
