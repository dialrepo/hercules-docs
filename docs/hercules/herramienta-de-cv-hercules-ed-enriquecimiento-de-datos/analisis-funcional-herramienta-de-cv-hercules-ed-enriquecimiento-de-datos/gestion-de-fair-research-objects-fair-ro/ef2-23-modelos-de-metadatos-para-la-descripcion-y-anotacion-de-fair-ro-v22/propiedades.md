...
* URI                             [{+}](http://purl.org/roh_edma#researchResultHasParth)[http://w3id.org/roh#researchResultHasParth+![](images/icons/linkext7.gif)](http://w3id.org/roh#researchResultHasParth+)
...
* URI                                [{+}](http://purl.org/roh_edma#partOfResearchResult)[http://w3id.org/roh#partOfResearchResult+![](images/icons/linkext7.gif)](http://w3id.org/roh#partOfResearchResult+)
...
* URI                                [{+}](http://purl.org/roh_edma#partOfRepository)[http://w3id.org/roh#partOfRepository+![](images/icons/linkext7.gif)](http://w3id.org/roh#partOfRepository+)
...
* URI                                [{+}](http://purl.org/roh_edma#seqOfAuthors)[http://w3id.org/roh#seqOfAuthors+![](images/icons/linkext7.gif)](http://w3id.org/roh#seqOfAuthors+)
...
Ejemplo de uso:  
<[http://w3id.org/roh/data#investigador-3-phd-thesis![](images/icons/linkext7.gif)](http://w3id.org/roh/data#investigador-3-phd-thesis)>   
        a :PhDThesis ;  
        dc:title "My fabulous PhD Thesis" ;  
        :correspondingAuthor <[http://w3id.org/roh/data#investigador-3![](images/icons/linkext7.gif)](http://w3id.org/roh/data#investigador-3)> ;  
        :seqOfAuthors [ a     rdf:Seq ;  
                          rdf:\_1        <[http://w3id.org/roh/data#investigador-3![](images/icons/linkext7.gif)](http://w3id.org/roh/data#investigador-3)> ;  
                          rdf:\_2        <[http://w3id.org/roh/data#investigador-1![](images/icons/linkext7.gif)](http://w3id.org/roh/data#investigador-1)> ] .

## **Software Status**

* URI                                [{+}](http://purl.org/roh_edma#softwareStatus)[http://w3id.org/roh#softwareStatus+![](images/icons/linkext7.gif)](http://w3id.org/roh#softwareStatus+)
...
* URI                                [{+}](http://purl.org/roh_edma#repositoryStatus)[http://w3id.org/roh#repositoryStatus+![](images/icons/linkext7.gif)](http://w3id.org/roh#repositoryStatus+)
...
* URI                                [{+}](http://purl.org/roh_edma#hasReadme)[http://w3id.org/roh#hasReadme+![](images/icons/linkext7.gif)](http://w3id.org/roh#hasReadme+)
* Label                    has readme
* In Data                         : hasReadme
...
* URI                                [{+}](http://purl.org/roh_edma#hasSucessor)[http://w3id.org/roh#hasSucessor+![](images/icons/linkext7.gif)](http://w3id.org/roh#hasSucessor+)
* Label                    has sucessor
* In Data                         : hasSucessor
* **Dominio**: –
* **Rango**: –
...
La información que nos permite definir es la siguiente: x es sucesora de y, o en tripletas x :hasSucessor y, donde x e y pueden ser instancias de cualquier entidad de nuestra ontología. Como subfunción de esta propiedad está la propiedad 'vivo:successor organization' ([{+}](http://purl.org/roh_edma/mirror/vivo#hasSuccessorOrganization)[http://w3id.org/roh/mirror/vivo#hasSuccessorOrganization+![](images/icons/linkext7.gif)](http://w3id.org/roh/mirror/vivo#hasSuccessorOrganization+))  que sirve para definir la organización sucesora de otra organización.  
...
* URI                                [{+}](http://purl.org/roh_edma#hasPredecessor)[http://w3id.org/roh#hasPredecessor+![](images/icons/linkext7.gif)](http://w3id.org/roh#hasPredecessor+)
...
La información que nos permite definir es la siguiente: x es predecesora de y, o en tripletas x :hasPredecessor y, donde x e y pueden ser instancias de cualquier entidad de nuestra ontología. Como subfunción de esta propiedad está la propiedad 'vivo:predecessor organization' ([{+}](http://purl.org/roh_edma/mirror/vivo#hasPredecessorOrganization)[http://w3id.org/roh/mirror/vivo#hasPredecessorOrganization+![](images/icons/linkext7.gif)](http://w3id.org/roh/mirror/vivo#hasPredecessorOrganization+))  que sirve para definir la organización predecesora de otra organización.  
...
* URI                                [{+}](http://purl.org/roh_edma#hasLicense)[http://w3id.org/roh#hasLicense+![](images/icons/linkext7.gif)](http://w3id.org/roh#hasLicense+)
* Label                    has license
* In Data                         : hasLicense
* Dominio: –
* **Rango**: vivo:License
...
* URI                                [{+}](http://purl.org/roh_edma#documentStatus)[http://w3id.org/roh#documentStatus+![](images/icons/linkext7.gif)](http://w3id.org/roh#documentStatus+)
...
* URI                            [{+}](http://purl.org/roh_edma#languageOfTheCertificate)[http://w3id.org/roh#languageOfTheCertificate+![](images/icons/linkext7.gif)](http://w3id.org/roh#languageOfTheCertificate+)
...
* URI                                [{+}](http://purl.org/roh_edma#language)[http://w3id.org/roh#language+![](images/icons/linkext7.gif)](http://w3id.org/roh#language+)
* Label                    language
* In Data                         : language
* **Dominio**: –
* **Rango**: xsd:string
...
* URI                                [{+}](http://purl.org/roh_edma#programmingLanguage)[http://w3id.org/roh#programmingLanguage+![](images/icons/linkext7.gif)](http://w3id.org/roh#programmingLanguage+)
...
●URI [{+}](http://w3id.org/roh#correspondingOrganization)[http://w3id.org/roh#correspondingOrganization+![](images/icons/linkext7.gif)](http://w3id.org/roh#correspondingOrganization+)   
...
●URI [{+}](http://w3id.org/roh#correspondingOrganizationOf)[http://w3id.org/roh#correspondingOrganizationOf+![](images/icons/linkext7.gif)](http://w3id.org/roh#correspondingOrganizationOf+)   
