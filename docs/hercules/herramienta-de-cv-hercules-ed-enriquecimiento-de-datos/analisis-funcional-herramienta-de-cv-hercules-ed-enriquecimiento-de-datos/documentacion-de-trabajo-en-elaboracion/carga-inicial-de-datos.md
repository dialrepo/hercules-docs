...
* [Características generales del proceso de carga de datos](#Cargainicialdedatos-Característicasgeneralesdelprocesodecargadedatos)
* [Paso 1 - Carga de datos de sistemas de la UMU](#Cargainicialdedatos-Paso1-CargadedatosdesistemasdelaUMU)
* [Paso 2 - Fuentes externas de resultados de investigación](#Cargainicialdedatos-Paso2-Fuentesexternasderesultadosdeinvestigación)
* [Paso 3 - Ficheros CVN de los investigadores](#Cargainicialdedatos-Paso3-FicherosCVNdelosinvestigadores)
...
* Recuperación de los resultados de investigación y [deduplicación de datos](/hercules/herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/analisis-funcional-herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/gestion-de-fair-research-objects-fair-ro/fuentes-de-publicaciones-cientificas/de-duplicacion-de-datos-de-fuentes-externas) de investigadores y resultados de investigación, desde las fuentes primarias de información: WoS, Scopus y OpenAire (pendiente de confirmar que es posible usarla).
...
Está pendiente de actualizar el proceso descrito en [Fuentes externas de publicaciones científicas](/hercules/herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/analisis-funcional-herramienta-de-cv-hercules-ed-enriquecimiento-de-datos/gestion-de-fair-research-objects-fair-ro/fuentes-de-publicaciones-cientificas/fuentes-externas-de-publicaciones-cientificas), a falta de recibir información de WoS que nos permita cerrar completamente el proceso.
