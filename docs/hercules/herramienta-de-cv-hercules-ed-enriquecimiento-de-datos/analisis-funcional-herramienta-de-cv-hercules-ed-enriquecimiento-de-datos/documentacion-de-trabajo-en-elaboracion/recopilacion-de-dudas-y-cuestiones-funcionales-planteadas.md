# Recopilación de dudas y cuestiones funcionales planteadas

* [ORCID y código de SCOPUS de investigadores para la carga inicial (resuelto)](#Recopilacióndedudasycuestionesfuncionalesplanteadas-ORCIDycódigodeSCOPUSdeinvestigadoresparalacargainicial(resuelto))
* [Carga inicial, obtención de enriquecimiento](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Cargainicial,obtencióndeenriquecimiento)
* [Campos multi-idioma (resuelto)](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Camposmulti-idioma(resuelto))
* [Datos personales editables (resuelto)](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Datospersonaleseditables(resuelto))
* [Ítems del investigador anteriores a su incorporación a la UMU](#Recopilacióndedudasycuestionesfuncionalesplanteadas-ÍtemsdelinvestigadoranterioresasuincorporaciónalaUMU)
* [Grupos](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Grupos)
* [Validación.](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Validación.)
* [Acceso a los datos de la biblioteca](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Accesoalosdatosdelabiblioteca)
* [Otros ítems y datos que podemos tener en sistemas de la UMU](#Recopilacióndedudasycuestionesfuncionalesplanteadas-OtrosítemsydatosquepodemostenerensistemasdelaUMU)
* [Acceso a datos de impacto](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Accesoadatosdeimpacto)
* [Eventos de divulgación](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Eventosdedivulgación)
* [Proyectos externos autorizados (resuelto)](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Proyectosexternosautorizados(resuelto))
* [Alineamiento de la taxonomía unificada con las categorías/áreas de conocimiento de la UMU](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Alineamientodelataxonomíaunificadaconlascategorías/áreasdeconocimientodelaUMU)
* [Dudas acerca del proceso de incorporación de ítems desde redes externas de investigación (resuelto)](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Dudasacercadelprocesodeincorporacióndeítemsdesderedesexternasdeinvestigación(resuelto))
* [Anotaciones](#Recopilacióndedudasycuestionesfuncionalesplanteadas-Anotaciones)
...
Se consulta en todas las redes externas de citas (definidas en [Fuentes externas de publicaciones científicas](https://confluence.um.es/confluence/pages/viewpage.action?pageId=317554701)) combinando los resultados sin duplicados. Pendiente de definir cómo presentar la procedencia.
