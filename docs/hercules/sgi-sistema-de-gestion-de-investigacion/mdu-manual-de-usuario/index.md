...
* [1. Introducción](#MDUManualdeusuario-1.Introducción)
* [2. Acceso al SGI](#MDUManualdeusuario-2.AccesoalSGI)
* [3. Navegación y elementos comunes](#MDUManualdeusuario-3.Navegaciónyelementoscomunes)
  + [3.1 Información de usuario y cierre de sesión](#MDUManualdeusuario-3.1Informacióndeusuarioycierredesesión)
  + [3.2 Selección de módulo](#MDUManualdeusuario-3.2Seleccióndemódulo)
  + [3.3 Menú lateral](#MDUManualdeusuario-3.3Menúlateral)
  + [3.4 Buscadores y listados](#MDUManualdeusuario-3.4Buscadoresylistados)
  + [3.5 Listado de entidad](#MDUManualdeusuario-3.5Listadodeentidad)
  + [3.6 Ordenación de los listados](#MDUManualdeusuario-3.6Ordenacióndeloslistados)
  + [3.7 Paginación de listados](#MDUManualdeusuario-3.7Paginacióndelistados)
  + [3.8 Exportación de listados](#MDUManualdeusuario-3.8Exportacióndelistados)
  + [3.9 Acciones](#MDUManualdeusuario-3.9Acciones)
  + [3.10 Editar o Modificar elemento](#MDUManualdeusuario-3.10EditaroModificarelemento)
  + [3.11 Ver elemento](#MDUManualdeusuario-3.11Verelemento)
  + [3.12 Eliminar elemento](#MDUManualdeusuario-3.12Eliminarelemento)
  + [3.13 Recuperar elemento](#MDUManualdeusuario-3.13Recuperarelemento)
  + [3.14 Información](#MDUManualdeusuario-3.14Información)
  + [3.15 Añadir nuevo elemento](#MDUManualdeusuario-3.15Añadirnuevoelemento)
  + [3.16 Detalle de elemento, menú de entidad o de segundo nivel](#MDUManualdeusuario-menu_entidad_compleja3.16Detalledeelemento,menúdeentidadodesegundonivel)
  + [3.17 Nivel de navegación o miga de pan](#MDUManualdeusuario-3.17Niveldenavegaciónomigadepan)
  + [3.18 Apertura de ventana en nueva pestaña](#MDUManualdeusuario-3.18Aperturadeventanaennuevapestaña)
  + [3.19 Controles sobre campos desplegables o selectores](#MDUManualdeusuario-3.19Controlessobrecamposdesplegablesoselectores)
    - [3.19.1 Acceso directo a la creación de entidades simples](#MDUManualdeusuario-3.19.1Accesodirectoalacreacióndeentidadessimples)
    - [3.19.2 Acceso directo a la creación de entidades complejas](#MDUManualdeusuario-3.19.2Accesodirectoalacreacióndeentidadescomplejas)
  + [3.20 Componente texto enriquecido](#MDUManualdeusuario-3.20Componentetextoenriquecido)
* [4. Validaciones y mensajes sobre campos](#MDUManualdeusuario-4.Validacionesymensajessobrecamposvalidaciones)
  + [4.1 Campos obligatorios](#MDUManualdeusuario-4.1Camposobligatorios)
  + [4.2 Activación de botones Guardar o Añadir](#MDUManualdeusuario-4.2ActivacióndebotonesGuardaroAñadir)
  + [4.3 Errores de validación de formato](#MDUManualdeusuario-4.3Erroresdevalidacióndeformato)
  + [4.4 Errores de validación en rangos de fechas](#MDUManualdeusuario-4.4Erroresdevalidaciónenrangosdefechas)
  + [4.5 Errores de datos](#MDUManualdeusuario-4.5Erroresdedatos)
  + [4.6 Información sobre campos](#MDUManualdeusuario-4.6Informaciónsobrecampos)
    - [4.6.1 Formato](#MDUManualdeusuario-4.6.1Formato)
    - [4.6.2 Campos no modificables](#MDUManualdeusuario-4.6.2Camposnomodificables)
    - [4.6.3 Longitud de campos de texto](#MDUManualdeusuario-4.6.3Longituddecamposdetexto)
    - [4.6.4 Valores no seleccionables en listados de desplegables](#MDUManualdeusuario-4.6.4Valoresnoseleccionablesenlistadosdedesplegables)
* [5. Mensajes de confirmación, informativos y de error](#MDUManualdeusuario-5.Mensajesdeconfirmación,informativosydeerror)
  + [5.1 Mensajes de confirmación](#MDUManualdeusuario-5.1Mensajesdeconfirmación)
  + [5.3 Mensajes de error](#MDUManualdeusuario-5.3Mensajesdeerror)
* [6. Comportamiento de buscadores](#MDUManualdeusuario-6.Comportamientodebuscadores)
  + [6.1 Filtros sobre campos de texto](#MDUManualdeusuario-6.1Filtrossobrecamposdetexto)
  + [6.2 Filtros sobre campos fecha](#MDUManualdeusuario-6.2Filtrossobrecamposfecha)
  + [6.3 Filtros sobre campos desplegables](#MDUManualdeusuario-6.3Filtrossobrecamposdesplegables)
  + [6.4 Filtros por defecto](#MDUManualdeusuario-6.4Filtrospordefecto)
  + [6.5 Buscadores con campos "autocomplete"](#MDUManualdeusuario-6.5Buscadoresconcampos"autocomplete")
* [7. Buscadores y selectores de entidades comunes](#MDUManualdeusuario-7.Buscadoresyselectoresdeentidadescomunes)
  + [7.1 Buscador de convocatorias](#MDUManualdeusuario-7.1Buscadordeconvocatorias)
  + [7.2 Buscador de proyectos](#MDUManualdeusuario-7.2Buscadordeproyectos)
  + [7.3 Buscador de invenciones](#MDUManualdeusuario-7.3Buscadordeinvenciones)
  + [7.4 Buscador de grupos](#MDUManualdeusuario-7.4Buscadordegrupos)
  + [7.5 Selector de clasificaciones](#MDUManualdeusuario-7.5Selectordeclasificaciones)
  + [7.6 Selector de áreas de conocimiento](#MDUManualdeusuario-7.6Selectordeáreasdeconocimiento)
  + [7.7 Selector de plan/programa de investigación](#MDUManualdeusuario-7.7Selectordeplan/programadeinvestigación)
* [8. Comunicación con sistemas corporativos: personas, entidades o empresas y proyectos del sistema de gestión económica](#MDUManualdeusuario-8.Comunicaciónconsistemascorporativos:personas,entidadesoempresasyproyectosdelsistemadegestióneconómica)
  + [8.1 Personas](#MDUManualdeusuario-8.1Personas)
    - [8.1.1 Buscar personas](#MDUManualdeusuario-8.1.1Buscarpersonas)
    - [8.1.2 Solicitar dar de alta nueva persona](#MDUManualdeusuario-8.1.2Solicitardardealtanuevapersona)
    - [8.1.3 Solicitar modificar una persona](#MDUManualdeusuario-8.1.3Solicitarmodificarunapersona)
    - [8.1.4 Visualización de datos relacionados con personas eliminadas en el sistema corporativo](#MDUManualdeusuario-8.1.4Visualizacióndedatosrelacionadosconpersonaseliminadasenelsistemacorporativo)
  + [8.2 Entidades o empresas](#MDUManualdeusuario-8.2Entidadesoempresas)
    - [8.2.1 Buscar entidades o empresas](#MDUManualdeusuario-8.2.1Buscarentidadesoempresas)
    - [8.2.2 Solicitar dar de alta entidades o empresas](#MDUManualdeusuario-8.2.2Solicitardardealtaentidadesoempresas)
    - [8.2.3 Modificar una entidad o empresa](#MDUManualdeusuario-8.2.3Modificarunaentidadoempresa)
  + [8.3 Identificador de proyecto del sistema de gestión económica](#MDUManualdeusuario-8.3Identificadordeproyectodelsistemadegestióneconómica)
    - [8.3.1 Buscar proyecto económico del SGE](#MDUManualdeusuario-8.3.1BuscarproyectoeconómicodelSGE)
    - [8.3.2 Solicitar dar de alta nuevo proyecto económico](#MDUManualdeusuario-8.3.2Solicitardardealtanuevoproyectoeconómico)
    - [8.3.3 Solicitar relacionar proyecto SGI con proyecto económico](#MDUManualdeusuario-8.3.3SolicitarrelacionarproyectoSGIconproyectoeconómico)
* [9. Palabras clave](#MDUManualdeusuario-9.Palabrasclave)
  + [9.1 Gestionar palabras clave](#MDUManualdeusuario-9.1Gestionarpalabrasclave)
    - [9.1.1 Añadir nueva palabra clave](#MDUManualdeusuario-9.1.1Añadirnuevapalabraclave)
    - [9.1.1 Desasociar una palabra clave](#MDUManualdeusuario-9.1.1Desasociarunapalabraclave)
  + [9.2 Filtro por palabras clave en buscadores](#MDUManualdeusuario-9.2Filtroporpalabrasclaveenbuscadores)
* [10. Comportamiento multi-idioma](#MDUManualdeusuario-10.Comportamientomulti-idioma)
  + [10.1 Habilitación de idiomas](#MDUManualdeusuario-10.1Habilitacióndeidiomas)
  + [10.2 Priorización de idiomas](#MDUManualdeusuario-10.2Priorizacióndeidiomas)
  + [10.3 Selección de idioma de visualización](#MDUManualdeusuario-10.3Seleccióndeidiomadevisualización)
  + [10.4 Introducción de valores multi-idioma](#MDUManualdeusuario-10.4Introduccióndevaloresmulti-idioma)
  + [10.5 Comportamiento de listados](#MDUManualdeusuario-10.5Comportamientodelistados)
  + [10.6 Comportamiento en visualización y edición de entidades](#MDUManualdeusuario-10.6Comportamientoenvisualizaciónyedicióndeentidades)
  + [10.7 Comportamiento de buscadores](#MDUManualdeusuario-10.7Comportamientodebuscadores)
  + [10.8 Generación y descarga de informes](#MDUManualdeusuario-10.8Generaciónydescargadeinformes)
...
* [MDU - Perfil de investigación](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-investigacion)
  + [MDU-Perfil de investigación - Módulo ETI](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-investigacion/mdu-perfil-de-investigacion-modulo-eti)
  + [MDU-Perfil de investigación - Módulo CSP](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-investigacion/mdu-perfil-de-investigacion-modulo-csp)
  + [MDU-Perfil de investigación - Módulo PRC](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-investigacion/mdu-perfil-de-investigacion-modulo-prc)
* [MDU - Perfil unidad de gestión](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion)
  + [MDU-Perfil unidad de gestión - Módulo CSP](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp)
    - [CSP-Configuración](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-configuracion)
    - [CSP-Convocatorias](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-convocatorias)
    - [CSP-Solicitudes](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-solicitudes)
    - [CSP-Proyectos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-proyectos)
      * [CSP-Proyectos-Configuración económica](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-proyectos/csp-proyectos-configuracion-economica)
      * [CSP-Proyectos-Comunicados](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-proyectos/csp-proyectos-comunicados)
    - [CSP-Grupos de investigación](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-grupos-de-investigacion)
    - [CSP-Ejecución económica](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-ejecucion-economica)
    - [CSP-Participación proyectos externos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-participacion-proyectos-externos)
    - [CSP-Notificación de presupuestos al SGE](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-notificacion-de-presupuestos-al-sge)
    - [CSP-Listados](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-listados)
  + [MDU-Perfil unidad de gestión - Módulo ETI](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eti)
    - [ETI-Solicitudes de evaluación y memorias](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eti/eti-solicitudes-de-evaluacion-y-memorias)
    ...
    - [ETI-Evaluaciones y seguimientos evaluador (Ficha equipo evaluador - Perfil "Técnico/a ética")](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eti/eti-evaluaciones-y-seguimientos-evaluador-ficha-equipo-evaluador-perfil-tecnicoa-etica)
    - [ETI-Actas evaluador](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eti/eti-actas-evaluador)
    - [ETI-Configuración](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eti/eti-configuracion)
  + [MDU-Perfil unidad de gestión - Módulo PII](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-pii)
    - [PII-Configuración](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-pii/pii-configuracion)
    - [PII-Invenciones](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-pii/pii-invenciones)
  + [MDU-Perfil unidad de gestión - Módulo PRC](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-prc)
    - [PRC-Validación producción científica](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-prc/prc-validacion-produccion-cientifica)
  ...
  + [MDU-Perfil unidad de gestión - Módulo EER](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eer)
    - [EER-Empresas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-eer/eer-empresas)
* [MDU - Perfil de Administración del sistema](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-administracion-del-sistema)
...
![](/attachments/597852732/597854248.png)
...
Al pasar el ratón sobre el icono ![](/attachments/597852732/597854229.png), disponible en la esquina superior derecha de todas las ventanas, se mostrará el nombre de usuario/a con el que se ha establecido la conexión.
...
![](/attachments/597852732/597862646.png)
...
![](/attachments/597852732/597862814.png)
...
Se define como entidad "compleja" como aquella que tiene un número alto de campos que deben ser presentados en diferentes apartados o pestañas. El detalle de este tipo de entidades se muestra en una ventana completa y dispondrá de un menú que permita acceder a cada uno de sus apartados de datos (ver [Detalle de elemento, menú de entidad o de segundo nivel](#MDUManualdeusuario-menu_entidad_compleja)), ejemplos de entidades complejas son convocatorias, proyectos o modelos de ejecución.
...
![](/attachments/597852732/597859795.png)
...
![](/attachments/597852732/597859076.png)
...
![](/attachments/597852732/597859077.png)
...
![](/attachments/597852732/597859326.png)
...
Además de estos mensajes de error, también existe la modalidad de errores sobre el formato de los campos ya comentados en apartado previo. Ver [Validaciones](#MDUManualdeusuario-validaciones).
...
#### 6.2 Filtros sobre campos fecha
...
![](/attachments/597852732/597883063.png)

Filtro para encontrar proyectos Vigentes:

Conclusión búsqueda fechas para proyectos vigentes:

Para hacer la búsqueda de proyectos vigentes se rellena la fecha de inicio hasta con la fecha de fin de vigencia y la fecha de fin desde, con la fecha de inicio de vigencia y recupera los proyectos vigentes en esas fechas.
...
![](/attachments/597852732/597883033.png)
...
* Dentro de la ventana emergente, el buscador seguirá la línea general del comportamiento de los buscadores del SGI descrita en el apartado [Buscadores y listados](#MDUManualdeusuario-3.2Buscadoresylistados), con la particularidad de que en este caso aparecerá la nueva acción "Seleccionar", no disponible en los buscadores accesible desde las opciones de menú, y que servirá para indicar con qué entidad rellenar el campo de la ventana llamante desde donde se solicitó la búsqueda o selección.
...
![](/attachments/597852732/597883019.png)
...
![](/attachments/597852732/597883023.png)
...
![](/attachments/597852732/597883103.png)
...
Se podrá elegir un elemento de cualquier nivel del árbol o bien dejar seleccionado únicamente el plan de investigación.
...
![](/attachments/597852732/597883122.png)
...
![](/attachments/597852732/597883110.png)
...
![](/attachments/597852732/712441979.png)
...
El buscador de entidades o empresas sigue las mismas normas básicas que los buscadores comunes, según se describe en [Buscadores y selectores de entidades comunes](#MDUManualdeusuario-7.Buscadoresyselectoresdeentidadescomunes), y además se añade funcionalidad extra:
...
![](/attachments/597852732/597883526.png)

Habrá una serie de datos obligatorios, otros opcionales, diferentes tipologías de campos, etc ... al igual que en el resto de formularios del SGI, y que seguirán las mismas normas generales que las descritas en los apartados anteriores de este manual.

![](/attachments/597852732/597883525.png)

Una vez se completen los datos necesarios para el alta de la entidad, se debe pulsar el botón "Solicitar alta" que será el que en última instancia se comunique con los sistemas de la Universidad para hacer la petición de alta de esa nueva entidad o empresa.
...
![](/attachments/597852732/597883521.png)
...
El buscador de proyectos del SGE sigue las normas básicas de los buscadores comunes, según se describe en [Buscadores y selectores de entidades comunes](#MDUManualdeusuario-7.Buscadoresyselectoresdeentidadescomunes), pero tiene alguna otra particularidad quee describe a continuación.
...
![](/attachments/597852732/597883553.png)
...
![](/attachments/597852732/597883559.png)
...
##### 8.3.3 Solicitar relacionar proyecto SGI con proyecto económico
...
Se podrá repetir este proceso para todas las palabras clave que se quieran añadir a la entidad.
...
Si se decide seleccionar una palabra del diccionario, la elegimos del desplegable y pulsamos la tecla "enter" y se añadiría la palabra clave a la lista de palabras clave por las que filtrar la entidad. En el ejemplo, la palabra clave "abeja" aparece en la lista de palabras por las que filtrar los proyectos.
...
### 10. Comportamiento multi-idioma

El SGI es una aplicación multi-idioma, tanto para la visualización de etiquetas y mensajes como para la introducción de contenido. El SGI estará disponible en varias lenguas, inicialmente: español, euskera e inglés. A medida que sea requerido se podrán incorporar nuevos idiomas. La inclusión de un nuevo idioma debe de ser realizado por el personal técnico correspondiente a partir de la incorporación de los ficheros de configuración necesarios que contengan todas las traducciones de los diferentes tipos de textos y mensajes de la aplicación.

#### 10.1 Habilitación de idiomas

Los idiomas en los que se encuentra disponible el SGI por configuración base podrán ser habilitados/deshabilitados de forma libre por el rol administrador del SGI. Para ello se hará uso del parámetro "Idiomas habilitados" disponible en el apartado "Configuración global" del módulo de Administración. El acceso a este módulo está reservado al rol de administración del SGI.

Por defecto la implantación tendrá habilitado únicamente el idioma Español.

![](/attachments/597852732/1400438787.png)

De acuerdo a esto, el español sería el único idioma disponible en la cabecera

![](/attachments/597852732/1400438789.png)

Para habilitar más idiomas se debe de acceder al menú "Configuración global" del módulo de Administración. Al desplegar el parámetro "Idiomas habilitados", se listarán todos los idiomas en los que se encuentra disponible el SGI. Se deben de seleccionar los idiomas que se desea habilitar para que estén disponibles en el selector de idiomas de la cabecera. En la imagen adjunta se ve cómo inicialmente sólo está seleccionado el español:

![](/attachments/597852732/1400438793.png)

Se deben de marcar las casillas correspondientes a los idiomas que se deseen habilitar:

![](/attachments/597852732/1400438794.png)

Tras dejar marcados los idiomas que se desea estén habilitados, se pulsará el icono de ![](https://treetk.atlassian.net/wiki/download/attachments/178773200/icono_guardar.png?version=1&modificationDate=1753085903791&cacheVersion=1&api=v2) correspondiente al campo "Idiomas habilitados" para que se guarde la selección realizada:

![](/attachments/597852732/1400438795.png)

Tras guardar la selección de idiomas, se mostrará el mensaje de confirmación correspondiente:

![](/attachments/597852732/1400438796.png)

Desde ese momento, los idiomas habilitados pasarán a estar disponibles en el selector de idiomas de la cabecera de la aplicación.

![](/attachments/597852732/1400438797.png)

#### 10.2 Priorización de idiomas

El SGI es una aplicación multi-idioma no sólo a nivel de textos y mensajes, sino también en contenido. Es decir, el SGI permite la introducción de los campos en los diferentes idiomas habilitados. Por ejemplo, el título de un proyecto o los comentarios a una evaluación de ética se podrán introducir en los diferentes idiomas habilitados. Del mismo modo, los informes o exportación de listados también se podrán generar en los diferentes idiomas  habilitados.

A pesar de permitirlo, no será obligatorio que los valores de los diferentes campos se introduzcan en todos los idiomas. Los idiomas habilitados en cada implantación, contarán con una priorización que también será de configuración libre en cada implantación. El primero de los idiomas, de acuerdo a esta priorización, actuará como idioma por defecto, que no será sinónimo de obligatorio. La persona usuaria decidirá en qué idioma o idiomas introduce su contenido, teniendo la libertad además de introducir cada campo en un número diferente de idiomas. Los campos marcados como obligatorios en las diferentes pantallas de la aplicación deberán ser introducidos en, al menos, un idioma. Será de nuevo la persona usuaria quien decida en qué idioma introducirlo.  El orden de priorización de los idiomas será considerado para la representación en pantalla del contenido de los campos multilingües o para la generación de los informes, de forma que si el valor del campo no se encuentra disponible en el idioma seleccionado sobre la aplicación en ese momento o en el idioma en que se ha de generar un informe, se mostrará el contenido del campo en el primer idioma en el que esté disponible siguiendo el orden de priorización establecido en la configuración.
...
Cuando se accede al detalle de una entidad para modificar sus datos se mostrará el valor de sus campos tomando como idioma de referencia el seleccionado en la cabecera, pero dando prioridad a mostrar el valor del campo cuando éste no esté cumplimentado en el idioma seleccionado y sí en algún otro de los idiomas disponibles. Se mostrará el valor de los campos en el idioma seleccionado en la cabecera y si algún campo no estuviera cumplimentado en ese idioma, se mostrará el valor en cualquier otro idioma en el que sí estuviera cumplimentado, siguiente el orden de idiomas definido en la priorización. Es decir, al mostrar una entidad en modo edición podrán verse campos en diferentes idiomas, según estén o no cumplimentados en el idioma seleccionado en la cabecera. Se da prioridad a mostrar el valor de los campos en otro idioma frente a mostrarlos vacíos , cuando no están cumplimentados en el idioma seleccionado.

La priorización de idiomas no está disponible en el módulo de Administración de SGI, sino que debe de realizarse a través de BD por personal técnico.

A continuación se dan las pautas para establecer la priorización de idiomas:

* **Modelo de datos:**CNF\_SGI
* **Tabla:** `config`
* **Campo:** `name`, valor: `'i18n-languages-priority'`

En la tabla "config" del modelo de datos "CNF\_SGI" existen diferentes parámetros de configuración. Cada parámetro tiene un nombre (campo "name") y un valor (campo "value"). El campo "`value"` asociado al registro cuyo campo "name" es "`i18n-languages-priority"` define el orden de prioridad de los idiomas utilizados en el sistema. Su valor debe establecerse en formato JSON como un array de códigos de idioma.

El orden de los elementos en este array determina la prioridad de los idiomas: el primer elemento representa el idioma prioritario, mientras que el último tiene la menor prioridad.

**Ejemplo**:

Si se desea establecer el idioma **español** como prioritario, seguido por **inglés** y finalmente **euskera**, el valor del campo será “["es", "en", "eu"]”:

|  |
| --- |
| `UPDATE CNF_SGI.CONFIG SET VALUE =``'["es", "en", "eu"]'` `WHERE NAME =``'i18n-languages-priority'``;` |

#### 10.3 Selección de idioma de visualización

El selector de idiomas se encuentra en la cabecera de la aplicación y está disponible en todas las páginas y para todos los perfiles de acceso.

![](/attachments/597852732/1400438799.png)

El listado de idiomas disponible en el selector será el correspondiente a la configuración realizada a través de [Habilitación de idiomas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-10.1Habilitaci%C3%B3ndeidiomas).

![](/attachments/597852732/1400438800.png)

Cada persona podrá hacer uso de un idioma y podrá cambiar el idioma seleccionado tantas veces como considere. Al iniciar sesión por primera vez en la aplicación, el idioma seleccionado será el idioma configurado como prioritario en la implantación del SGI. Tras iniciar sesión, se podrá cambiar el idioma en el que se muestra la aplicación. El idioma seleccionado se conservará tras cerrar la sesión. Al iniciar una nueva sesión en el SGI se dispondrá del idioma seleccionado por última vez, permaneciendo éste hasta nuevo cambio.

Los textos de todas las pantallas, botones, mensajes de confirmación, mensajes de error, avisos, etc. se mostrarán en el idioma seleccionado en la cabecera en cada momento.

#### 10.4 Introducción de valores multi-idioma

El SGI es una aplicación multi-idioma en contenido. Esto supone que el valor de los campos se podrá introducir en todos los idiomas habilitados. Por norma general, todos los campos de texto de la aplicación, salvo aquellos que representen códigos, tienen la condición de multi-idioma.

Cada campo multi-idioma se acompaña de un selector del tipo ![](/attachments/597852732/1400438802.png) , situado a la izquierda del campo ![](/attachments/597852732/1400438803.png) .

El valor del selector determina el idioma en el que será introducido el contenido del campo. Cada idioma se representa por un código de tres letras de acuerdo a la norma ISO.

Para introducir el contenido en los diferentes idiomas se debe de ir rellenando el valor del campo y cambiando el idioma en el selector.

![](/attachments/597852732/1400438804.png)

Al desplegar el selector de idiomas del cada campo multilingüe, se mostrará el listado con todos los idiomas habilitados:

![](/attachments/597852732/1400438805.png)

Al desplegar el selector se muestra el código de tres letras y el nombre completo del idioma.

Se seleccionará el idioma y se introducirá el contenido del campo en ese idioma:

![](/attachments/597852732/1400438806.png)

No es obligatorio cumplimentar el valor del campo en todos los idiomas.

![](/attachments/597852732/1400438807.png)

Sobre los campos obligatorios de una entidad, como puede ser el título de un proyecto, no es necesario introducir el valor en todos los idiomas, pero sí al menos en uno, sin importar el idioma en el que se introduzca (no tiene por qué ser el prioritario ni el seleccionado en la cabecera.

No es obligatorio tampoco que en una misma pantalla se introduzcan los diferentes campos multi-idioma en los mismos idiomas. Por ejemplo, en la pantalla de proyecto se podría introducir el campo "título" en los tres idiomas y el campo "observaciones" sólo en un idioma, por ejemplo.

![](/attachments/597852732/1400438808.png)

No es necesario guardar los cambios cada vez que se introduzca el valor en un idioma. Todos los cambios se guardarán conjuntamente al pulsar el botón guardar correspondiente a la entidad correspondiente (proyecto, convocatoria, solicitud de evaluación de ética, etc.)

Destacar que los formularios de Memoria del módulo de Ética tienen unas necesidades particulares, ya que el almacenamiento de las respuestas se realiza por bloques completos según la visualización de los mismos en pantalla. Para iniciar el proceso de evaluación de las memorias no se obligará a la cumplimentación de la misma en todos los idiomas, pero sí será necesario que esté cumplimentada por completo en uno de los idiomas (cómo antes puede ser cualquier idioma, no tiene por qué ser el prioritario ni el seleccionado en la cabecera).

#### 10.5 Comportamiento de listados

Los idiomas habilitados en el SGI estarán priorizados de acuerdo a la configuración establecida (apartado [Priorización de idiomas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-10.2Priorizaci%C3%B3ndeidiomas)). El orden de priorización de los idiomas será considerado para la representación del contenido de los campos multilingües sobre pantalla o en la generación de los informes, de forma que si el valor del campo no se encuentra disponible en el idioma seleccionado sobre la aplicación en ese momento, o en el idioma en que se ha de generar un informe, se mostrará el contenido del campo en el primer idioma en el que esté disponible siguiendo el orden de priorización establecido en la configuración. 

Siguiendo esta norma, en los listados que contengan campos multi-idioma, se mostrarán en primera instancia los valores en el idioma seleccionado en la cabecera, pero si en algún caso el campo no hubiese sido introducido en ese idioma se mostrará en cualquier otro idioma de acuerdo a la priorización.

Cuando el idioma en el que se muestra el contenido de un campo no es el seleccionado en la cabecera, se antepone la codificación del idioma para destacar que está siendo mostrado en otro idioma y no en el seleccionado. Cada idioma se representa por un código de tres letras, correspondiente a la norma ISO.

En la siguiente imagen se muestra el resultado del buscador de proyectos, con el idioma de aplicación en Español, mostrando un proyecto en el que el título no está introducido en español. En este caso se muestra el título resaltando que se está mostrando en inglés

![](/attachments/597852732/1400438809.png)

En la siguiente imagen se muestra un ejemplo en el que, siendo el idioma de visualización el euskera, tres de los proyectos no tienen el título introducido en este idioma. Se mostrarán en el idioma más prioritario en el que estén disponibles. En este caso, los dos  primeros proyectos disponen del título en el idioma español, no así el tercero que sólo está disponible en inglés.

![](/attachments/597852732/1400438810.png)

Finalmente un ejemplo adicional en el que, siendo el inglés el idioma de visualización, el primer y el cuarto proyecto se muestran con su título en español al no disponer del valor en el idioma de visualización.

![](/attachments/597852732/1400438811.png)

Los ejemplos anteriores se corresponden con un orden de prioridad: español, inglés, euskera.

#### 10.6 Comportamiento en visualización y edición de entidades

Los idiomas habilitados en el SGI estarán priorizados de acuerdo a la configuración establecida ([Priorización de idiomas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-10.2Priorizaci%C3%B3ndeidiomas)). El orden de priorización de los idiomas será considerado para la representación del contenido de los campos multilingües sobre pantalla o en la generación de los informes, de forma que si el valor del campo no se encuentra disponible en el idioma seleccionado sobre la aplicación en ese momento, o en el idioma en que se ha de generar un informe, se mostrará el contenido del campo en el primer idioma en el que esté disponible siguiendo el orden de priorización establecido en la configuración. 

Cuando se accede al detalle de una entidad para modificar sus datos se mostrará el valor de sus campos tomando como idioma de referencia el seleccionado en la cabecera, pero dando prioridad a mostrar el valor del campo cuando éste no esté cumplimentado en el idioma seleccionado y sí en otro de los idiomas disponibles. Se mostrará el valor de los campos en el idioma seleccionado en la cabecera y si algún campo no estuviera cumplimentado en ese idioma, se mostrará el valor en cualquier otro idioma en el que sí estuviera cumplimentado, siguiendo el orden definido en la priorización. Es decir, al mostrar una entidad en modo edición podrán verse campos en diferentes idiomas, según estén o no cumplimentados en el idioma seleccionado en la cabecera. Se da prioridad a mostrar el valor de los campos en algún idioma, frente a mostrarlos vacíos cuando no están cumplimentados en el idioma seleccionado.

![](/attachments/597852732/1400438813.png)

La imagen anterior muestra la edición de los datos generales de un grupo de investigación. El idioma de visualización es el español. El nombre del grupo sólo se introdujo en inglés y el resumen en español. Al entrar en la pantalla para editar los datos del grupo, el nombre se muestra en el idioma disponible, inglés, no se muestra en español, siendo el idioma de visualización, porque en su momento no se introdujo. Se prima el mostrar los datos informados en el idioma en que estén disponibles (según priorización), frente a mostrar todos los campos en el idioma de visualización cuando están sin cumplimentar.

En el escenario anterior, si lo que se desease fuese, precisamente, introducir el nombre del grupo en español, se debería seleccionar el idioma "spa" en el campo "nombre" y proceder a su introducción.

![](/attachments/597852732/1400438814.png)

Tras introducir el nombre del grupo en español y guardar los datos del grupo

![](/attachments/597852732/1400438815.png)

Cuando se acceda a la edición del grupo teniendo seleccionado el idioma español, ambos campos, "nombre" y "resumen", se mostrarán con sus valores en español:

![](/attachments/597852732/1400438816.png)

En cambio, si se accede a la edición del grupo en idioma inglés se mostrará el campo "nombre" en inglés, pero el campo "resumen" se mostrará en español ya que no fue introducido en inglés.

![](/attachments/597852732/1400438817.png)

Si se accede a la edición del grupo en idioma euskera, ambos campos se muestran con su valor en español (idioma configurado como prioridad inicial) ya que no están disponibles en euskera.

![](/attachments/597852732/1400438818.png)

#### 10.7 Comportamiento de buscadores

Los buscadores aplicarán sin distinción de idioma. Cuando se realicen búsquedas utilizando como filtro los campos multi-idioma incluidos en los buscadores, éstas se aplicarán sobre el valor del campo en cualquiera de los idiomas. Los elementos que cumplan el filtro establecido se mostrarán en el listado de resultados con el siguiente criterio:

* Los campos que tengan valor en el idioma seleccionado en cabecera, se mostrarán en este idioma (aunque el valor en este idioma no contenga la cadena de búsqueda).
* Los campos cuyo valor no haya sido introducido en el idioma seleccionado de visualización, se mostrarán en el idioma para el que contengan valor siguiendo el orden de prioridad establecido (aunque no contengan el valor buscado en ese idioma). Se identificará el idioma en el que se están mostrando.
...
Se aplica la búsqueda por el campo "nombre" de una entidad, siendo el idioma de visualización el español:

![](/attachments/597852732/1400438819.png)

Se aplica una búsqueda por el término "pribat" y el resultado muestra un elemento que tiene por nombre "privado", que en primera instancia no coincide con el término de búsqueda. El idioma de visualización seleccionado es el español, por tanto, el listado contiene los valores de los campos, en primer término, con su valor en español. El resultado que se muestra no contiene el término de búsqueda en su valor en español pero sí en su valor en euskera:

|  |  |  |
| --- | --- | --- |
|  |  |  |

Las búsquedas aplican de manera indistinta sobre todos los valores del campo en los diferentes idiomas. Por ello, la búsqueda por "pribat" devuelve como resultado el elemento indicado. Como el idioma de visualización es el español, se muestra el valor del campo en español (aunque el patrón de búsqueda se dé para el valor del campo en euskera).

Si la misma búsqueda se aplica siendo el inglés el idioma de visualización, el resultado sería el siguiente:

![](/attachments/597852732/1400438823.png)

El resultado de la búsqueda devuelve el mismo elemento que antes, pero ahora el idioma de  visualización seleccionado es el inglés. El elemento a visualizar no tiene informado su valor en idioma inglés sino solamente en español y euskera. Al no estar informado en el idioma de visualización, se muestra en el idioma disponible más prioritario, en este caso el español.

Si la misma búsqueda se aplica con el euskera como idioma de visualización seleccionado, el resultado sería:

![](/attachments/597852732/1400438824.png)

En el listado de resultados se muestra el elemento con el valor del nombre en euskera, puesto que es el idioma de visualización y se dispone del valor en ese idioma. Que además, en este caso, es el idioma que cumple con el término de la búsqueda.

En resumen:

* Se aplican los filtros de búsqueda sin distinguir el idioma, de forma que se mostrarán los elementos para los que el término de búsqueda coincida en alguno de los idiomas.
* El listado de resultados de la búsqueda se muestra siguiendo la norma general de visualización de listados, es decir, mostrando los campos del listado, en primera instancia, con el valor en el idioma visualización y, si no está disponible, con el valor en el idioma siguiente de acuerdo a la priorización establecida.

El término de búsqueda "cit" aparece en los 3 proyectos listados:

* El primer proyecto listado se muestra con su título en español porque éste es el idioma seleccionado y el proyecto tiene el título introducido en español y, además, es el idioma para el que se cumple el patrón de búsqueda.
* Para el segundo proyecto la coincidencia se da en el título en idioma inglés, pero se muestra el valor del título en español de acuerdo al idioma de visualización seleccionado
* Para el tercer proyecto la coincidencia se da en el título en idioma inglés. Además es el idioma en el que se muestra en el listado, puesto que no se dispone del título introducido en español y el inglés es el siguiente idioma en prioridad

![](/attachments/597852732/1400438825.png)

#### 10.8 Generación y descarga de informes

Los informes estarán disponibles para su descarga en el idioma de visualización seleccionado. Para descargar un informe en todos los idiomas se debe de cambiar el idioma de visualización en la cabecera de la aplicación. El informe se genera con el mismo nombre en todos los idiomas. Para guardar una copia en cada idioma debe de renombrarse el fichero en el momento de realizar la descarga.

En la composición de los informes se aplica la priorización de acuerdo a la configuración establecida (apartado Priorización de idiomas). El orden de priorización de los idiomas será considerado para la inclusión del valor de los campos en los informes, de forma que si el valor del campo no se encuentra disponible en el idioma en que se ha de generar un informe, se mostrará el contenido del campo en el primer idioma en el que esté disponible siguiendo el orden de priorización establecido en la configuración. Esto puede suponer que, para un mismo informe, unos campos se incluyan en el idioma de generación del informe y otros en otro idioma, en caso de no disponerse de su valor en el idioma de generación del informe. Si en un informe se incluyen dos campos, como título y observaciones, y el título está disponible en español e inglés  y las observaciones sólo en español, el informe generado en inglés contendrá el campo título en inglés, pero el campo observaciones se incluirá en español, al no estar disponible su valor en inglés.