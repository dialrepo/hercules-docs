...
* Fecha inicio.  Fecha de inicio del proyecto. Es un campo obligatorio para poder pasar el proyecto a estado "Concedido".
  ...
  + Si el proyecto no está asociado a una convocatoria o solicitud, se mostrará un mensaje de aviso cuando se informe por primera vez o cuando se modifique el valor de la fecha de inicio. Ver [Modificación fecha inicio, fin o fin definitiva](https://confluence.treelogic.com/display/HERCULES/CSP-Proyectos#CSPProyectos-4.1.3Datosgenerales-Fichageneral-Modificaci%C3%B3ndefechainicioy/ofechafiny/ofechafindefinitiva)
...
* Fecha fin definitiva. Se muestra el valor actual que podrá ser modificado.
  + Cada vez que se introduzca una [prórroga](https://confluence.treelogic.com/display/HERCULES/CSP-Proyectos#CSPProyectos-pro_prorrogas)en el proyecto, este campo tomará el valor del campo "nueva fecha fin de proyecto", si bien este valor podrá ser modificado.
