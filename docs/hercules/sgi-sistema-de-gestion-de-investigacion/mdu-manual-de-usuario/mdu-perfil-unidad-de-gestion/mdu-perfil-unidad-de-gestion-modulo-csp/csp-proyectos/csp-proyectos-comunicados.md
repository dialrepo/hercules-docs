# CSP-Proyectos-Comunicados

* [1. Introducción](#CSPProyectosComunicados-1.Introducción)
* [2. Aviso fecha prevista del pago a un socio](#CSPProyectosComunicados-2.Avisofechaprevistadelpagoaunsocio)
* [3. Aviso inicio y fin de plazo de presentación de la justificación de un socio](#CSPProyectosComunicados-3.Avisoinicioyfindeplazodepresentacióndelajustificacióndeunsocio)
* [4. Aviso inicio y fin de presentación de seguimiento científico](#CSPProyectosComunicados-4.Avisoinicioyfindepresentacióndeseguimientocientífico)
* [5. Aviso inicio plazo de presentación de la justificación económica](#CSPProyectosComunicados-5.Avisoinicioplazodepresentacióndelajustificacióneconómica)
* [6. Aviso calendario facturación - Notificar IP](#CSPProyectosComunicados-6.Avisocalendariofacturación-NotificarIP)
* [7. Aviso calendario facturación - Validar/Rechazar IP](#CSPProyectosComunicados-7.Avisocalendariofacturación-Validar/RechazarIP)
...
* Comunicados que pueden ser configurados, a través de las pantallas propias de la gestión sobre la que se generan. Desde estas pantallas se podrá configurar el asunto del email, el contenido y las direcciones de destino. Los comunicados configurables de la entidad Proyectos son los incluidos en los apartados [CSP-Proyectos - 4.11.4 Comunicados en fases](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-proyectos#CSPProyectos-4.11.4Comunicadosenfases) y [CSP-Proyectos - 4.12.4 Comunicados de hitos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-proyectos#CSPProyectos-4.12.4Comunicadosdehitos).
...
Se enviará un comunicado cuando el responsable económico y/o investigador principal de un proyecto pulse sobre la acción "Validar/Rechazar IP" para un ítem en el calendario de facturación (Ver [Perfil personal investigador - CSP - 4.2 Calendario facturación-Validación de ítem de facturación](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-investigacion/mdu-perfil-de-investigacion-modulo-csp#MDUPerfildeinvestigaciónMóduloCSP-4.2Calendariofacturaci%C3%B3n-Validaci%C3%B3n%C3%ADtemdefacturaci%C3%B3n)).
