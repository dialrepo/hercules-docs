...
* [1. Introducción](#CSPConvocatorias-1.Introducción)
  + [1.1 Detalle de una convocatoria](#CSPConvocatorias-1.1Detalledeunaconvocatoria)
  + [1.2 Estados de una convocatoria](#CSPConvocatorias-1.2Estadosdeunaconvocatoria)
* [2. Listado y búsqueda de convocatorias](#CSPConvocatorias-2.Listadoybúsquedadeconvocatorias)
  + [2.1 Buscador simple](#CSPConvocatorias-2.1Buscadorsimple)
  + [2.2 Buscador ampliado](#CSPConvocatorias-2.2Buscadorampliado)
  + [2.3 Exportación de convocatorias](#CSPConvocatorias-2.3Exportacióndeconvocatorias)
* [3. Añadir nueva convocatoria](#CSPConvocatorias-con_aniadir3.Añadirnuevaconvocatoria)
  + [3.1 Datos generales](#CSPConvocatorias-con_datos_generales3.1Datosgenerales)
    - [3.1.1 Palabras clave](#CSPConvocatorias-3.1.1Palabrasclave)
    - [3.1.2 Listado de áreas temáticas](#CSPConvocatorias-con_areas_tematicas3.1.2Listadodeáreastemáticas)
  + [3.2 Entidades convocantes](#CSPConvocatorias-con_entidades_convocantes3.2Entidadesconvocantes)
  + [3.3 Entidades financiadoras](#CSPConvocatorias-con_entidades_financiadoras3.3Entidadesfinanciadoras)
  + [3.4 Enlaces](#CSPConvocatorias-3.4Enlaces)
  + [3.5 Fases](#CSPConvocatorias-con_fases3.5Fases)
    - [3.5.1 Comunicados de fases](#CSPConvocatorias-3.5.1Comunicadosdefases)
    - [3.5.2 Destinatarios de comunicados](#CSPConvocatorias-3.5.2Destinatariosdecomunicados)
  + [3.6 Periodos de justificación](#CSPConvocatorias-3.6Periodosdejustificación)
  + [3.7 Seguimiento científico](#CSPConvocatorias-3.7Seguimientocientífico)
  + [3.8 Hitos](#CSPConvocatorias-3.8Hitos)
    - [3.8.1 Comunicados de hitos](#CSPConvocatorias-3.8.1Comunicadosdehitos)
  + [3.9 Documentos](#CSPConvocatorias-3.9Documentos)
    - [3.9.1 Añadir documento](#CSPConvocatorias-3.9.1Añadirdocumento)
    - [3.9.2 Modificar documento](#CSPConvocatorias-3.9.2Modificardocumento)
    - [3.9.3 Eliminar documento](#CSPConvocatorias-3.9.3Eliminardocumento)
    - [3.9.4 Descargar fichero](#CSPConvocatorias-3.9.4Descargarfichero)
  + [3.10 Requisitos IP](#CSPConvocatorias-3.10RequisitosIP)
  + [3.11 Requisitos equipo](#CSPConvocatorias-3.11Requisitosequipo)
  + [3.12 Elegibilidad](#CSPConvocatorias-3.12Elegibilidad)
  + [3.13 Partidas presupuestarias](#CSPConvocatorias-con_partidas_presupuestarias3.13Partidaspresupuestarias)
  + [3.14 Configuración de solicitudes](#CSPConvocatorias-3.14Configuracióndesolicitudes)
  + [3.15 Datos obligatorios para crear una convocatoria](#CSPConvocatorias-con_datos_obligatorios3.15Datosobligatoriosparacrearunaconvocatoria)
* [4. Modificar una convocatoria](#CSPConvocatorias-con_modificar4.Modificarunaconvocatoria)
  + [4.1 Restricciones en la modificación de convocatorias en estado "borrador"](#CSPConvocatorias-4.1Restriccionesenlamodificacióndeconvocatoriasenestado"borrador")
    - [4.1.1 Pantalla Datos generales](#CSPConvocatorias-con_modificar_borrador_datos_generales4.1.1PantallaDatosgenerales)
    - [4.1.2 Fases](#CSPConvocatorias-con_modificar_borrador_fases4.1.2Fases)
  + [4.2 Restricciones en la modificación de convocatorias en estado "registrada"](#CSPConvocatorias-con_modificacion_registrada4.2Restriccionesenlamodificacióndeconvocatoriasenestado"registrada")
    - [4.2.1 Datos generales](#CSPConvocatorias-4.2.1Datosgenerales)
      * [4.2.1.1 Unidad de gestión y modelo de ejecución](#CSPConvocatorias-4.2.1.1Unidaddegestiónymodelodeejecución)
      * [4.2.1.2 Tipo solicitud SGI](#CSPConvocatorias-4.2.1.2TiposolicitudSGI)
      * [4.2.1.3 Duración](#CSPConvocatorias-4.2.1.3Duración)
      * [4.2.1.4 Régimen concurrencia](#CSPConvocatorias-4.2.1.4Régimenconcurrencia)
      * [4.2.1.5 Clasificación producción científica/CVN](#CSPConvocatorias-4.2.1.5Clasificaciónproduccióncientífica/CVN)
      * [4.2.1.6 Entidad gestora](#CSPConvocatorias-4.2.1.6Entidadgestora)
      * [4.2.1.7 Listado de áreas temáticas](#CSPConvocatorias-4.2.1.7Listadodeáreastemáticas)
    - [4.2.2 Entidades convocantes](#CSPConvocatorias-4.2.2Entidadesconvocantes)
    - [4.2.3 Entidades financiadoras](#CSPConvocatorias-4.2.3Entidadesfinanciadoras)
    - [4.2.4 Fases](#CSPConvocatorias-4.2.4Fases)
    - [4.2.5 Partidas presupuestarias](#CSPConvocatorias-4.2.5Partidaspresupuestarias)
* [5. Cambiar estado a una convocatoria](#CSPConvocatorias-5.Cambiarestadoaunaconvocatoria)
  + [Datos obligatorios para "registrar" una convocatoria](#CSPConvocatorias-con_datos_obligatorios_registrarDatosobligatoriospara"registrar"unaconvocatoria)
* [6. Eliminar una convocatoria](#CSPConvocatorias-6.Eliminarunaconvocatoria)
* [7. Recuperar una convocatoria eliminada](#CSPConvocatorias-7.Recuperarunaconvocatoriaeliminada)
* [8. Clonar una convocatoria](#CSPConvocatorias-8.Clonarunaconvocatoria)
* [9. Creación de solicitudes y proyectos asociados a la convocatoria](#CSPConvocatorias-9.Creacióndesolicitudesyproyectosasociadosalaconvocatoria)
  + [9.1 Campos de la convocatoria que se copian a la solicitud](#CSPConvocatorias-9.1Camposdelaconvocatoriaquesecopianalasolicitud)
  + [9.2 Campos de la convocatoria que se copian al proyecto](#CSPConvocatorias-9.2Camposdelaconvocatoriaquesecopianalproyecto)
  + [9.3 Navegación a las solicitudes y proyectos de una convocatoria](#CSPConvocatorias-9.3Navegaciónalassolicitudesyproyectosdeunaconvocatoria)
...
Las convocatorias creadas en el SGI podrán ser visibles para el personal investigador, a través de su acceso al SGI ([MDU - Perfil de investigación](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-de-investigacion)). La información que tendrán disponible será la que haya sido transcrita al SGI por la unidad de gestión, que podrá incluir los enlaces web y/o la documentación facilitada por el organismo convocante/financiador, pero el ciclo de vida de la convocatoria en el SGI será independiente del proceso que siga la misma en el organismo correspondiente.
...
![](https://treetk.atlassian.net/wiki/download/thumbnails/178773251/202407_con_datos_generales.png?version=7&modificationDate=1720090048177&cacheVersion=1&api=v2&width=1000&height=561)
...
Existen unos campos obligatorios mínimos para poder crear una convocatoria en estado borrador (Ver [Datos obligatorios para crear una convocatoria](#CSPConvocatorias-con_datos_obligatorios)) y, del mismo modo, unos campos mínimos para poder pasarla a estado registrada (Ver [Datos obligatorios para registrar una convocatoria](#CSPConvocatorias-con_datos_obligatorios_registrar)).

### 2. Listado y búsqueda de convocatorias

El acceso a la gestión de convocatorias ocupa el la primera posición en el menú del módulo CSP.  Siguiendo la estructura general del SGI, tras pulsar en el menú Convocatorias se accede a la página inicial que contiene el listado de convocatorias y su buscador, que sigue las normas básicas descritas en [MDU - 3.2 Buscadores y listados](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-3.2Buscadoresylistados).

![](https://treetk.atlassian.net/wiki/download/thumbnails/178773251/202407_con_listado_inicial_ed.png?version=1&modificationDate=1720087450097&cacheVersion=1&api=v2&width=1000&height=478)

Por defecto, se listan todas las convocatorias disponibles sobre una tabla de resultados paginada, [MDU-Manual de usuario - 3.5 Paginación de listados](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-3.5Paginaci%C3%B3ndelistados).  La tabla muestra una serie de campos significativos:

* Título: Título que se ha dado a la convocatoria en el SGI.
* Referencia externa: Identificación o referencia de la convocatoria, otorgado por el organismo convocante. Es una cadena alfanumérica que identifica a nivel general la convocatoria.
...
* Referencia externa. Si se introduce una cadena en este filtro, se mostrarán las convocatorias que contengan la cadena introducida en cualquier parte del campo "referencia externa".
...
![](https://treetk.atlassian.net/wiki/download/thumbnails/178773251/Captura%20de%20pantalla%20de%202024-09-04%2009-25-42.png?version=1&modificationDate=1725434791005&cacheVersion=1&api=v2&width=1000&height=527)
...
* Plan/programa investigación. Este campo permite especificar una plan o un programa de investigación. Se realizará  la búsqueda de todas las convocatorias cuyas entidades convocantes estén asociadas al elemento seleccionado en el árbol o cualquiera que derive del mismo. Para indicar el plan o el programa se utilizará el buscador común de plan/programa de investigación [MDU - Manual de usuario#7.7Selector de plan/programa de investigación](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-7.7Selectordeplan/programadeinvestigaci%C3%B3n).
...
El listado de convocatorias obtenido del buscador puede ser exportado siguiendo los criterios generales indicados en [MDU - Exportación de listados](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-3.6Exportaci%C3%B3ndelistados). 

![](https://treetk.atlassian.net/wiki/download/thumbnails/178773251/202407_con_listado_inicial_exportar_ed.png?version=1&modificationDate=1720087981905&cacheVersion=1&api=v2&width=1000&height=478)
...
![](https://treetk.atlassian.net/wiki/download/thumbnails/178773251/202407_con_listado_inicial.png?version=1&modificationDate=1720088197959&cacheVersion=1&api=v2&width=1000&height=478)
...
El desplegable "Listado áreas temáticas" contendrá los listados activos creados a través de la opción de Configuración [Áreas temáticas](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134296892#CSPConfiguraci%C3%B3n-9.Listadosde%C3%A1reastem%C3%A1ticas). 
...
El campo "ámbito" mostrado en la tabla del listado de entidades financiadoras se corresponde con el ámbito geográfico de la fuente de financiación ([ver detalle](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134296892#CSPConfiguraci%C3%B3n-10.Fuentesdefinanciaci%C3%B3n)). 
...
El funcionamiento y condiciones para el caso de que se quieran generar avisos, que en el SGI denominaremos también comunicados, se describe más a detalle en el apartado [Comunicados de fases](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-convocatorias#CSPConvocatorias-3.5.1Comunicadosdefases).
...
1. * Utilizando el texto introducido + el botón buscar para abrir el buscador de personas con el resultado de la búsqueda por dicho texto ya cargada, con la operativa descrita en [MDU-Manual de usuario - 8.1.1 Buscar personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-8.1.1Buscarpersonas).
...
1. Se tecleará el email completo en el componente "Destinatarios" en la zona donde aparece el texto "Añadir destinatario ...", por ejemplo, "[jimancas.lopez@educastur.org](mailto:jimancas.lopez@educastur.org)":
...
El funcionamiento y condiciones para el caso de que se quieran generar avisos, que en el SGI denominaremos también comunicados, se describe más a detalle en el apartado [Comunicados de hitos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-convocatorias#CSPConvocatorias-3.8.1Comunicadosdehitos).
...
* Asunto. Será necesario informar un asunto para el email. Se mostrará un asunto por defecto, según lo que se haya configurado en la Universidad en el momento de la implantación para este tipo de comunicados y para la unidad de gestión a la que pertenezca la convocatoria. Este asunto podrá ser modificado por el usuario.
* Contenido del email. Será necesario informar un contenido o cuerpo para el email. Se mostrará un contenido por defecto, según lo que se haya configurado en la Universidad en el momento de la implantación para este tipo de comunicados y para la unidad de gestión a la que pertenezca la convocatoria. Al contenido por defecto, se concatenarán además, en caso de haberse informado, las observaciones introducidas por el usuario antes de marcar el indicador "Generar aviso". Este contenido podrá ser modificado por el usuario.
* Destinatarios. Será necesario informar al menos un destinatario del email de aviso, pero podrá definirse una lista. Esta lista de destinatarios del email serán adicionales a los que añadirán los indicadores "Añadir IPs solicitud" y "Añadir IPs proyecto", si se marcan. Se mostrarán unos destinatarios por defecto según lo configurado en la Universidad en el momento de la implantación para este tipo de comunicados y para la unidad de gestión a la que pertenezca la convocatoria. Esta lista podrá ser modificada por el usuario según lo descrito en el apartado [Destinatarios de comunicados](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-convocatorias#CSPConvocatorias-3.5.2Destinatariosdecomunicados) que, si bien se basa en la configuración dentro de una fase, tiene el comportamiento equivalente para el caso de los hitos.
* Añadir IPs solicitud. De manera opcional, se puede indicar si se quiere añadir a los IPs de las solicitudes asociadas a la convocatoria como destinatarios del email de aviso. Estos destinatarios no se mostrarán ni se guardarán en el campo "Destinatarios" ya que se resolverán en el día y hora en el que se haya programado el envío del aviso.
* Añadir IPs proyecto. De manera opcional, se puede indicar si se quiere añadir a los IPs de los proyectos asociados a las solicitudes de la convocatoria como destinatarios del email de aviso. Estos destinatarios no se mostrarán ni se guardarán en el campo "Destinatarios" ya que se resolverán en el día y hora en el que se haya programado el envío del aviso.
...
Para la fase seleccionada como plazo de presentación de solicitudes aplican las restricciones de modificación indicadas en el apartado "[modificar convocatoria](#CSPConvocatorias-con_modificar_borrador_fases)".
...
![](https://treetk.atlassian.net/wiki/download/thumbnails/178773251/202407_con_datos_generales_obligatorios.png?version=1&modificationDate=1720090366077&cacheVersion=1&api=v2&width=1000&height=562)
...
Consultar los detalles de visualización en el apartado [datos generales](#CSPConvocatorias-con_modificacion_borrador_datos_generales) de las restricciones de modificación en estado borrador.
...
No se podrán realizar modificaciones sobre la fase seleccionada para configurar el plazo de presentación de las solicitudes en el apartado "Configuración solicitudes". Aplicarán las mismas restricciones indicadas en [Modificación de convocatoria en estado borrador - Fases](#CSPConvocatorias-con_modificar_borrador_fases).
...
* Dejarán de ser modificables determinados campos y/o apartados. Ver [Apartados modificables sobre convocatorias en estado "registrada"](#CSPConvocatorias-con_modificacion_registrada).
