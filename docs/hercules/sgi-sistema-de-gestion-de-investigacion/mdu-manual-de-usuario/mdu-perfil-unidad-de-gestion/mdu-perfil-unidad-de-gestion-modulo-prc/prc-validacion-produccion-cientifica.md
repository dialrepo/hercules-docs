...
* [Validación producción científica](#PRCValidaciónproduccióncientífica-Validaciónproduccióncientífica)
  + [Publicaciones](#PRCValidaciónproduccióncientífica-Publicaciones)
    - [Ver/consultar publicación](#PRCValidaciónproduccióncientífica-Ver/consultarpublicación)
  + [Congresos](#PRCValidaciónproduccióncientífica-Congresos)
    - [Ver/consultar congreso](#PRCValidaciónproduccióncientífica-Ver/consultarcongreso)
  + [Obras Artísticas](#PRCValidaciónproduccióncientífica-ObrasArtísticas)
    - [Ver/consultar obra artística](#PRCValidaciónproduccióncientífica-Ver/consultarobraartística)
  + [Comités Editoriales](#PRCValidaciónproduccióncientífica-ComitésEditoriales)
    - [Ver/consultar comités editorial](#PRCValidaciónproduccióncientífica-Ver/consultarcomitéseditorial)
  + [Dirección de Tesis/TFM/TFG](#PRCValidaciónproduccióncientífica-DireccióndeTesis/TFM/TFG)
    - [Ver/consultar dirección de tesis/TFM/TFG](#PRCValidaciónproduccióncientífica-Ver/consultardireccióndetesis/TFM/TFG)
  + [Organización Actividades I+D+i](#PRCValidaciónproduccióncientífica-OrganizaciónActividadesI+D+i)
    - [Ver/consultar organización actividad I+D+i](#PRCValidaciónproduccióncientífica-Ver/consultarorganizaciónactividadI+D+i)
  + [Validar item](#PRCValidaciónproduccióncientífica-Validaritem)
  + [Rechazar item](#PRCValidaciónproduccióncientífica-Rechazaritem)
* [Anexo](#PRCValidaciónproduccióncientífica-Anexo)
  + [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproduccióncientífica)
...
* **Autor/a**: campo para buscar por nombre o apellidos o email de uno de los autores del item de publicación. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de personas para realizar una búsqueda mas concreta y poder seleccionar la persona en cuestión por la que se quiere buscar. Ver apartado [MDU-Manual de usuario - 8.1.1 Buscar personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-8.1.1Buscarpersonas) para mas detalle de la funcionalidad del buscador.
* **Grupo de investigación**: campo para buscar por nombre del grupo de investigación cuyo IP sea uno de los IP que tenga que validar el item o haya validado el item. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de grupos de investigación para realizar una búsqueda mas concreta y poder seleccionar el grupo en cuestión por el que se quiere buscar. Ver apartado [MDU-Manual de usuario - 7.4 Buscador de grupos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-7.4Buscadordegrupos) para mas detalle de la funcionalidad del buscador.
...
![](/attachments/597853641/597881900.png)
...
* **Estado**: estado actual de la publicación. Para mas detalle ver anexo [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica).
...
* VALIDAR: Ver detalle en el apartado [Validar item](#PRCValidaciónproduccióncientífica-Validaritem)
* RECHAZAR: Ver detalle en el apartado [Rechazar item](#PRCValidaciónproduccióncientífica-Rechazaritem)
...
* **Autor/a**: campo para buscar por nombre o apellidos o email de uno de los autores del item del congreso. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de personas para realizar una búsqueda mas concreta y poder seleccionar la persona en cuestión por la que se quiere buscar. Ver apartado [MDU-Manual de usuario - 8.1.1 Búsqueda de personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-8.1.1Buscarpersonas) para mas detalle de la funcionalidad del buscador.
* **Grupo de investigación**: campo para buscar por nombre del grupo de investigación cuyo IP sea uno de los IP que tenga que validar el item o haya validado el item. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de grupos de investigación para realizar una búsqueda mas concreta y poder seleccionar el grupo en cuestión por el que se quiere buscar. Ver apartado [MDU-Manual de usuario - 7.4 Buscador de grupos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-7.4Buscadordegrupos) para mas detalle de la funcionalidad del buscador.
...
* **Estado**: estado del item de congreso, puede tener uno de los valores comentados en el apartado [Estados de un item de producción científica](https://confluence.um.es/confluence/pages/viewpage.action?pageId=141923910#MDUPerfilunidaddegestiónPRCGestor/a-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica)

Tras pulsar el botón “Buscar”, se muestra el listado de items de "Trabajos presentados en congresos nacionales o internacionales" (provenientes de la aplicación CVN) que cumplan con los parámetros introducidos en el formulario. Por defecto se realiza la búsqueda aplicando el filtro por estado "Pendiente" o "Validado parcialmente", es decir, se recuperan todos aquellos items de "Trabajos presentados en congresos nacionales o internacionales" enviados por el personal de investigación desde la aplicación CVN al módulo de PRC cuyo estado sea "Pendiente" o "Validado parcialmente". Ver anexo [Estados de un item de producción científica](https://confluence.um.es/confluence/pages/viewpage.action?pageId=141923910#MDUPerfilunidaddegestiónPRCGestor/a-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica)
...
![](/attachments/597853641/597877421.png)
...
* **Estado**: estado actual del congreso. Para mas detalle ver anexo [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica).
...
* **Autor/a**: campo para buscar por nombre o apellidos o email de uno de los autores del item de la obra. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de personas para realizar una búsqueda mas concreta y poder seleccionar la persona en cuestión por la que se quiere buscar. Ver apartado [MDU-Manual de usuario - Búsqueda de personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-B%C3%BAsqueda) para mas detalle de la funcionalidad del buscador.
* **Grupo de investigación**: campo para buscar por nombre del grupo de investigación cuyo IP sea uno de los IP que tenga que validar el item o haya validado el item. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de grupos de investigación para realizar una búsqueda mas concreta y poder seleccionar el grupo en cuestión por el que se quiere buscar. Ver apartado [MDU-Manual de usuario - Buscador de grupos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-Buscadordegrupos) para mas detalle de la funcionalidad del buscador.
...
* **Fecha inicio hasta**: campo para introducir la fecha la cual se va a tomar como referencia para obtener los items de obras artísticas cuya fecha de comienzo de la exposición sea menor o igual a esta fecha.
* **Estado**: estado del item de obra artística, puede tener uno de los valores comentados en el apartado [Estados de un item de producción científica](https://confluence.um.es/confluence/pages/viewpage.action?pageId=141923910#MDUPerfilunidaddegestiónPRCGestor/a-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica)
...
* **Estado**: estado actual de la obra artística. Para mas detalle ver anexo [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica).
...
* **Autor/a**: campo para buscar por nombre o apellidos o email de uno de los autores del item del comité editorial. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de personas para realizar una búsqueda mas concreta y poder seleccionar la persona en cuestión por la que se quiere buscar. Ver apartado [MDU-Manual de usuario - Búsqueda de personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-B%C3%BAsqueda) para mas detalle de la funcionalidad del buscador.
* **Grupo de investigación**: campo para buscar por nombre del grupo de investigación cuyo IP sea uno de los IP que tenga que validar el item o haya validado el item. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de grupos de investigación para realizar una búsqueda mas concreta y poder seleccionar el grupo en cuestión por el que se quiere buscar. Ver apartado [MDU-Manual de usuario - Buscador de grupos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-Buscadordegrupos) para mas detalle de la funcionalidad del buscador.
...
* **Estado**: estado del item de comité editorial, puede tener uno de los valores comentados en el apartado [Estados de un item de producción científica](https://confluence.um.es/confluence/pages/viewpage.action?pageId=141923910#MDUPerfilunidaddegestiónPRCGestor/a-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica)
...
* **Estado**: estado actual del comité editorial Para mas detalle ver anexo [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica).
...
* **Director/a**: campo para buscar por nombre o apellidos o email de uno de los directores del item de dirección de tesis y/o trabajo fin de máster o grado. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de personas para realizar una búsqueda mas concreta y poder seleccionar la persona en cuestión por la que se quiere buscar. Ver apartado [MDU-Manual de usuario - Búsqueda de personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-B%C3%BAsqueda) para mas detalle de la funcionalidad del buscador.
* **Grupo de investigación**: campo para buscar por nombre del grupo de investigación cuyo IP sea uno de los IP que tenga que validar el item o haya validado el item. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de grupos de investigación para realizar una búsqueda mas concreta y poder seleccionar el grupo en cuestión por el que se quiere buscar. Ver apartado [MDU-Manual de usuario - Buscador de grupos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-Buscadordegrupos) para mas detalle de la funcionalidad del buscador.
...
* **Estado**: estado del item de dirección de tesis, puede tener uno de los valores comentados en el apartado [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica)
...
![](/attachments/597853641/597877411.png)
...
* **Estado**: estado actual de la dirección de tesis. Para mas detalle ver anexo [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica).
...
* **Autor/a**: campo para buscar por nombre o apellidos o email de uno de los autores del item de organización de la actividad de I+D+i. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de personas para realizar una búsqueda mas concreta y poder seleccionar la persona en cuestión por la que se quiere buscar. Ver apartado [MDU-Manual de usuario - 8.1.1 Búsqueda de personas](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-8.1.1Buscarpersonas) para mas detalle de la funcionalidad del buscador.
* **Grupo de investigación**: campo para buscar por nombre del grupo de investigación cuyo IP sea uno de los IP que tenga que validar el item o haya validado el item. Se podrá pulsar sobre el icono de la lupa para abrir el buscar genérico de grupos de investigación para realizar una búsqueda mas concreta y poder seleccionar el grupo en cuestión por el que se quiere buscar. Ver apartado [MDU-Manual de usuario - 7.4 Buscador de grupos](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario#MDUManualdeusuario-7.4Buscadordegrupos) para mas detalle de la funcionalidad del buscador.
...
* **Estado**: estado del item de organización de actividad, puede tener uno de los valores comentados en el apartado [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica)
...
* **Estado**: estado actual de la organización de actividad. Para mas detalle ver anexo [Estados de un item de producción científica](#PRCValidaciónproduccióncientífica-Estadosdeunitemdeproducci%C3%B3ncient%C3%ADfica).
