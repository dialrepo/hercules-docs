# IU-PRC-0201-009 - Ver comité editorial - Investigador

|  |  |
| --- | --- |
| Cod. IU | ********IU-PRC-0201-009 - Ver comité editorial - Investigador******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado |  |
| Fec. Aprobación |  |
...
| Fuente de impacto | Texto corto  Enumerado | Campo "fuenteImpacto" de la tabla "IndiceImpacto". Valor del enumerado TipoFuenteImpacto.  Excepción: Si el valor de este campo es "OTHERS" y esta informado el campo "otraFuenteImpacto", entonces se muestra la concatenación de "TipoFuenteImpacto.OTHERS - otraFuenteImpacto". En caso de que no este informado el campo "otraFuenteImpacto" únicamente sale el valor del enumerado TipoFuenteImpacto.OTHERS. |
...
|  |  |
| --- | --- |
| ACT-PRC-001-Investigador | PRC-VAL-INV-ER, CSP-PRO-PRC-V |
