# IU-PRC-0200-008 Búsqueda y listado de comités editoriales - Unidades de gestión

|  |  |
| --- | --- |
| Cod. IU | ********IU-PRC-0200-008 Búsqueda y listado de comités editoriales - Unidades de gestión******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado |  |
| Fec. Aprobación |  |
...
| Buscar | Aplica los filtros introducidos sobre la lista de comités editoriales mostrando las que cumplen las condiciones |  | PRC-VAL-V  PRC-VAL-E |
| Limpiar | Elimina los datos introducidos en el formulario de búsqueda |  |  |
| Ver | Muestra la pantalla de validación del comité editorial | Da acceso al detalle del item:  [IU-PRC-0200-009 - Ver comité editorial - Unidad de gestión](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/prc-modulo-de-produccion-cientifica/prc-interfaz-de-usuario/iu-prc-0200-validacion-produccion-cientifica-unidad-de-gestion/iu-prc-0200-009-ver-comite-editorial-unidad-de-gestion) | PRC-VAL-E  PRC-VAL-V |
