# IU-PRC-0200-005 - Ver congreso - Unidad de gestión

|  |  |
| --- | --- |
| Cod. IU | ********IU-PRC-0200-005 - Ver congreso - Unidad de gestión******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado |  |
| Fec. Aprobación |  |
...
## Formulario Ver congreso - Unidad de gestión
...
La unidad de gestión podrá Validar o Rechazar el item de trabajo presentado en un congreso.
...
| Fuente de impacto | Texto corto  Enumerado | Campo "fuenteImpacto" de la tabla "IndiceImpacto". Valor del enumerado TipoFuenteImpacto. |
| Año | Número entero | Campo "anio" de la tabla "IndiceImpacto". |
| Ranking | Texto corto  Enumerado | Campo "ranking" de la tabla "IndiceImpacto". Valor del enumerado TipoRanking |
...
| Fecha fin | Fecha | Fecha de finalización del proyecto  A partir de la referencia del proyecto (campo "proyectoRef" ) se consultará el detalle del proyecto y se recuperará el campo "fecha fin definitiva" de la tabla "proyecto" si esta informada y sino el campo "fecha fin" de la tabla "proyecto" |
...
| URL | Texto largo | URL acreditativa en repositorios ajenos a la Universidad  Campo "URL" de la tabla "Acreditacion" |
...
|  |  |
| --- | --- |
| ACT-PRC-003-Gestor | PRC-VAL-E, CSP-PRO-PRC-V |
| **ACT-PRC-004-Visor** | PRC-VAL-V, CSP-PRO-PRC-V |
