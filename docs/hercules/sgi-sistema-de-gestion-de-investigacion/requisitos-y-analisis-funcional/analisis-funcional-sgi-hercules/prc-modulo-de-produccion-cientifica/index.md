...
* [Introducción](#PRCMódulodeproduccióncientífica-Introducción)
* [Tipología y datos de la producción cientifíca](#PRCMódulodeproduccióncientífica-Tipologíaydatosdelaproduccióncientifíca)
* [Introducción de la información](#PRCMódulodeproduccióncientífica-Introduccióndelainformación)
  + [Forma automática SGI](#PRCMódulodeproduccióncientífica-FormaautomáticaSGI)
  + [Forma automática CVN](#PRCMódulodeproduccióncientífica-FormaautomáticaCVN)
    - [Flujo de validación nuevo item en el CVN](#PRCMódulodeproduccióncientífica-FlujodevalidaciónnuevoitemenelCVN)
    - [Flujo de validación de un item modificado en el CVN (en estado Validado)](#PRCMódulodeproduccióncientífica-FlujodevalidacióndeunitemmodificadoenelCVN(enestadoValidado))
    - [Flujo de validación de un item modificado en el CVN (en estado Rechazado)](#PRCMódulodeproduccióncientífica-FlujodevalidacióndeunitemmodificadoenelCVN(enestadoRechazado))
  + [Forma automática integraciones Universidad](#PRCMódulodeproduccióncientífica-FormaautomáticaintegracionesUniversidad)
* [Convocatorias](#PRCMódulodeproduccióncientífica-Convocatorias)
  + [Nueva Convocatoria](#PRCMódulodeproduccióncientífica-NuevaConvocatoria)
    - [Datos Generales](#PRCMódulodeproduccióncientífica-DatosGenerales)
    - [Baremos y puntuaciones](#PRCMódulodeproduccióncientífica-Baremosypuntuaciones)
    - [Moduladores y rangos](#PRCMódulodeproduccióncientífica-Moduladoresyrangos)
* [Informes](#PRCMódulodeproduccióncientífica-Informes)
* [Modelo lógico](#PRCMódulodeproduccióncientífica-Modelológico)
...
3. Al recibirlo el SGI lo notificará al IP o IPs del grupo o grupos de investigación al que pertenecen los investigadores que forman parte del item. La notificación se hará a través del módulo de [CU-COM-0020 - Generar comunicado](https://confluence.um.es/confluence/display/HERCULES/CU-COM-0020+-+Generar+comunicado). Se recorrerán todos los autores del item y se mirará por cada autor al grupo o grupos de investigación al que pertenece actualmente. Una vez que se tiene la lista de grupos de investigación que tienen que validar el item se enviará el comunicado al investigador principal de cada uno de los grupos. El item se considerará totalmente validado (se cambia el estado a "Validado") cuando todos los IP de los grupos lo valide. Un item no tiene que estar completamente validado para contabilizar para la baremación del ACI, si por ejemplo un item de publicación científica tiene 4 autores, y 2 de ellos forman parte del Grupo de investigación 1 y otros dos del Grupo de investigación 2 y únicamente lo ha validado el IP del Grupo de investigación 1, ese item contará para la baremación del Grupo 1 y no para la del Grupo 2 (tendrá un estado "Validado parcialmente").
