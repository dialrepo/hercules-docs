# REQ-INT-0010-SGE-0103 - Detalle gasto

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0010-SGE-0103 - Detalle gasto** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es: [SGI - ESB - SGE - Ejecución económica - Consultar detalle de gasto](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sge/sgi-esb-sge-ejecucion-economica/sgi-esb-sge-ejecucion-economica-consultar-detalle-de-gasto).
