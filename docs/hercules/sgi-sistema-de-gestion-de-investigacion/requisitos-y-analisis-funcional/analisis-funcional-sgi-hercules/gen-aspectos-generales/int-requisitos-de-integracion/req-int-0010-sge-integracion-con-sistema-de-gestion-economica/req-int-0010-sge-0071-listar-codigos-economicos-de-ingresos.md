# REQ-INT-0010-SGE-0071 - Listar códigos económicos de ingresos

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0010-SGE-0071 - Listar códigos económicos de ingresos** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGE - Proyecto SGE y presupuesto - Listar códigos económicos de ingresos](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sge/sgi-esb-sge-proyecto-sge-y-presupuesto/sgi-esb-sge-proyecto-sge-y-presupuesto-servicios-basicos/sgi-esb-sge-proyecto-sge-y-presupuesto-listar-codigos-economicos-de-ingresos).
