# REQ-INT-0013-SGEPII-0020 - Buscar facturas emitidas - Ingresos

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0013-SGEPII-0020 - Buscar facturas emitidas-ingresos** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
* [SGI - ESB - SGEPII - Buscar columnas de ingresos](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgepii/sgi-esb-sgepii-buscar-columnas-de-ingresos)
  + Se llamará en primer lugar para obtener las columnas de ingresos que se han de presentar por pantalla.
* [SGI - ESB - SGEPII - Buscar ingresos](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgepii/sgi-esb-sgepii-buscar-ingresos)
