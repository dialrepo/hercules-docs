# REP-PII-0010 - Listado general de solicitudes de protección - Formato csv

|  |  |
| --- | --- |
| Cod. REP | **REP-PII-0010 - Listado general de solicitudes de protección - Formato csv** |
| Ver. Objetivo |  |
| Ver. REP | 1.0.0 |
| Estado | PENDIENTE |
| Fec. Aprobación |  |
...
Ejemplo: [solicitudes\_proteccion\_with\_columns\_repeated.csv](/attachments/597852844/597858700.csv)
