# REP-CSP-0033 - Listado general de convocatorias - Formato pdf

|  |  |
| --- | --- |
| Cod. REP | **REP-CSP-0033 - Listado general de convocatorias - Formato pdf** |
| Ver. Objetivo |  |
| Ver. REP | 1.0.0 |
| Estado | PENDIENTE |
| Fec. Aprobación |  |
...
Ejemplo de formato de datos: [proyectos\_with\_list.pdf](/attachments/597852461/597865736.pdf) al que se de debe de incorporar la visualización en varias filas, de manera semejante a la imagen mostrada previamente.
