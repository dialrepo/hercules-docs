# REP-CSP-0032 - Listado general de convocatorias - Formato rtf

|  |  |
| --- | --- |
| Cod. REP | **REP-CSP-0032 - Listado general de convocatorias - Formato rtf** |
| Ver. Objetivo |  |
| Ver. REP | 1.0.0 |
| Estado | PENDIENTE |
| Fec. Aprobación |  |
...
Ejemplo de formato de datos:  [proyectos\_with\_list.rtf](/attachments/597852256/597865714.rtf) al que se de debe de incorporar la visualización en varias filas, de manera semejante a la imagen mostrada previamente.
