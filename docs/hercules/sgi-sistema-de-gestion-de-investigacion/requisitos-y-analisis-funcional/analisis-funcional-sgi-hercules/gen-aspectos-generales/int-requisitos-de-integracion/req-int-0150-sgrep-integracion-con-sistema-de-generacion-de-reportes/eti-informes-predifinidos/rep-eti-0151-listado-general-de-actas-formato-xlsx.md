# REP-ETI-0151 - Listado general de actas - Formato xlsx

|  |  |
| --- | --- |
| Cod. REP | **REP-ETI-0151 - Listado general de actas - Formato xlsx** |
| Ver. Objetivo |  |
| Ver. REP | 1.0.0 |
| Estado | PENDIENTE |
| Fec. Aprobación |  |
...
Ejemplo: [acta\_with\_columns\_repeated.xlsx](/attachments/597852287/597865628.xlsx)
...
|  |  |
| --- | --- |
| ACT-ETI-001-Gestor | ETI-ACT-V, ETI-ACT-E |
