# REP-CSP-0037 - Listado general de grupos de investigación - Formato pdf

|  |  |
| --- | --- |
| Cod. REP | **REP-CSP-0037 - Listado general de grupos de investigación - Formato pdf** |
| Ver. Objetivo |  |
| Ver. REP | 1.0.0 |
| Estado | PENDIENTE |
| Fec. Aprobación |  |
...
Ejemplo:  [grupo\_with\_list.pdf](/attachments/597852499/597858357.pdf)
