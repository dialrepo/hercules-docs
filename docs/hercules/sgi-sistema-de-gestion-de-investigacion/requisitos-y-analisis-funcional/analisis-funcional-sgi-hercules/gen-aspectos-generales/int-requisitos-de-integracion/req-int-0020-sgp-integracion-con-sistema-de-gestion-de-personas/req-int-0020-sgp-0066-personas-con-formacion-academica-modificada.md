# REQ-INT-0020-SGP-0066 - Personas con formación académica modificada

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0020-SGP-0066 - Personas con formación académica modificada** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGP - Personas - Consultar personas con modificaciones en formación](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgp/sgi-esb-sgp-servicios-pasarela/sgi-esb-sgp-personas-consultar-personas-con-modificaciones-en-formacion).
