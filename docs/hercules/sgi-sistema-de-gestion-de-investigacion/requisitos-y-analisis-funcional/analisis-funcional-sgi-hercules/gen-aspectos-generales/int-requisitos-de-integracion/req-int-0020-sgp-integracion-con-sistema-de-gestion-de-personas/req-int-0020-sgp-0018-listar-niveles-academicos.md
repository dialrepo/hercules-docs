# REQ-INT-0020-SGP-0018 - Listar niveles académicos

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0020-SGP-0018 - Listar niveles académicos** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGP - Niveles académicos - Listar](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgp/sgi-esb-sgp-servicios-basicos/sgi-esb-sgp-niveles-academicos-listar).
