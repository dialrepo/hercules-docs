# REQ-INT-0020-SGP-0068 - Consulta formación académica de una persona

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0020-SGP-0068 - Consulta formación académica de una persona** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGP - Personas - Formación - Consultar detalle](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgp/sgi-esb-sgp-servicios-pasarela/sgi-esb-sgp-personas-formacion-consultar-detalle).
