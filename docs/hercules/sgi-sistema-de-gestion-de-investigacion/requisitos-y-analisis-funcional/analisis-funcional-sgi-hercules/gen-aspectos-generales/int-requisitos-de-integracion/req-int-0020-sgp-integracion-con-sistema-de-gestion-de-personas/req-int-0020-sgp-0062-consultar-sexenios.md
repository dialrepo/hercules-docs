# REQ-INT-0020-SGP-0062 - Consultar sexenios

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0020-SGP-0062 - Consultar sexenios** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGP - Sexenios - Buscar](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgp/sgi-esb-sgp-servicios-basicos/sgi-esb-sgp-sexenios-buscar).
