# REQ-INT-0020-SGP-0063 - Consultar direcciones de tesis

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0020-SGP-0063 - Consultar direcciones de tesis** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGP - Dirección de tesis - Buscar](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgp/sgi-esb-sgp-servicios-basicos/sgi-esb-sgp-direccion-de-tesis-buscar).
...
[PRC - Baremación - Diseño algoritmo](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-prc/prc-baremacion-diseno-algoritmo)
