# REQ-INT-0020-SGP-0064 - Personas modificadas

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0020-SGP-0064 - Personas modificadas** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGP - Personas - Consultar personas modificadas](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgp/sgi-esb-sgp-servicios-pasarela/sgi-esb-sgp-personas-consultar-personas-modificadas).
