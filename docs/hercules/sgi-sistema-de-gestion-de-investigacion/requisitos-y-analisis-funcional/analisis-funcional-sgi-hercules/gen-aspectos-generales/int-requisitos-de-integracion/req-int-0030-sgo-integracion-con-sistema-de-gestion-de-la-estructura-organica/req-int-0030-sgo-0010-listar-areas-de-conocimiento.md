# REQ-INT-0030-SGO-0010 - Listar áreas de conocimiento

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0030-SGO-0010** **- Listar áreas de conocimiento** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGO - Áreas de conocimiento - Buscar](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgo/sgi-esb-sgo-areas-de-conocimiento-buscar).
