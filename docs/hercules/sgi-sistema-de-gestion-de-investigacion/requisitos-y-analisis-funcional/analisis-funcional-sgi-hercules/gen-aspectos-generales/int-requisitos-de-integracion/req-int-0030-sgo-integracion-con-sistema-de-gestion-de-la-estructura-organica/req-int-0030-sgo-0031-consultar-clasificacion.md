# REQ-INT-0030-SGO-0031 - Consultar clasificación

|  |  |
| --- | --- |
| Cod. REQ | **REQ-INT-0030-SGO-0021** **- Consultar clasificación** |
| Ver. Objetivo |  |
| Ver. REQ | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
El servicio concreto del API que cubre este requisito es [SGI - ESB - SGO - Clasificaciones - Consultar detalle](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/sgi-esb-sgo/sgi-esb-sgo-clasificaciones-consultar-detalle).
