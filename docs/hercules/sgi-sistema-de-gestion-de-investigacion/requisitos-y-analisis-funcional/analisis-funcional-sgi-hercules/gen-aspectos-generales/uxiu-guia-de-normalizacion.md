# UX/IU - Guía de normalización

* 1 [Introducción](#UX/IUGuíadenormalización-Introducción)
* 2 [Estructura general](#UX/IUGuíadenormalización-Estructurageneral)
  + 2.1 [Cabecera](#UX/IUGuíadenormalización-Cabecera)
  + 2.2 [Área de trabajo](#UX/IUGuíadenormalización-Áreadetrabajo)
* 3 [Elementos y componentes](#UX/IUGuíadenormalización-Elementosycomponentes)
  + 3.1 [Cabecera](#UX/IUGuíadenormalización-Cabecera.1)
  + 3.2 [Área de trabajo](#UX/IUGuíadenormalización-Áreadetrabajo.1)
* 4 [Diseño UI](#UX/IUGuíadenormalización-DiseñoUI)
  + 4.1 [Área del investigador](#UX/IUGuíadenormalización-Áreadelinvestigador)
  + 4.2 [Área del Gestor](#UX/IUGuíadenormalización-ÁreadelGestor)
  + 4.3 [Otras pantallas comunes](#UX/IUGuíadenormalización-Otraspantallascomunes)
* 5 [Recursos](#UX/IUGuíadenormalización-Recursos)
