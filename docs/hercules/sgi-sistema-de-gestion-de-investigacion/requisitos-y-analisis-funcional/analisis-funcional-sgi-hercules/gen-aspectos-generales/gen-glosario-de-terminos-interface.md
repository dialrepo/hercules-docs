# GEN - Glosario de Términos Interface

| Término | Descripción. |
| --- | --- |
| Acta | Entidad donde se recoge la información resultado de una convocatoria de reunión. Existiendo una única acta por convocatoria de reunión. |
| Ámbito geográfico | Campo desplegable donde se podrá elegir uno de los siguientes valores:   * Local * Autonómico * Estatal * Europeo * Internacional no europeo |
| Antigüedad nivel académico | Número de años de antigüedad para el nivel académico exigido. |
| Años vinculación | Número de años de vinculación en la modalidad de contrato exigida por la convocatoria. |
| Apartado | Cada uno de los epígrafes de un bloques que compone una memoria. |
| Áreas temáticas | Clasificación jerárquica propia de las convocatorias y definidas por el administrador en cada universidad |
| Asistencia | Campo para indicar si una persona convocada asiste o no a la misma. Podrá tomar el valor Si o No. En el caso de seleccionar No, aparece el campo Motivo donde se puede especificar el mismo (baja laboral, licencia de maternidad, estancia en el extranjero, incompatibilidad con clases, y si ha enviado los informes de evaluación por email) |
| Asistentes | Personas que asisten a una reunión. |
| Aviso | Es un campo de tipo check que indica si se envía un aviso (correo o notificación) a la persona destinataria del aviso. |
| Bloque | Cada una de las partes en las que se divide una memoria. |
| Campo libre para indicar los requisitos a cumplir | Campo de texto donde se indican los requisitos que debe cumplir el solicitante. |
| Cargo comité | Campos desplegable que recoger el cargo dentro del comité de evaluación de ética que puede ser uno de los siguientes valores: Presidente o Vocal. |
| Código | Campo alfanumérico único asociado a una entidad. |
| Códigos económicos | Son los códigos contables con los que se identifican los tipos de gasto en el Sistema de gestión económica (SGE). |
| Comentario | Campo de texto libre donde se introduce información sobre la entidad para que su lector la tenga en cuenta al revisar la información de la misma. |
| Comité | Campo desplegable donde se recogen los tres comités de ética existentes:  * CEISH: Comité de ética para las investigaciones con seres humanos, sus datos y sus muestras * CEEA: Comité de ética en experimentación animal * CEIAB: Comité de ética para las investigaciones con agentes biológicos y OMG |
...
| Conflicto de interés | Personas (evaluadores) que no pueden evaluar las memorias de algún miembro del equipo investigador, por existir una relación entre ambos. |
| Convocados | Listado con todos los miembros activos del comité seleccionado (NIF, nombre, apellidos) y la secretaria técnica (gestores del módulo de ética). |
| Convocatoria | Desplegable con los valores:   * Ordinaria * Extraordinaria * Seguimiento |
| Costes indirectos | Nombre del concepto de gasto asociado al campo concepto de gasto de costes indirectos de la convocatoria |
| Descripción | Texto explicativo de la entidad |
| Destinatarios | Personas a las que va dirigida la entidad |
| Dictamen | Listado con distintos valores en función del seguimiento.  Memoria:   * Favorable * Favorable pendiente de modificaciones mínimas * Pendiente de correcciones * No procede evaluar   Retrospectiva:   * Favorable * Desfavorable   Seguimiento anual:   * Favorable * Solicitud de modificaciones   Seguimiento final:   * Favorable * Solicitud de aclaraciones |
| Diseño metodológico | Texto en el que se indica el diseño metodológico del proyecto |
| Documento | Archivo asociado a la entidad |
| Edad máxima | Edad limite para poder presentar una solicitud por parte de un investigador |
...
| Entidad convocante | Nombre de la entidad que realiza la convocatoria. Pueden ser entidades privadas o públicas. |
| Entidad financiadora | Nombre de la entidad que financia el proyecto. Pueden ser entidades privadas o públicas. |
...
| Equipo investigador | Grupo de investigadores que trabajan de forma conjunta en un proyecto de investigación |
| Estado | Situación en la que se encuentra la entidad. Son valores acotados y propios de cada entidad. |
...
| Valor social | Valor social del proyecto, que ha de indicar el investigador al realizar una petición de evaluación. |
...
Guía de lenguaje:  [guia-leng-no-sexista.pdf](/attachments/597853231/598835227.pdf)