# IU-GEN-0110 - Selección de áreas de conocimiento

|  |  |
| --- | --- |
| Cod. IU | ********IU-GEN-0110 - Selección de áreas de conocimiento******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT-CSP-003-Gestor, ACT-CSP-004-Administrador, ACT-ESB-004-Administrador |
| Frecuencia | Media |
