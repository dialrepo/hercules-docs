# IU-GEN-0050 - Búsqueda de convocatorias

|  |  |
| --- | --- |
| Cod. IU | IU-GEN-0050 - Búsqueda de convocatorias |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado |  |
| Fec. Aprobación |  |
...
| Identificación | Texto  Opcional | Código identificativo o referencia de la convocatoria. Campo "código" de la tabla "convocatoria" (que no es el identificador único interno de la tabla). |
| Fecha publicación desde  Fecha publicación hasta | Fecha  Opcional | Los valores introducidos en estos campos se aplicarán como rango de búsqueda  sobre la fecha de publicación de la convocatoria (campo "fecha publicación" de la tabla "convocatoria"), de forma que ésta deba estar comprendida entre los valores indicados. |
| Abierto plazo de presentación de solicitudes | Check  Booleano  Valores: Abierto plazo de presentación de solicitudes / Cerrado plazo de presentación de solicitudes | Indica si está abierto el plazo de presentación de las solicitudes. Es decir, si la fecha actual está comprendida entre las fechas de inicio y fin de presentación de solicitudes, campos de la tabla "Configuración solicitud". |
