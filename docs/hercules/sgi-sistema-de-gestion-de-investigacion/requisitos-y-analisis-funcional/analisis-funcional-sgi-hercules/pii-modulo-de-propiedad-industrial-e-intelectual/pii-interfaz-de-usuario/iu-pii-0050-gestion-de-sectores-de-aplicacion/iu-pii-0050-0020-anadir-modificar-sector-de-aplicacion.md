# IU-PII-0050-0020 - Añadir-modificar sector de aplicación

|  |  |
| --- | --- |
| Cod. IU | IU-PII-0050-0020 - Añadir-modificar sector de aplicación |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Nombre | Texto  Obligatorio  Modificable | Es el nombre identificativo del sector de aplicación, con el que se listará en todos los desplegables.  Tanto en el alta como en la modificación debe de validarse su unicidad en la tabla de sectores de aplicación (entre los activos) |
