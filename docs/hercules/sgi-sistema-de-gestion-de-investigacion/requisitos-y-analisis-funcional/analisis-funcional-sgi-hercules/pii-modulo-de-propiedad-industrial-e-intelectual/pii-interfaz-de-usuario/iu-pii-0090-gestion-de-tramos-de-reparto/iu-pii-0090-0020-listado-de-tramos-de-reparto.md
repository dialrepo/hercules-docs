# IU-PII-0090-0020 - Listado de tramos de reparto

|  |  |
| --- | --- |
| Cod. IU | IU-PII-0090-0020 - Listado de tramos de reparto |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Modificar (tramo de reparto) | Muestra la pantalla para ver el detalle/modificar un tramo de reparto. |  | PII-TRE-V  PII-TRE-E |
...
|  |  |
| --- | --- |
| ACT-PII-001-Gestor | PII-TRE-C, PII-TRE-E, PII-TRE-B |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | PII-TRE-V, PII-TRE-C, PII-TRE-E, PII-TRE-B |
