# IU-PII-0020-0010-001 Crear solicitud de protección - Datos generales

|  |  |
| --- | --- |
| Cod. IU | IU-PII-0010-0020 - Crear solicitud de protección - Datos generales |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| *Campos comunes* | | |
| Título | Texto  Obligatorio | Título de la solicitud de protección.  Al crear una solicitud, se cargará por defecto el título de la invención asociada como título de la solicitud, pero el usuario podrá modificarla. |
