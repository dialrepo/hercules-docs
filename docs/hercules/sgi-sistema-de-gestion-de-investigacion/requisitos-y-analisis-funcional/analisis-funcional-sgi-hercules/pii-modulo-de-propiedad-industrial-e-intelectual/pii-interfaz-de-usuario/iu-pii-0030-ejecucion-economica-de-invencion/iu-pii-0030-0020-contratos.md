# IU-PII-0030-0020 - Contratos

|  |  |
| --- | --- |
| Cod. IU | IU-PII-0030-0020 - Contratos |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| --- | --- | --- | --- |
| Modificar (sector licenciado) | Abrirá el formulario [IU-PII-0031-002 - Añadir-modificar sector licenciado](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/pii-modulo-de-propiedad-industrial-e-intelectual/pii-interfaz-de-usuario/iu-pii-0030-ejecucion-economica-de-invencion/iu-pii-0031-ejecucion-economica-de-invencion-popups-auxiliares/iu-pii-0031-002-anadir-modificar-sector-licenciado) que permitirá ver el detalle y/o modificar los datos del sector licenciado asociado a la invención. |  | PII-INV-V  PII-INV-E |
| Eliminar (sector licenciado) | Se eliminará la asociación entre el sector y el contrato asociado a la invención. |  | PII-INV-E |
| Añadir sector licenciado | Abrirá el formulario [IU-PII-0031-002 - Añadir-modificar sector licenciado](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/pii-modulo-de-propiedad-industrial-e-intelectual/pii-interfaz-de-usuario/iu-pii-0030-ejecucion-economica-de-invencion/iu-pii-0031-ejecucion-economica-de-invencion-popups-auxiliares/iu-pii-0031-002-anadir-modificar-sector-licenciado) que permitirá añadir un nuevo sector licenciado asociado a la invención.  Se validará que no se repita el sector licenciado, entendiendo que un sector licenciado se repite cuando ya hay otro sector licenciado con el mismo:   * País * Sector * Valor de exclusividad |  | PII-INV-E |
...
|  |  |
| --- | --- |
| ACT-PII-001-Gestor | PII-INV-E, REL-V, CSP-PRO-MOD-V |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | PII-INV-V, PII-INV-E, REL-V, CSP-PRO-MOD-V |
