# IU-CSP-0201-010 - Crear convocatoria - Requisitos IP

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0201-010 Crear convocatoria - Requisitos IP******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
