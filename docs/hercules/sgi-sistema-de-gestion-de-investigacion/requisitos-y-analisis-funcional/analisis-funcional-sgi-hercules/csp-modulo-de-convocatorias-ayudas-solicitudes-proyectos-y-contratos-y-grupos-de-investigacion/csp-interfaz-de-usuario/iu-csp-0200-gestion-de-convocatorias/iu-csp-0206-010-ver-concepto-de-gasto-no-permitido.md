# IU-CSP-0206-010 - Ver concepto de gasto no permitido

|  |  |
| --- | --- |
| Cod. IU | **IU-CSP-0206-010 - Ver concepto de gasto no permitido** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| --- | --- | --- |
| Ver | Se abre la pantalla del código económico del SGE asociado al concepto de gasto. Modo consulta. | Muestra la pantalla [IU-CSP-0206-011 - Ver código económico](https://confluence.um.es/confluence/pages/viewpage.action?pageId=87826611) |