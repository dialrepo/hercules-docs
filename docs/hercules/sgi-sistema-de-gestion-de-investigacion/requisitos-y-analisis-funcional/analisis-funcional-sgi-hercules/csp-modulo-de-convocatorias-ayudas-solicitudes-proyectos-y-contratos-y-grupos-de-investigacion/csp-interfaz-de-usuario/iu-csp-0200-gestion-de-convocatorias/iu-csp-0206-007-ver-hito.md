# IU-CSP-0206-007 - Ver hito

|  |  |
| --- | --- |
| Cod. IU | **IU-CSP-0206-007 - Ver hito** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Tipo hito | Nombre  Texto corto | Nombre del hito recuperado de la tabla "tipos hito convocatoria" a partir de la referencia en la tabla "hitos convocatoria".  El campo se muestra en modo consulta. |
