# IU-CSP-0204-009 - Modificar convocatoria - Documentos

|  |  |
| --- | --- |
| Cod. IU | **IU-CSP-0204-009 - Modificar convocatoria - Documentos** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| --- | --- | --- | --- |
| Editar | Muestra la pantalla de Edición del documento | Muestra la pantalla definida en el formulario de abajo. | CSP-CON-E  CSP-CON-E\_UO |
...
| Añadir nuevo documento | Muestra la pantalla Nuevo documento | Muestra la pantalla [IU-CSP-202-010 - Añadir documento](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/csp-modulo-de-convocatorias-ayudas-solicitudes-proyectos-y-contratos-y-grupos-de-investigacion/csp-interfaz-de-usuario/iu-csp-0200-gestion-de-convocatorias/iu-csp-202-010-anadir-documento). | CSP-CON-E  CSP-CON-E\_UO |
...
| Público | Selector  Booleano  Valores: Sí, No  Obligatorio | Tomará los valores Sí/No.  Indica si el documento va a ser visible para los ACT- CSP-001-Investigador |
