# IU-CSP-0205-010 - Ver convocatoria - Requisitos IP

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0205-010 - Ver convocatoria - Requisitos IP******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Posterior a | Fecha | Fecha más antigua en la que puede haber sido obtenida la categoría para poder optar a la convocatoria  Se corresponde con el campo "fecha mínima categoría profesional" de la tabla "requisito IP". |
| Anterior a | Fecha | Fecha tope en la que puede haber sido obtenida la categoría para poder optar a la convocatoria  Se corresponde con el campo "fecha máxima categoría profesional" de la tabla "requisito IP". |
|  | | |
