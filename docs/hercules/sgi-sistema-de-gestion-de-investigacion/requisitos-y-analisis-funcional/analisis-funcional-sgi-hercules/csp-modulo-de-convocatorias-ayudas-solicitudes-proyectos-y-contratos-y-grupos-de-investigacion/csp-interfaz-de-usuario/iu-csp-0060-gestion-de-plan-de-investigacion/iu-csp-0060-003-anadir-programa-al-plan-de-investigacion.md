# IU-CSP-0060-003 - Añadir programa al plan de investigación

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0060-003 Añadir programa al plan de investigación******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
|  |  |
| --- | --- |
| ACT-CSP-004-Administrador | CSP-PRG-C, CSP-PRG-E |
| ACT-CSP-003-Gestor | CSP-PRG-C, CSP-PRG-E |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-PRG-C, CSP-PRG-E |