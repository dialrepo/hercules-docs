# IU-CSP-0451-001 - Búsqueda y listado de autorizaciones participación proyecto externo - Perfil investigador

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0451-01o - Búsqueda y listado de autorizaciones participación proyecto externo - Perfil investigador******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
|  |  |
| --- | --- |
| ACT-CSP-001-Investigador | CSP-AUT-INV-C, CSP-AUT-INV-ER, CSP-AUT-INV-BR |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-AUT-INV-C, CSP-AUT-INV-ER, CSP-AUT-INV-BR |