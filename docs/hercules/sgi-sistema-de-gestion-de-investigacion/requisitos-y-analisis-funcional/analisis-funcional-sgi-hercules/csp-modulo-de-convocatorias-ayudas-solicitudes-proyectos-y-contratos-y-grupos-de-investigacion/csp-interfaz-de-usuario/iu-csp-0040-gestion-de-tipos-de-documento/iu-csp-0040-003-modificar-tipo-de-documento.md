...
| --- | --- | --- | --- |
| Guardar | Actualiza el registro en base de datos | Se comprobará la unicidad del campo "nombre" sobre los registros activos (campo "activo" a "true")  Se guardarán los cambios modificando los datos del tipo de documento en base de datos.  CU-CSP-0006-003 - Modificar tipo de documento | CSP-TDOC-E |
