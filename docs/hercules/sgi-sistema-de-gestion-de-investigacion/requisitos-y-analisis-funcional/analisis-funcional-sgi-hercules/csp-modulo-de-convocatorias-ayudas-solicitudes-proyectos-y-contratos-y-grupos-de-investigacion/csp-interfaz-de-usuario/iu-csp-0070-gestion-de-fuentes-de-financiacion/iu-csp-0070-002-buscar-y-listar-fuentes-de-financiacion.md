# IU-CSP-0070-002 - Buscar y listar fuentes de financiación

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0070-002 Buscar y listar fuentes de financiación******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Descripción | Texto | Descripción de la fuente de financiación  Se contemplará la ordenación de las filas de la tabla en función de esta columna |
...
| Fondo estructural | Boolean | Campo fondo estructural de la tabla fuente de financiación  Se contemplará la ordenación de las filas de la tabla en función de esta columna |
...
|  |  |
| --- | --- |
| ACT-CSP-004-Administrador | CSP-FNT-C, CSP-FNT-E, CSP-FNT-B, CSP-FNT-R |
| ACT-CSP-003-Gestor | CSP-FNT-C, CSP-FNT-E, CSP-FNT-B |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-FNT-V, CSP-FNT-C, CSP-FNT-E, CSP-FNT-B, CSP-FNT-R |