# IU-CSP-0560-008 - Periodo justificación - Horas timesheet

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0560-008 - Periodo justificación - Horas timesheet******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| --- | --- | --- |
| Modificar | Muestra la pantalla de modificación de rechazo del gasto | Solo estará disponible si el periodo de justificación se encuentra en uno de los estados siguientes:  * Entregada * Subsanación   Muestra una pantalla similar a la de rechazo de gastos, [IU-CSP-0405-005 - Rechazar gasto en justificación de ejecución económica en proyecto](https://confluence.um.es/confluence/pages/viewpage.action?pageId=91014627) |
