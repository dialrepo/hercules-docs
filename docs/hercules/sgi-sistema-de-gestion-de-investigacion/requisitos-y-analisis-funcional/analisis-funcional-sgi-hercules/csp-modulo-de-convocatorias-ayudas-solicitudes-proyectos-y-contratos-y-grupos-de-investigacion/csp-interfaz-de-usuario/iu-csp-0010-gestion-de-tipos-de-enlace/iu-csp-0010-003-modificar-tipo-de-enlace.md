# IU-CSP-0010-003 Modificar tipo de enlace

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0010-003 Modificar tipo de enlace******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Nombre | Texto corto  Obligatorio | Campo "nombre" de la tabla "tipo enlace". No podrá modificarse a un nombre que ya esté siendo utilizado en un tipo de enlace activo (campo "activo" a "true") |
...
|  |  |
| --- | --- |
| ACT-CSP-004-Administrador | CSP-TENL-E |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-TENL-V, CSP-TENL-E |