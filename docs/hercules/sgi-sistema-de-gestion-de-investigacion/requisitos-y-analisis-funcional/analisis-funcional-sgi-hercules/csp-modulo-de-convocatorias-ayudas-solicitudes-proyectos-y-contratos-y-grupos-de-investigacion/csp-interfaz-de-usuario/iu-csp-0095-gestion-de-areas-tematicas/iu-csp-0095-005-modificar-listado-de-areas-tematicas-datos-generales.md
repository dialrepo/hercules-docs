# IU-CSP-0095-005 - Modificar listado de áreas temáticas - Datos generales

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0095-005 Modificar listado de áreas temáticas - Datos generales******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Nombre del listado de áreas temáticas | Texto corto  Obligatorio | Nombre identificativo del grupo o listado de áreas temáticas. Deberá ser un nombre único en la tabla "Área temática" entre aquellos elementos raíz (campo "padre" a null) que estén activos (campo "activo" a "true") |
