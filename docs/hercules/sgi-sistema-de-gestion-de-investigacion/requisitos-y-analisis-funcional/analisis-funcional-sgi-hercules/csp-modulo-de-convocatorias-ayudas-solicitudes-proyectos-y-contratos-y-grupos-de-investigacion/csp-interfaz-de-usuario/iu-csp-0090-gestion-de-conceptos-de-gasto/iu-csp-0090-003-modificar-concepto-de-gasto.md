# IU-CSP-0090-003 - Modificar concepto de gasto

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0090-003 - Modificar concepto de gasto******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Nombre | Texto corto  Obligatorio | Campo nombre del concepto de gasto. No se podrá dejar vacío. Se podrá modificar el nombre del concepto de gasto siempre y cuando se respete la restricción de unicidad con independencia del valor del campo "activo". Es decir, no podrán existir dos conceptos de gasto con el mismo nombre estén o no activos.  Se corresponde con el campo "nombre" de la tabla "concepto de gasto". |
| Descripción | Texto  Opcional | Campo descripción del concepto de gasto. Se podrá modificar libremente y dejar vacío.  Se corresponde con el campo "descripción" de la tabla "concepto de gasto". |
| ¿Representa costes indirectos? | Selector  Booleano  Obligatorio | Permite indicar si el concepto de gasto será utilizado para recoger costes indirectos. No se restringirá la existencia de varios conceptos representativos de costes indirectos. Se podrá modificar. Es un campo obligatorio.  Selector con los valores: sí, no.  Se mostrará un icono informativo a su derecha con un tooltip con el texto: "Se debe de indicar si se trata de un concepto de gasto a través del que se realiza el control y gestión de los costes indirectos".  Se corresponde con el campo "costes indirectos" de la tabla "concepto de gasto". |
...
|  |  |
| --- | --- |
| ACT-CSP-004-Administrador | CSP-TGTO-E |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-TGTO-V, CSP-TGTO-E |