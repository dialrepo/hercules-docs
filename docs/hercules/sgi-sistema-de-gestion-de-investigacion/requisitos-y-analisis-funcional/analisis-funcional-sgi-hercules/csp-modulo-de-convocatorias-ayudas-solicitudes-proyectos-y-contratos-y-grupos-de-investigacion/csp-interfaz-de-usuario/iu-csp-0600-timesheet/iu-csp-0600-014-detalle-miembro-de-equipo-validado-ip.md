# IU-CSP-0600-014 - Detalle - Miembro de equipo - Validado IP

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0500-014 - Detalle - Miembro de equipo - Validado IP******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Estado | | Texto corto  Solo lectura | En estado "Validado IP" el ACT-CSP-001-Investigador no podrá realizar ninguna modificación. |
