# IU-CSP-0600-015 - Detalle - Miembro de equipo - Validado Unidad

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0600-015 - Detalle - Miembro de equipo - Validado Unidad******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Periodo | | Texto corto  Solo lectura | Mes y año del periodo de registro de horas de dedicación. Modo lectura. |
| Estado | | Texto corto  Solo lectura | En estado "Validado Unidad" el ACT-CSP-001-Investigador no podrá realizar ninguna modificación. |
