# IU-CSP-0600-021 - Histórico de estados

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0600-021 - Histórico de estados******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT- CSP-001-Investigador con rol principal, ACT-CSP-003-Gestor, ACT-CSP-004-Administrador |
| Frecuencia | Media |
...
|  |  |
| --- | --- |
| ACT- CSP-001-Investigador | CSP-TSHHE-VR |
| ACT-CSP-003-Gestor | CSP-TSHHE-V |
| ACT-CSP-004-Administrador | CSP-TSHHE-V |
| ACT-CSP-005-Visor | CSP-TSHHE-V |