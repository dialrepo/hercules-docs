# IU-CSP-0600-022 - Hojas de firma

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0600-022 - Hojas de firma******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Iniciar firma | Una vez que la hoja ha sido generada:   * El investigador propietario de la hoja inicia la firma invocando al sistema de firma digital, común a todo el SGI   Una vez que la hoja ha sido firmada por el investigador miembro:   * El  IP  invoca al sistema de firma digital, común a todo el SGI | La hoja de firma debe ser firmada en primera instancia por el investigador miembro y posteriormente debe ser firmada por el IP. La firma se debe de resolver a través REQ - NF - INT - 0110 - SFIDI - 001 - Hojas de firma de timesheet |
| Generar | Invoca la generación de la hoja de firma | Informe correspondiente a la hoja de firma es generado por el módulo de BI wip\_REP-CSP-003-Informe de hoja de firma |
...
|  |  |
| --- | --- |
| ACT- CSP-001-Investigador | CSP-TSHHJ-ER |
| ACT-CSP-003-Gestor | CSP-TSHHJ-E |
| ACT-CSP-004-Administrador | CSP-TSHHJ-E |