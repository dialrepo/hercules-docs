# IU-CSP-0044-003 Modificar tipo de hito

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0044-003 Modificar tipo de hito******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Nombre | | Texto corto  Obligatorio | No se podrá modificar el nombre a un nombre que ya exista para un registro activo (campo "activo" a "true") en la tabla "tipo hito".  No se podrá dejar vacío. |
...
|  |  |
| --- | --- |
| ACT-CSP-004-Administrador | CSP-THITO-E |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-THITO-V, CSP-THITO-E |