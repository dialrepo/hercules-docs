# IU-CSP-0953-007 - Modificar-consultar línea de investigación - Datos generales

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0953-007 - Modificar-consultar línea de investigación - Datos generales******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Nombre | Texto largo  Selector  Obligatorio | Se mostrará un combo con los nombres de las líneas de investigación dadas de alta en el SGI activas. Campo "nombre" de la tabla "línea investigación".  La línea seleccionada se guardará en el campo "línea investigación" de la tabla "grupo línea investigación")  Será un campo obligatorio. |
