# IU-CSP-0951-002 - Búsqueda ampliada y listado de grupos de investigación - Unidades de gestión

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0951-002 - Búsqueda ampliada y listado de grupos de investigación - Unidades de gestión******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Nombre | | Texto largo  Opcional | Campo para introducir la cadena de texto por la que se aplicará la búsqueda sobre el campo "nombre" de la tabla "grupo" |
| Código | | Texto corto  Opcional | Código alfanumérico generado automáticamente por el SGI al crear el grupo (aunque puede ser modificado por el ACT-CSP-003-Gestor, ACT-CSP-004-Administrador.  Filtro a aplicar sobre el campo "código" de la tabla "grupo". |
| Miembro de equipo | | Buscador  Opcional | A través del botón Buscar se dará acceso al buscador de personas común al SGI, [IU-GEN-0100-0060 - Búsqueda de persona](https://confluence.um.es/confluence/pages/viewpage.action?pageId=95489453). Las condiciones de invocación a este buscador se recogen en  la tabla de acciones.  La persona seleccionada se utilizará para aplicar como filtro de búsqueda sobre el campo "personaRef" de la tabla "grupo equipo". |
| Código identificación SGE | | Texto corto  Opcional | Código de identificación del proyecto económico del SGE con el que se vincula el grupo de investigación SGI. Podrá ser alfanumérico.  Filtro a aplicar sobre el campo "proyecto SGE ref" de la tabla "grupo". |
| Fecha inicio desde | | Fecha  Opcional | Permitirá indicar el intervalo de fechas entre las que se debe encontrar la fecha de inicio del grupo (campo "fecha inicio" de la tabla "grupo").  Se comprobará que la "fecha inicio" de la tabla "grupo" sea mayor o igual a esta fecha. |
| Fecha inicio hasta | | Fecha  Opcional | Permitirá indicar el intervalo de fechas entre las que se debe encontrar la fecha de inicio del grupo (campo "fecha inicio" de la tabla "grupo").  Se comprobará que la "fecha inicio" de la tabla "grupo" sea menor o igual a esta fecha. |
| Activo | | Selector  Booleano  Opcional | Selector con los valores "Sí", "No", "Todos".  Por defecto, se establecerá el valor "Sí", debiendo el usuario modificar el valor del selector para aplicar cualquier otro filtro. Actuará como filtro sobre el campo "activo" de la tabla "grupo". |
| Palabras clave | | Componente a medida  Opcional | Lista de palabras clave por las que filtrar para buscar grupos. El filtro se aplicará sobre el campo "nombre" de las palabras clave vinculadas al grupo a través de la tabla "grupo palabra clave".  El comportamiento del componente será el descrito de manera general en [IU-GEN-0201 - Búsqueda por palabras clave](https://confluence.um.es/confluence/pages/viewpage.action?pageId=113053123). |
| Línea de investigación | | Selector  Opcional | Línea de investigación por la que filtrar para buscar grupos. El filtro se aplicará sobre el campo "nombre" de las líneas  de investigación vinculadas al grupo a través de la tabla "grupo linea investigación".  Combo con las líneas de investigación dadas de alta en el SGI ( campo "nombre" de la tabla "linea investigación") |
...
| Código | | Texto corto | Código del grupo de investigación  Se corresponde con el campo "código" de la tabla "grupo". |
...
|  |  |
| --- | --- |
| ACT-CSP-003-Gestor | CSP-GIN-C, CSP-GIN-E, CSP-GIN-B, CSP-GIN-R |
| ACT-CSP-004-Administrador | CSP-GIN-C, CSP-GIN-E, CSP-GIN-B, CSP-GIN-R |
...
|  |  |
| --- | --- |
| Permisos | CSP-GIN-V, CSP-GIN-C, CSP-GIN-E, CSP-GIN-B, CSP-GIN-R |