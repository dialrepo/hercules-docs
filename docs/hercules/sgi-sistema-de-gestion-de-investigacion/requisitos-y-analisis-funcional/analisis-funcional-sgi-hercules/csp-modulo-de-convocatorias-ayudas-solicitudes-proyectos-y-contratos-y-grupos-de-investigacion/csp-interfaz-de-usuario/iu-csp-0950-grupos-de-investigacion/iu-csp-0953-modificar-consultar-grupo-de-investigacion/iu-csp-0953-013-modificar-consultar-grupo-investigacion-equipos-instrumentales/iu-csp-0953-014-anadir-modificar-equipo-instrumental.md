# IU-CSP-0953-014 - Añadir-modificar equipo instrumental

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0953-014 - Añadir-modificar equipo instrumental******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Nombre | Texto  Obligatorio | Nombre del equipo instrumental.  Campo "nombre" de la tabla "grupo equipo instrumental".  Campo obligatorio |
| Descripción | Texto largo  Opcional | Descripción del equipo instrumental.  Campo "descripción" de la tabla "grupo equipo instrumental".  Campo opcional |
| Número registro | Texto corto  Opcional | Descripción del equipo instrumental.  Campo "num registro" de la tabla "grupo equipo instrumental".  Campo opcional |
