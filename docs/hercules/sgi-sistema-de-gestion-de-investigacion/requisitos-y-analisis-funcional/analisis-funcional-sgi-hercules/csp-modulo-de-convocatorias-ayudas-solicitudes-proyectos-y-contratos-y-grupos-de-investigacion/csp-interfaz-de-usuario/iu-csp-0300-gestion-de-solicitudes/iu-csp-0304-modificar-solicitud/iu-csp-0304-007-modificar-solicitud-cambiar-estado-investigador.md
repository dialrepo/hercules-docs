# IU-CSP-0304-007 - Modificar solicitud - Cambiar estado - Investigador

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0304-007 - Modificar solicitud - Cambiar estado - Investigador******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT-CSP-001-Investigador, ACT-CSP-001-Investigador-Externo |
| Frecuencia | Media |
...
|  |  |
| --- | --- |
| ACT-CSP-001-Investigador | CSP-SOL-INV-ER, ETI-PEV-MOD-C |
...
|  |  |
| --- | --- |
| Permisos | CSP-SOL-INV-ER, CSP-SOL-INV-VR, ETI-PEV-MOD-C |
