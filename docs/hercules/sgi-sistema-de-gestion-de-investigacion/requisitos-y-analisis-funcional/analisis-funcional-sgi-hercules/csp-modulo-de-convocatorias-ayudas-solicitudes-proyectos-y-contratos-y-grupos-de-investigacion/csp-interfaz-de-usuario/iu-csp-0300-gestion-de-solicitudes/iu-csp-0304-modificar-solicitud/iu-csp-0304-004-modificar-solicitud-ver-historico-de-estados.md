# IU-CSP-0304-004 - Modificar Solicitud - Ver Histórico de estados

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0304-004 - Modificar Solicitud - Ver Histórico de estados******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT-CSP-001-Investigador, ACT-CSP-002-InvestigadorExterno, ACT-CSP-003-Gestor, ACT-CSP-004-Administrador, ACT-CSP-005-Visor |
| Frecuencia | Media |
...
| Estado | Texto corto | Estado de la solicitud. Nombre del estado extraído de la tabla "tipo estado solicitud" a partir de la referencia de la tabla "estado solicitud". Los estados son definidos en [Tipos de estados de la solicitud](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-solicitudes#CSP-Solicitudes-#tipo_estado_solicitudTiposdeestadodesolicitud) |
...
| ACT-CSP-005-Visor | CSP-SOL-V, CSP-SOL-V\_UO |
