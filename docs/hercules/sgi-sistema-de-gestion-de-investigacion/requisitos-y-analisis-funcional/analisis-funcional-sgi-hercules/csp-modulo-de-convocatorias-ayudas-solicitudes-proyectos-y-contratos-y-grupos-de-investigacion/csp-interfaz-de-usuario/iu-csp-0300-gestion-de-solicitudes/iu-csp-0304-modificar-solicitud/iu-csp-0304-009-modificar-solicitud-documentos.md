# IU-CSP-0304-009 - Modificar Solicitud - Documentos

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0304-009 - Modificar Solicitud - Documentos******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT-CSP-001-Investigador, ACT-CSP-001-InvestigadorExterno, ACT-CSP-004-Administrador, ACT-CSP-003-Gestor |
| Frecuencia | Media |
...
| Nombre | Texto  Modo consulta | Nombre del documento |
...
| Documento | Documento  Modo consulta |  |
| Comentarios | Texto  Modo consulta | Comentarios sobre el documento subido |
