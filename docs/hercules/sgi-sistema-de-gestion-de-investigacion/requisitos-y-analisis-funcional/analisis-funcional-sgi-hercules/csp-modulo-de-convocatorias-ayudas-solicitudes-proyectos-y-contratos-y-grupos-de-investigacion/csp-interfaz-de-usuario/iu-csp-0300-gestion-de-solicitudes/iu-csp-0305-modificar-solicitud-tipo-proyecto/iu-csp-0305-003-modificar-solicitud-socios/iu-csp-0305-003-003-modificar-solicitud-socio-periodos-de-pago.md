# IU-CSP-0305-003-003 - Modificar solicitud - Socio - Periodos de pago

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0305-003-003 - Modificar solicitud - Socio - Periodos de pago******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Nº Periodo | Secuencia  Numérico entero genérico | Número secuencial dentro de la solicitud que asignará directamente el sistema en función de la ordenación del mes |
