# IU-CSP-0304-006 - Modificar solicitud - Cambiar estado - Unidad de gestión

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0304-006 - Modificar solicitud - Cambiar estado - Unidad de gestión******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
|  |  |
| --- | --- |
| ACT-CSP-003-Gestor | CSP-SOL-E, CSP-SOL-E\_UO, ETI-PEV-MOD-C |
| ACT-CSP-004-Administrador | CSP-SOL-E, CSP-SOL-E\_UO, ETI-PEV-MOD-C |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-SOL-V, CSP-SOL-V\_UO, CSP-SOL-E, CSP-SOL-E\_UO, ETI-PEV-MOD-C |
