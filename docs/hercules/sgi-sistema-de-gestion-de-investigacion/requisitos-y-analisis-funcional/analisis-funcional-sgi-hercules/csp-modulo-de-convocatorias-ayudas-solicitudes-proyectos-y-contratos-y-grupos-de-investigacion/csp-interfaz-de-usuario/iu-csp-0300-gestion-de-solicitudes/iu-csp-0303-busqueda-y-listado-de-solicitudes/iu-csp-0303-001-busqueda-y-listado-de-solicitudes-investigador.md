# IU-CSP-0303-001- Búsqueda y listado de solicitudes - Investigador

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0303-001- Búsqueda y listado de solicitudes - Investigador******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Convocatoria | Buscador  Opcional | Se incorporará el buscador de convocatorias común al SGI [IU-GEN-0050 - Búsqueda de convocatorias](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/gen-aspectos-generales/sha-buscadores-y-listados-comunes/iu-gen-0050-busqueda-de-convocatorias) que permite seleccionar una convocatoria registrada en el SGI. Las restricciones de invocación a este buscador se especifican en la tabla de Acciones.  La convocatoria seleccionada se aplicará como filtro sobre el campo "convocatoria" de la tabla "solicitud". |
| Estado solicitud | Selector  Opcional | Mostrará el listado de estado de la solicitudes. Los estados son definidos en [Tipos de estados de la solicitud](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-solicitudes#CSP-Solicitudes-#tipo_estado_solicitudTiposdeestadodesolicitud). Este filtro se aplicará sobe el campo "estado" de la tabla "Estado solicitud" de forma que se corresponda con el estado actual de la solicitud (campo "fecha estado" más reciente) |
| Título solicitud | Texto  Opcional | Filtro a aplicar sobre el campo "título" de la tabla "Solicitud" |
...
| Estado  solicitud | Texto corto | Mostrará el estado actual de la solicitud. Se recuperará de la tabla "Estado solicitud" y se mostrará el nombre del estado ("Tipo estado solicitud"). Los estados son definidos en [Tipos de estados de la solicitud](/hercules/sgi-sistema-de-gestion-de-investigacion/mdu-manual-de-usuario/mdu-perfil-unidad-de-gestion/mdu-perfil-unidad-de-gestion-modulo-csp/csp-solicitudes#CSP-Solicitudes-#tipo_estado_solicitudTiposdeestadodesolicitud) |
...
| --- | --- | --- | --- |
| Buscar (Convocatoria) | Búsqueda de convocatoria registrada en el SGI | La búsqueda se realizará a través del buscador de convocatorias [IU-GEN-0050 - Búsqueda de convocatorias](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/gen-aspectos-generales/sha-buscadores-y-listados-comunes/iu-gen-0050-busqueda-de-convocatorias), común a todo el SGI. En este caso la búsqueda de convocatorias no llevará implícito ningún filtro por permisos. ACT-CSP-001-Investigador recuperará indistintamente las convocatorias de todas las unidades de gestión. | No se necesita permiso para buscar convocatoria |
...
|  |  |
| --- | --- |
| ACT-CSP-001-Investigador | CSP-SOL-INV-ER, CSP-SOL-INV-BR |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-SOL-INV-ER, CSP-SOL-INV-BR |
