# IU-CSP-0303-004 - Búsqueda y listado de solicitudes - UG - Crear proyecto

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0303-004 - Búsqueda y listado de solicitudes - UG - Crear proyecto******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
|  |  |
| --- | --- |
| ACT-CSP-003-Gestor | CSP-PRO-C |
| ACT-CSP-004-Administrador | CSP-PRO-C |
