# IU-CSP-0306-007 - Modificar solicitud - Memoria

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0306-007 - Modificar solicitud - Memoria******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT-CSP-001-Investigador, ACT-CSP-00s-InvestigadorExterno, ACT-CSP-003-Gestor, ACT-CSP-004-Administrador |
| Frecuencia | Media |
...
| Título del trabajo | Texto  Obligatorio | Título del trabajo que se propone desarrollar. Deberá ser un alfanumérico de 1000 caracteres.  Campo "título trabajo" de la tabla "solicitud RRHH". |
| Resumen | Texto largo  Obligatorio | Resumen del trabajo con el que se opta a la solicitud. Deberá ser un alfanumérico de 4000 caracteres.  Campo "resumen" de la tabla "solicitud RRHH" |
| Observaciones | Texto largo  Opcional | Observaciones del trabajo presentado por el solicitante.  Campo "observaciones" de la tabla "solicitud RRHH" |
