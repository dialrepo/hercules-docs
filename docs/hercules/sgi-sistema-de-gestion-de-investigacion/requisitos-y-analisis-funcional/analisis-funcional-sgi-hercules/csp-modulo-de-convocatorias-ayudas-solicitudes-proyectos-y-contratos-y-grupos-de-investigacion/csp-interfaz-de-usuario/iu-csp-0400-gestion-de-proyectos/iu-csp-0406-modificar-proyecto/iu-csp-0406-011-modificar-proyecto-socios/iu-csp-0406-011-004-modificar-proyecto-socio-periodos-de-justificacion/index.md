# IU-CSP-0406-011-004 - Modificar proyecto - Socio - Periodos de justificación

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0406-011-004 - Modificar proyecto - Socio - Periodos de justificación******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Nº Periodo | Secuencia  Numérico entero genérico | Número secuencial dentro del proyecto que asignará directamente el sistema en función de la ordenación de la fecha de inicio.  Se corresponde con el campo "num. periodo" de la tabla "proyecto socio periodo justificación". |
...
| Documentación recibida | Booleano  Valores: Sí, No | Permitir indicar si la Universidad ha recibido, por parte del socio, la documentación necesaria para realizar la justificación a la entidad convocante.  Se corresponde con el campo "doc. recibida" de la tabla "proyecto socio periodo justificación". |
