# IU-CSP-0406-015 - Modificar proyecto - Prórrogas

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0406-015 - Modificar proyecto - Prórrogas******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Número prórroga | Secuencia  Numérico entero genérico | Número secuencial dentro del proyecto que asignará directamente el sistema en función de la ordenación de la fecha de concesión.  Se corresponde con el campo "num. prórroga" de la tabla "proyecto prórroga". |
