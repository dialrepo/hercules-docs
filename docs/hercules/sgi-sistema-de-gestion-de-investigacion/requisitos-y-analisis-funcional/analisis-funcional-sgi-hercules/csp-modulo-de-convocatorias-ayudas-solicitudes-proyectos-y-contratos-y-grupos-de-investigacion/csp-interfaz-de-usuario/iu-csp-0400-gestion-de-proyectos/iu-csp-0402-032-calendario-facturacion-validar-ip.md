# IU-CSP-0402-032 - Calendario facturación - Validar IP

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0402-032 - Calendario facturación - Validar IP******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| Estado | Selector  Texto corto  Obligatorio | Combo con los valores:   * Validada * Rechazada |
| Motivo del rechazo | Texto  Obligatorio si el estado es "Rechazada" | Sólo se muestra si se selecciona en Estado el valor de "Rechazada" |
