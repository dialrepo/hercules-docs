# IU-CSP-0402-028 - Añadir-modificar área temática

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0402-028 - Añadir área temática******** |
| Ver. objetivo | 0.4.0 |
| Ver. IU | 1.0.0 |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
...
| --- | --- | --- | --- |
| Añadir | Añade el área temática al proyecto | * + Sólo se puede seleccionar un nodo del árbol   + El nodo seleccionado se almacenará en el campo "área temática" de la tabla "contexto proyecto". | CSP-PRO-E  CSP-PRO-E\_UO |
