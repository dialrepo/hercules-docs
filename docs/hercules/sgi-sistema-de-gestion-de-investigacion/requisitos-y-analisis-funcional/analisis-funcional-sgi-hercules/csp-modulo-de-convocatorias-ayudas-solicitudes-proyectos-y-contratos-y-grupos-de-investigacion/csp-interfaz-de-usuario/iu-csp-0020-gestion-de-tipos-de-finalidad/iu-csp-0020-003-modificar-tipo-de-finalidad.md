# IU-CSP-0020-003 Modificar tipo de finalidad

|  |  |
| --- | --- |
| Cod. IU | ********IU-CSP-0020-003 Modificar tipo de finalidad******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Nombre | Texto corto  Obligatorio | No se podrá modificar el nombre a un nombre ya existente sobre un elemento activo (campo "activo" a "true") de la tabla "tipo finalidad".  No se podrá dejar vacío. |
...
|  |  |
| --- | --- |
| ACT-CSP-004-Administrador | CSP-TFIN-E |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | CSP-TFIN-V, CSP-TFIN-E |