# CU-CSP-1000-002 - Modificar convocatoria - Registrar

|  |  |
| --- | --- |
| Cod. CU | ****************CU-CSP-1000-002 - Modificar******** convocatoria - Registrar******** |
| Ver. objetivo |  |
| Ver. CU |  |
| Estado | IN PROGRESS |
| Fec. Aprobación |  |
| Épica, historia |  |
| Actores | ACT-CSP-003-Gestor, ACP-CSP-004-Administrador |
| Frecuencia | Media |
