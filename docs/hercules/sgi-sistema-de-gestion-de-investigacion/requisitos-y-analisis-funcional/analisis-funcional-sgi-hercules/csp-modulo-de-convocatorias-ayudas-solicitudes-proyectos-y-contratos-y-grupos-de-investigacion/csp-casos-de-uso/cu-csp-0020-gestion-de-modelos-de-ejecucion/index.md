# CU-CSP-0020 - Gestión de modelos de ejecución

|  |  |
| --- | --- |
| Cod. CU | **CU-CSP-0020 - Gestión de modelos de ejecución** |
| Ver. objetivo |  |
| Ver. CU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
* Tipos de fases [CU-CSP-0005 - Gestión de tipos de fase](https://confluence.um.es/confluence/spaces/GES/pages/221381977/CU-CSP-0005+-+Gesti%C3%B3n+de+tipos+de+fase)
