# CU-CSP-0020-003 - Modificar modelo de ejecución

|  |  |
| --- | --- |
| Cod. CU | **CU-CSP-0020-003 - Modificar modelo de ejecución** |
| Ver. objetivo |  |
| Ver. CU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
* Tipos de fases ([CU-CSP-0005 - Gestión de tipos de fases](https://confluence.um.es/confluence/pages/viewpage.action?pageId=87827119))
