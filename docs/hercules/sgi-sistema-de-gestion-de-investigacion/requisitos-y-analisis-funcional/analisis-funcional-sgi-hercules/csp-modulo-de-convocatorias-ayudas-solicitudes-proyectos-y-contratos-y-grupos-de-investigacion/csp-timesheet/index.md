...
* [Descripción](#CSPTimesheet-Descripción)
* [Estados y ciclo de vida](#CSPTimesheet-Estadosyciclodevida)
* [Hojas de firma de timesheet](#CSPTimesheet-Hojasdefirmadetimesheet)
* [Distribución de timesheet](#CSPTimesheet-Distribucióndetimesheet)
* [Vista ACT-CSP-001-Investigador miembro de equipo](#CSPTimesheet-VistaACT-CSP-001-Investigadormiembrodeequipo)
* [Vista ACT-CSP-001-Investigador con rol principal](#CSPTimesheet-VistaACT-CSP-001-Investigadorconrolprincipal)
...
El paso a estado "Validado IM"  supondrá la creación de un aviso que será gestionado por el módulo global del SGI [AVI - Módulo de Avisos / Alertas](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/gen-aspectos-generales/com-modulo-de-comunicados). Este aviso será recepcionado por el ACT- CSP-001-Investigador que actúe como IP del proyecto o por los ACT-CSP-003-Gestor de la unidad de gestión correspondiente, en caso que no esté activado el estado "validado IP".
...
El flujo de firma de las hojas de timesheet se establecerá a través de la integración del SGI con el sistema de firma digital corporativo REQ - NF - INT - 0110 - SFIDI - 001 - Hojas de firma de timesheet. De acuerdo a la capacidad de integración y posibilidad de configuración de un flujo de firma variable (en función del IP y unidad de gestión), el proceso de firma de los timesheet podrá estar más o menos automatizado. El sistema de firma digital deberá informar al SGI el momento en el que el flujo de firma definido ha finalizado, devolviendo al SGI el documento final firmado por todos los involucrados en el flujo definido. El documento ya firmado podrá ser descargado desde el SGI.

La plantilla de hoja de firma deberá ser establecida en la configuración de cada proyecto (Datos generales), y será generada haciendo uso del módulo común del SGI de generación de informes wip\_REP-CSP-003-Informe de hoja de firma
...
El ACT-CSP-001-Investigador tendrá acceso a las hojas de firma derivadas de sus timesheet, y será el encargado de iniciar el flujo de firma de las mismas, que será resuelto a través de la integración son el sistema de firma digital  REQ - NF - INT - 0110 - SFIDI - 001 - Hojas de firma de timesheet.
...
Del mismo modo ACT-CSP-001-Investigador con rol principal  accederá a las hojas de firma de todos los timesheet de los miembros del equipo de proyecto de acuerdo al flujo marcado por el sistema de firma digital REQ - NF - INT - 0110 - SFIDI - 001 - Hojas de firma de timesheet.