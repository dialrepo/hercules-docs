...
* [Descripción de convocatoria](#CSPConvocatorias-Descripcióndeconvocatoria)
  + [Datos generales](#CSPConvocatorias-Datosgenerales)
  + [Entidades convocantes](#CSPConvocatorias-Entidadesconvocantes)
  + [Entidades financiadoras](#CSPConvocatorias-Entidadesfinanciadoras)
  + [Enlaces](#CSPConvocatorias-Enlaces)
  + [Fases](#CSPConvocatorias-Fasesplazos_fases)
  + [Periodos de justificación](#CSPConvocatorias-Periodosdejustificación)
  + [Periodos de seguimiento científico](#CSPConvocatorias-Periodosdeseguimientocientífico)
  + [Hitos](#CSPConvocatorias-hitos_convocatoriaHitos)
  + [Documentos](#CSPConvocatorias-Documentos)
  + [Requisitos a cumplir por IP](#CSPConvocatorias-RequisitosacumplirporIP)
  + [Requisitos a cumplir por el equipo de investigación](#CSPConvocatorias-Requisitosacumplirporelequipodeinvestigación)
  + [Elegibilidad](#CSPConvocatorias-Elegibilidad)
    - [Conceptos de gasto permitidos](#CSPConvocatorias-Conceptosdegastopermitidos)
    - [Conceptos de gasto no permitidos](#CSPConvocatorias-Conceptosdegastonopermitidos)
  + [Partidas presupuestarias](#CSPConvocatorias-Partidaspresupuestarias)
  + [Configuración de solicitudes](#CSPConvocatorias-configuracion_solicitudesConfiguracióndesolicitudes)
  + [Palabras clave](#CSPConvocatorias-Palabrasclave)
* [Búsqueda y listado de convocatorias](#CSPConvocatorias-Búsquedaylistadodeconvocatorias)
  + [Perfiles de Unidades de gestión](#CSPConvocatorias-PerfilesdeUnidadesdegestión)
  + [Perfil investigador](#CSPConvocatorias-Perfilinvestigador)
...
* ACT-CSP-003-Gestor ([CSP - Actores](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/csp-modulo-de-convocatorias-ayudas-solicitudes-proyectos-y-contratos-y-grupos-de-investigacion/csp-actores))
* ACT-CSP-004-Administrador ([CSP - Actores](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/csp-modulo-de-convocatorias-ayudas-solicitudes-proyectos-y-contratos-y-grupos-de-investigacion/csp-actores))

pertenecientes a una de las unidades de gestión que tengan habilitado la creación de convocatorias entres sus funcionalidades ([USR - Módulo de usuarios](/confluence/pages/createpage.action?spaceKey=HERCULES&title=USR+-+M%C3%B3dulo+de+usuarios&linkCreation=true&fromPageId=597853534))
...
* Ámbito geográfico
* Tipo de formulario para la solicitud
* Configuración de la tramitación de solicitudes. Ver apartado [Configuración de solicitudes](#CSPConvocatorias-configuracion_solicitudes).
...
* Fuente de financiación. Ver [CSP - Configuración](/confluence/pages/createpage.action?spaceKey=HERCULES&title=CSP+-+Configuraci%C3%B3n&linkCreation=true&fromPageId=597853534).
* Tipo de financiación. Ver  [CSP - Configuración](/confluence/pages/createpage.action?spaceKey=HERCULES&title=CSP+-+Configuraci%C3%B3n&linkCreation=true&fromPageId=597853534).
...
El listado de conceptos de gasto disponible para indicar las dos configuraciones anteriores parte de los gastos que hubieran sido configurados de manera general en el SGI por los ACT-CSP-004-Administrador. Ver [CSP - Configuración](/confluence/pages/createpage.action?spaceKey=HERCULES&title=CSP+-+Configuraci%C3%B3n&linkCreation=true&fromPageId=597853534).
