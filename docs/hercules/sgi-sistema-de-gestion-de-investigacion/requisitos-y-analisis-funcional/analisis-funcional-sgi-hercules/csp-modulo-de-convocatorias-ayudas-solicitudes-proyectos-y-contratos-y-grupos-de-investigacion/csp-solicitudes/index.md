...
* [Flujo de estados de solicitud](#CSPSolicitudes-ciclo_estadosFlujodeestadosdesolicitud)
* [Descripción de la entidad "Solicitud"](#CSPSolicitudes-Descripcióndelaentidad"Solicitud")
  + [Datos generales](#CSPSolicitudes-Datosgenerales)
  + [Documentos](#CSPSolicitudes-Documentos)
  + [Hitos](#CSPSolicitudes-Hitos)
  + [Histórico de estados](#CSPSolicitudes-Históricodeestados)
  + [Palabras clave](#CSPSolicitudes-Palabrasclave)
* [Descripción solicitudes tipo "proyecto"](#CSPSolicitudes-Descripciónsolicitudestipo"proyecto")
  + [Ficha general](#CSPSolicitudes-Fichageneral)
  + [Áreas de conocimiento](#CSPSolicitudes-Áreasdeconocimiento)
  + [Clasificaciones](#CSPSolicitudes-Clasificaciones)
  + [Equipo](#CSPSolicitudes-Equipo)
  + [Responsable económico](#CSPSolicitudes-Responsableeconómico)
  + [Socios](#CSPSolicitudes-Socios)
  + [Entidades financiadoras](#CSPSolicitudes-Entidadesfinanciadoras)
  + [Desglose de presupuesto](#CSPSolicitudes-Desglosedepresupuesto)
  + [Autoevaluación de ética](#CSPSolicitudes-Autoevaluacióndeética)
  + [Concesión de proyecto](#CSPSolicitudes-Concesióndeproyecto)
  + [Vista investigador](#CSPSolicitudes-Vistainvestigador)
* [Descripción solicitudes tipo "grupo"](#CSPSolicitudes-Descripciónsolicitudestipo"grupo")
  + [Creación del grupo](#CSPSolicitudes-Creacióndelgrupo)
* [Descripción solicitudes tipo "RRHH"](#CSPSolicitudes-Descripciónsolicitudestipo"RRHH")
  + [Información adicional del solicitante](#CSPSolicitudes-Informaciónadicionaldelsolicitante)
  + [Identificación tutor/a del trabajo](#CSPSolicitudes-Identificacióntutor/adeltrabajo)
  + [Requisitos de la convocatoria](#CSPSolicitudes-Requisitosdelaconvocatoria)
  + [Memoria](#CSPSolicitudes-Memoria)
  + [Flujo solicitudes tipo "RRHH"](#CSPSolicitudes-Flujosolicitudestipo"RRHH")
* [Búsqueda y listado de solicitudes](#CSPSolicitudes-Búsquedaylistadodesolicitudes)
  + [Perfiles de Unidades de gestión](#CSPSolicitudes-PerfilesdeUnidadesdegestión)
  + [Perfil Investigador](#CSPSolicitudes-PerfilInvestigador)

El registro de solicitudes y su ciclo de revisión y aprobación será interno al SGI.  En este ciclo intervendrán los ACT- CSP-001-Investigador y los ACT-CSP-004-Administrador o ACT-CSP-003-Gestor de la Unidad de gestión vinculada a la convocatoria, siempre en función de la configuración indicada en la convocatoria durante su registro en el SGI ([IU-CSP-0201-013 - Crear convocatoria - Configuración de solicitudes](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/csp-modulo-de-convocatorias-ayudas-solicitudes-proyectos-y-contratos-y-grupos-de-investigacion/csp-interfaz-de-usuario/iu-csp-0200-gestion-de-convocatorias/iu-csp-0201-crear-convocatoria/iu-csp-0201-014-crear-convocatoria-configuracion-de-solicitudes)), en referencia a la habilitación de la presentación de solicitudes en el SGI. La tramitación de la solicitud en el SGI no sustituirá a la tramitación de la misma en la plataforma correspondiente de la entidad gestora/convocante/financiadora de la convocatoria, salvo que se trate de convocatorias del plan propio.
...
Ver prototipo de pantalla genérica para gestionar las palabras clave asociadas a una entidad [IU-GEN-0200 - Gestión de palabras clave](https://confluence.um.es/confluence/pages/viewpage.action?pageId=94570057) que se adaptará en el menú correspondiente de la gestión de una solicitud.
...
* Rol con el que participará en el equipo de proyecto. Se deberá especificar obligatoriamente un rol para cada uno de los miembros del equipo. Los roles disponibles serán los configurados en la tabla ["rol equipo"](#CSPSolicitudes-rol_equipo)
...
* El rol que desempeña. Los roles de los socios de proyecto estarán disponibles a través de la tabla [tipos de roles de socios](#CSPSolicitudes-rol_socio) (ejemplos de valores "líder", "colaborador")
...
* Rol que desempeña. Para ello se utilizará la misma tabla [tipos de rol de equipo](#CSPSolicitudes-rol_equipo) disponible para el equipo de proyecto propio.
...
Ver información ampliada en [CSP - Grupos de investigación](/hercules/sgi-sistema-de-gestion-de-investigacion/requisitos-y-analisis-funcional/analisis-funcional-sgi-hercules/csp-modulo-de-convocatorias-ayudas-solicitudes-proyectos-y-contratos-y-grupos-de-investigacion/csp-grupos-de-investigacion)
...
Los estados de la solicitud solamente podrán modificarse de acuerdo al diagrama de estados reflejado en [Flujo de solicitud](#CSPSolicitudes-ciclos_solicitud).
