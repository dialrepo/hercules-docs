# IU-ETI-0010-001 Búsqueda y listado de convocatorias reunión

|  |  |
| --- | --- |
| Cod. IU | ********IU-ETI-0010-001 Búsqueda y listado de convocatorias******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Comité | Desplegable  Texto corto  Opcional | Listado con los tres comités: CEISH, CEEA y CEIAB. |
...
| Ver | Muestra la pantalla de consulta convocatoria | Cuando la convocatoria de reunión tiene asociada un acta en estado "Finalizada" | ETI-CNV-E  ETI-CNV-V |
...
|  |  |
| --- | --- |
| ACT-ETI-001-Gestor | ETI-CNV-C, ETI-CNV-E, ETI-CNV-B, ETI-CNV-ENV |

#### Todos los permisos de acceso

|  |  |
| --- | --- |
| Permisos | ETI-CNV-V, ETI-CNV-C, ETI-CNV-E, ETI-CNV-B, ETI-CNV-ENV |