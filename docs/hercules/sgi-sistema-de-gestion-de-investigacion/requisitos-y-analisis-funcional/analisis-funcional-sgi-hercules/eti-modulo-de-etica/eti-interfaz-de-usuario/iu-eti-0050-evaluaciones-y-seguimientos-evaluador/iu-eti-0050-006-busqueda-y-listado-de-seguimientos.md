...
|  |  |
| --- | --- |
| Cod. IU | ********IU-ETI-0050-006 Búsqueda y listado de seguimientos******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
|  |  |
| --- | --- |
| Permisos | ETI-EVC-INV-VR, ETI-EVC-INV-EVALR, ETI-EVC-VR, ETI-EVC-EVALR |