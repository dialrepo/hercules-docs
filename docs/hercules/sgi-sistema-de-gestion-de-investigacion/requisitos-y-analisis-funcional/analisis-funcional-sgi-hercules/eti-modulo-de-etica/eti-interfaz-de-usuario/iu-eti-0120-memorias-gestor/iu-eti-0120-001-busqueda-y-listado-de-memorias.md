# IU-ETI-0120-001 Búsqueda y listado de memorias

|  |  |
| --- | --- |
| Cod. IU | ********IU-ETI-0110-001 Búsqueda y listado de memorias******** |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| Buscar | Aplica los filtros introducidos sobre la lista de memorias de peticiones de evaluación mostrando las que cumplen las condiciones | CU-ETI-0100-001 - Buscar Memorias | ETI-MEM-V  ETI-MEM-CEST |
...
|  |  |
| --- | --- |
| ACT-ETI-001-Gestor | ETI-MEM-V, ETI-MEM-CEST |
