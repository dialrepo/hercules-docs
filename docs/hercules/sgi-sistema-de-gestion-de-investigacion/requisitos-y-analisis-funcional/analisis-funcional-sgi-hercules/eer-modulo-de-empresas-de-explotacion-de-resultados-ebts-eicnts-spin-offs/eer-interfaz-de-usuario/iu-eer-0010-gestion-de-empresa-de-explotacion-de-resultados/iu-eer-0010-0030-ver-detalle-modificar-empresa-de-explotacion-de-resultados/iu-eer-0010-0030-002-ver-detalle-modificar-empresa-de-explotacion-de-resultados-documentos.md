# IU-EER-0010-0030-002 - Ver detalle-modificar empresa de explotación de resultados - Documentos

|  |  |
| --- | --- |
| Cod. IU | IU-EER-0010-0030-002 - Ver detalle-modificar empresa de explotación de resultados - Documentos |
| Ver. objetivo |  |
| Ver. IU | 1.0.0 |
| Estado | LIBERADO\_ |
| Fec. Aprobación |  |
...
| --- | --- | --- | --- |
| Ver (documento) | Mostrará los datos del documento seleccionado en el formulario de datos del documento, a la derecha del árbol. |  | EER-EER-V  EER-EER-E |
