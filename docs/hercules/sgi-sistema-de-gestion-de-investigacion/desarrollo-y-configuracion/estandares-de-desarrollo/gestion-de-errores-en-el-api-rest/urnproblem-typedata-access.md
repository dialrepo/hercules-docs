...
| status | 400 |  |
| detail | El mensaje concreto dependerá del tipo de problema. | En la mayoría de los casos este mensaje de detalle no estará internacionalizado  Ej:  Cannot insert existing object with id 0!. Please use update. |
