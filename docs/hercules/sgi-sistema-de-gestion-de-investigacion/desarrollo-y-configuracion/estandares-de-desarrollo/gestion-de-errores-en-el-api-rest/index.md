# Gestión de errores en el API Rest

Para la gestión de errores REST, seguiremos la especificación [RFC 7807](https://tools.ietf.org/html/rfc7807), que define cómo devolver la información de errores al cliente.
...
* [When HTTP status code is not enough: tackling web APIs error reporting](https://www.javacodegeeks.com/2019/05/http-status-code-enough-tackling-web-apis-error-reporting.html)