...
| status | 400 |  |
| detail | El mensaje concreto dependerá del parámetro y el tipo de problema. | En la mayoría de los casos este mensaje de detalle no estará internacionalizado  Ej:  Missing matrix variable 'v1' for method parameter of type String |
