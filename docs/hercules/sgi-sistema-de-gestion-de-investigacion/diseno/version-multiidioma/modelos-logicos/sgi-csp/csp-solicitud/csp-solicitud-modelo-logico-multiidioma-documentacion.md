# CSP-Solicitud - Modelo lógico multiidioma - Documentación

* [Entidades del modelo de solicitud genérica](#CSPSolicitudModelológicomultiidiomaDocumentación-Entidadesdelmodelodesolicitudgenérica)
  + [Entidad Solicitud](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadSolicitud)
  + [Entidad Título de una solicitud "SolicitudTitulo"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadTítulodeunasolicitud"SolicitudTitulo")
  + [Entidad Observaciones de una solicitud: "SolicitudObservaciones"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadObservacionesdeunasolicitud:"SolicitudObservaciones")
  + [Entidad Histórico de estados de una solicitud: "EstadoSolicitud"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadHistóricodeestadosdeunasolicitud:"EstadoSolicitud")
  + [Entidad Comentario de un estado de solicitud: "EstadoSolicitudComentario"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadComentariodeunestadodesolicitud:"EstadoSolicitudComentario")
  + [Entidad Documentos de una solicitud: "SolicitudDocumento"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadDocumentosdeunasolicitud:"SolicitudDocumento")
  + [Entidad Nombre de un documento de una solicitud: "SolicitudDocumentoNombre"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadNombredeundocumentodeunasolicitud:"SolicitudDocumentoNombre")
  + [Entidad Comentarios de un documento de una solicitud: "SolicitudDocumentoComentario"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadComentariosdeundocumentodeunasolicitud:"SolicitudDocumentoComentario")
  + [Entidad Hitos de una solicitud: "SolicitudHito"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadHitosdeunasolicitud:"SolicitudHito")
  + [Entidad Comentario de un hito de solicitud: "SolicitudHitoComentario"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadComentariodeunhitodesolicitud:"SolicitudHitoComentario")
  + [Entidad Avisos para un hito de solicitud: "SolicitudHitoAviso"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadAvisosparaunhitodesolicitud:"SolicitudHitoAviso")
  + [Entidad Modalidad de una solicitud: "SolicitudModalidad"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadModalidaddeunasolicitud:"SolicitudModalidad")
  + [Entidad Palabras clave de una solicitud: "SolicitudPalabraClave"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadPalabrasclavedeunasolicitud:"SolicitudPalabraClave")
* [Enumerados del modelo de solicitud genérica](#CSPSolicitudModelológicomultiidiomaDocumentación-Enumeradosdelmodelodesolicitudgenérica)
  + [Enumerado Listado de estados de solicitud: "TipoEstadoSolicitud"](#CSPSolicitudModelológicomultiidiomaDocumentación-EnumeradoListadodeestadosdesolicitud:"TipoEstadoSolicitud")
* [Entidades del modelo Solicitudes de tipo proyecto](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadesdelmodeloSolicitudesdetipoproyecto)
  + [Entidad Solicitud de tipo proyecto: "SolicitudProyecto"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadSolicituddetipoproyecto:"SolicitudProyecto")
  + [Entidad Objetivos de proyecto de una solicitud de tipo proyecto: "SolicitudProyectoObjetivos"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadObjetivosdeproyectodeunasolicituddetipoproyecto:"SolicitudProyectoObjetivos")
  + [Entidad Intereses de proyecto de una solicitud de tipo proyecto: "SolicitudProyectoIntereses"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadInteresesdeproyectodeunasolicituddetipoproyecto:"SolicitudProyectoIntereses")
  + [Entidad Resultados previstos de una solicitud de tipo proyecto: "SolicitudProyectoResultadosPrevistos"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadResultadosprevistosdeunasolicituddetipoproyecto:"SolicitudProyectoResultadosPrevistos")
  + [Entidad Roles de miembro de equipo: "RolProyecto"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadRolesdemiembrodeequipo:"RolProyecto")
  + [Entidad Nombre del rol de equipo de proyecto: "RolProyectoNombre"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadNombredelroldeequipodeproyecto:"RolProyectoNombre")
  + [Entidad Descripción rol de equipo de proyecto: "RolProyectoDescripcion"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadDescripciónroldeequipodeproyecto:"RolProyectoDescripcion")
  + [Entidad Abreviatura rol de equipo de proyecto: "RolProyectoAbreviatura"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadAbreviaturaroldeequipodeproyecto:"RolProyectoAbreviatura")
  + [Entidad Colectivos para un rol de equipo: "RolProyectoColectivo"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadColectivosparaunroldeequipo:"RolProyectoColectivo")
  + [Entidad Roles de socio de proyecto: "RolSocio"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadRolesdesociodeproyecto:"RolSocio")
  + [Entidad Nombre del rol de socio: "RolSocioNombre"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadNombredelroldesocio:"RolSocioNombre")
  + [Entidad Descripción rol de socio: "RolSocioDescripcion"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadDescripciónroldesocio:"RolSocioDescripcion")
  + [Entidad Abreviatura rol de socio: "RolSocioAbreviatura"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadAbreviaturaroldesocio:"RolSocioAbreviatura")
  + [Entidad Áreas de conocimiento de una solicitud de proyecto: "SolicitudProyectoArea"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadÁreasdeconocimientodeunasolicituddeproyecto:"SolicitudProyectoArea")
  + [Entidad Clasificaciones de una solicitud de proyecto: "SolicitudProyectoClasificacion"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadClasificacionesdeunasolicituddeproyecto:"SolicitudProyectoClasificacion")
  + [Entidad Entidades financiadoras de una solicitud de proyecto: "SolicitudProyectoEntidad"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadEntidadesfinanciadorasdeunasolicituddeproyecto:"SolicitudProyectoEntidad")
  + [Entidad Entidad financiadoras de una ajenas a la convocatoria de una solicitud de proyecto: "SolicitudProyectoEntidadFinanciadoraAjena"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadEntidadfinanciadorasdeunaajenasalaconvocatoriadeunasolicituddeproyecto:"SolicitudProyectoEntidadFinanciadoraAjena")
  + [Entidad Miembros de equipo de una solicitud de proyecto: "SolicitudProyectoEquipo"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadMiembrosdeequipodeunasolicituddeproyecto:"SolicitudProyectoEquipo")
  + [Entidad Miembros de equipo de un socio para una solicitud de proyecto: "SolicitudProyectoEquipoSocio"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadMiembrosdeequipodeunsocioparaunasolicituddeproyecto:"SolicitudProyectoEquipoSocio")
  + [Entidad Periodos de justificación de un socio para una solicitud de proyecto: "SolicitudProyectoPeriodoJustificacion"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadPeriodosdejustificacióndeunsocioparaunasolicituddeproyecto:"SolicitudProyectoPeriodoJustificacion")
  + [Entidad Observaciones de un periodo de justificación de un socio para una solicitud de proyecto: "SolicitudProyectoPeriodoJustificacionObservaciones"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadObservacionesdeunperiododejustificacióndeunsocioparaunasolicituddeproyecto:"SolicitudProyectoPeriodoJustificacionObservaciones")
  + [Entidad Periodos de pago de un socio para una solicitud de proyecto: "SolicitudProyectoPeriodoPago"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadPeriodosdepagodeunsocioparaunasolicituddeproyecto:"SolicitudProyectoPeriodoPago")
  + [Entidad Presupuesto para una solicitud de proyecto: "SolicitudProyectoPresupuesto"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadPresupuestoparaunasolicituddeproyecto:"SolicitudProyectoPresupuesto")
  + [Entidad Observaciones del desglose de presupuesto de una solicitud de proyecto: "SolicitudProyectoPresupuestoObservaciones"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadObservacionesdeldesglosedepresupuestodeunasolicituddeproyecto:"SolicitudProyectoPresupuestoObservaciones")
  + [Entidad Responsable económico para una solicitud de proyecto: "SolicitudProyectoResponsableEconomico"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadResponsableeconómicoparaunasolicituddeproyecto:"SolicitudProyectoResponsableEconomico")
  + [Entidad Socios para una solicitud de proyecto: "SolicitudProyectoSocio"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadSociosparaunasolicituddeproyecto:"SolicitudProyectoSocio")
* [Enumerado del modelo solicitudes tipo proyecto](#CSPSolicitudModelológicomultiidiomaDocumentación-Enumeradodelmodelosolicitudestipoproyecto)
  + [Enumerado Tipos de equipo: "TipoEquipoProyecto"](#CSPSolicitudModelológicomultiidiomaDocumentación-EnumeradoTiposdeequipo:"TipoEquipoProyecto")
  + [Enumerado Tipos de orden para un rol de equipo: "TipoOrden"](#CSPSolicitudModelológicomultiidiomaDocumentación-EnumeradoTiposdeordenparaunroldeequipo:"TipoOrden")
  + [Enumerado Tipos de presupuesto para una solicitud: "TipoPresupuesto"](#CSPSolicitudModelológicomultiidiomaDocumentación-EnumeradoTiposdepresupuestoparaunasolicitud:"TipoPresupuesto")
* [Entidades del modelo de solicitudes de tipo grupo](#CSPSolicitudModelológicomultiidiomaDocumentación-Entidadesdelmodelodesolicitudesdetipogrupo)
  + [Entidad Solicitud de tipo grupo: "SolicitudGrupo"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadSolicituddetipogrupo:"SolicitudGrupo")
* [Enumerados del modelo de solicitudes de tipo grupo](#CSPSolicitudModelológicomultiidiomaDocumentación-Enumeradosdelmodelodesolicitudesdetipogrupo)
  + [Enumerado Tipos de solicitudes de grupo: "TipoSolicitudGrupo"](#CSPSolicitudModelológicomultiidiomaDocumentación-EnumeradoTiposdesolicitudesdegrupo:"TipoSolicitudGrupo")
* [Entidades del modelo de solicitudes de tipo RRHH](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadesdelmodelodesolicitudesdetipoRRHH)
  + [Entidad Solicitud de tipo RRHH: "SolicitudRRRHH"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadSolicituddetipoRRHH:"SolicitudRRRHH")
  + [Entidad Título del trabajo de una solicitud de RRHH: "SolicitudRRHHTituloTrabajo"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadTítulodeltrabajodeunasolicituddeRRHH:"SolicitudRRHHTituloTrabajo")
  + [Entidad Resumen del trabajo de una solicitud de RRHH: "SolicitudRRHHResumen"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadResumendeltrabajodeunasolicituddeRRHH:"SolicitudRRHHResumen")
  + [Entidad Observaciones del trabajo de una solicitud de RRHH: "SolicitudRRHHObservaciones"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadObservacionesdeltrabajodeunasolicituddeRRHH:"SolicitudRRHHObservaciones")
  + [Entidad Categorías de convocatoria para una solicitud de RRHH: "SolicitudRRRHHRequisitoCategoria"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadCategoríasdeconvocatoriaparaunasolicituddeRRHH:"SolicitudRRRHHRequisitoCategoria")
  + [Entidad Niveles académicos de convocatoria para una solicitud de RRHH: "SolicitudRRRHHRequisitoNivelAcadémico"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadNivelesacadémicosdeconvocatoriaparaunasolicituddeRRHH:"SolicitudRRRHHRequisitoNivelAcadémico")
  + [Entidad Solicitante externo para una solicitud: "SolicitanteExterno"](#CSPSolicitudModelológicomultiidiomaDocumentación-EntidadSolicitanteexternoparaunasolicitud:"SolicitanteExterno")
  + [Entidad solicitud externa: "SolicitudExterna"](#CSPSolicitudModelológicomultiidiomaDocumentación-Entidadsolicitudexterna:"SolicitudExterna")

### Entidades del modelo de solicitud genérica

#### Entidad Solicitud

Entidad principal del modelo CSP Solicitud. Representa una solicitud genérica y contiene los datos básicos de la misma. Según el tipo de solicitud, esta entidad se complementará o no con otra entidad que particulariza los datos de acuerdo al tipo.
...
| anio : Integer Private  Año natural en el que se enmarca la solicitud. Permitirá agrupar las solicitudes por año natural. El año en el que se clasifique una solicitud no tendría por qué coincidir con el de su fecha de creación/presentación. Si la solicitud está vinculada a una convocatoria, heredará el campo año de la misma. |
| modeloEjecucion : ModeloEjecucion Private  Modelo de Ejecución bajo el que se clasifica la actividad solicitada. Si la solicitud se asocia a una convocatoria registrada en el SGI, el modelo de ejecución se corresponderá con el de la convocatoria. Es una FK a la tabla "modelo ejecución" |
| finalidad : TipoFinalidad Private  Clasificación del proyecto de acuerdo a la naturaleza de la actividad de investigación que representa Si la solicitud se asocia a una convocatoria registrada en el SGI, el valor de este campo "finalidad" se corresponderá con el del campo "finalidad" de la convocatoria. Es una FK a la tabla "tipo finalidad". |
| origenSolicitud : TipoOrigenSolicitud Private  Identifica el modo de creación de una solicitud con el objetivo de aplicar unas validaciones de obligatoriedad u otras sobre la pantalla de creación de solicitud. Los modos de creación posibles son: \* Solicitud asociado a una convoctoria registrada en el SGI (la solicitud deberá llevar informado el campo "solicitud") \* Solicitud asociada a una convocatoria no registrada en el SGI (la solicitud deberá llevar informados los campos "referencia de convocatoria externa" y "unidad de gestión") \* Solicitud sin convocatoria (la solicitud deberá llevar informados los campos "unidad de gestión", "modelo de ejecución" y "tipo de finalidad") |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) Petición Evaluación Ética Proyecto  Cardinality:  [1] |
| Association (direction: Unspecified) | |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudRRHH  Cardinality:  [1] |
| Association (direction: Unspecified) | |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitanteExterno  Cardinality:  [0..1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudHito  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudTitulo  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudObservaciones  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudExterna  Cardinality:  [0..1] | Target: Public (Class) Solicitud  Cardinality:  [1] |
| Association (direction: Unspecified) | |
| Source: Public (Enumeration) TipoOrigenSolicitud | Target: Public (Class) Solicitud |
| Association (direction: Unspecified) | |
...
#### Entidad Título de una solicitud "SolicitudTitulo"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el campo "título" de una solicitud. No es un campo obligatorio. Una solicitud puede ser creada con el campo título vacío.

En el caso de las solicitudes de tipo proyecto o rrhh se corresponderá con el título del proyecto SGI posterior, en el caso de las solicitudes de grupo con el nombre del grupo.

| **ATTRIBUTES** |
| --- |
| solicitud : Solicitud  Private  Identificador de la solicitud a la que pertenece el título. Es una FK a la tabla "solicitud". |
| lang : String  Private  Idioma en el que está expresado el valor del campo título de la solicitud. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo título de la solicitud, expresado en el idioma indicado por el campo lang |
...
#### Entidad Observaciones de una solicitud: "SolicitudObservaciones"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el campo "observaciones" de una solicitud. No es un campo obligatorio. Las observaciones se recogen a través de un campo de texto de libre introducción. A través del campo observaciones se permite indicar cualquier información complementaria de la solicitud.

| **ATTRIBUTES** |
| --- |
| solicitud : Solicitud  Private  Identificador de la solicitud a la que pertenecen las observaciones. Es una FK a la tabla "solicitud". |
| lang : String  Private  Idioma en el que está expresado el valor del campo observaciones de la solicitud. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor que toma el campo observaciones de la solicitud, expresado en el idioma indicado por el campo lang. |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) EstadoSolicitud  Cardinality:  [1] | Target: Public (Class) SolicitudEstadoComentario  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) EstadoSolicitud  Cardinality:  [0..\*] |

#### Entidad Comentario de un estado de solicitud: "EstadoSolicitudComentario"

Entidad para almacenar, en todos los idiomas soportados por la aplicación, el comentario asociado a un estado de la solicitud. El comentario se introduce en la acción de Cambiar estado de la solicitud a través de un campo de texto y es opcional.

| **ATTRIBUTES** |
| --- |
| estadoSolicitud : EstadoSolicitud  Private  Estado concreto de la solicitud al que pertenece el comentario. Es una FK a la tabla EstadoSolicitud |
| lang : String  Private  Idioma en el que está expresado el valor del campo comentario del estado de la solicitud. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo comentario de un estado de una solicitud. Está expresado en el idioma indicado por el campo lang |
...
Entidad para almacenar los documentos asociados a una solicitud
...
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudDocumento  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudDocumentoComentario  Cardinality:  [0..\*] | Target: Public (Class) SolicitudDocumento  Cardinality:  [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudDocumentoNombre  Cardinality:  [1..\*] | Target: Public (Class) SolicitudDocumento  Cardinality:  [1] |

#### Entidad Nombre de un documento de una solicitud: "SolicitudDocumentoNombre"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el nombre de un documento de una solicitud de tipo proyecto. Es un nombre interno al SGI, independiente del nombre propiamente dicho del fichero (archivo). El nombre de un documento es un campo de texto y es de introducción obligatoria.

| **ATTRIBUTES** |
| --- |
| solicitudDocumento : SolicitudDocumento  Private  Documento de solicitud al que pertenece el campo nombre. Es una FK a la tabla SolicitudDocumento |
| lang : String  Private  Idioma en el que está expresado el valor del campo nombre de un documento de una solicitud. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del nombre del documento de una solicitud. Está expresado en el idioma indicado por el campo lang. |
...
#### Entidad Comentarios de un documento de una solicitud: "SolicitudDocumentoComentario"
...
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudHito  Cardinality:  [1] | Target: Public (Class) SolicitudHitoComentario  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudHito  Cardinality:  [0..\*] | Target: Public (Class) TipoHito  Cardinality:  [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudHito  Cardinality:  [0..\*] |

#### Entidad Comentario de un hito de solicitud: "SolicitudHitoComentario"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el comentario asociado a un hito de una solicitud. Este comentario recoge cualquier explicación u observación asociada al hito. Se introduce a través de un campo de texto y opcional.

| **ATTRIBUTES** |
| --- |
| solicitudHito : SolicitudHito  Private  Hito de la solicitud al que pertenece el comentario. Es una FK a la tabla SolicitudHito. |
| lang : String  Private  Idioma en el que está expresado el valor del campo comentario de un hito de una solicitud. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del comentario del hito de la solicitud. Está expresado en el idioma indicado por el campo lang |
...
| programaConvocatoria : Programa Private  Programa con el que está asociada la entidad convocante en la convocatoria de origen de la solicitud (tabla "convocatoria entidad convocante"). Es una FK a la tabla "programa" (modelo lógico "CSP Convocatoria"). |
...
| rolUniversidad : RolSocio  Private   Indica con qué rol participará la Universidad en el proyecto. Sólo estará cumplimentado si el proyecto es coordinado, siendo obligatorio en este caso. Será un valor de los configurados en la tabla "rol socio". Es una FK a la tabla "rol socio". |
...
| --- | --- |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyecto  Cardinality:  [0..\*] | Target: Public (Class) RolSocio  Cardinality:  [0..1] |
| Association (direction: Unspecified) | |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoResultadosPrevistos  Cardinality:  [0..\*] | Target: Public (Class) SolicitudProyecto  Cardinality:  [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoObjetivos  Cardinality:  [0..\*] | Target: Public (Class) SolicitudProyecto  Cardinality:  [1..] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoPresupuesto  Cardinality:  [0..\*] | Target: Public (Class) SolicitudProyecto  Cardinality:  [0..1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudProyecto  Cardinality:  [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoIntereses  Cardinality:  [0..\*] | Target: Public (Class) SolicitudProyecto  Cardinality:  [1] |
| Association (direction: Unspecified) | |
| Source: Public (Enumeration) TipoPresupuesto | Target: Public (Class) SolicitudProyecto |

#### Entidad Objetivos de proyecto de una solicitud de tipo proyecto: "SolicitudProyectoObjetivos"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo "objetivos" de una solicitud de tipo proyecto. Los objetivos en una solicitud de tipo proyecto se introducen a través de un campo de texto libre. Es un campo opcional.

| **ATTRIBUTES** |
| --- |
| solicitudProyecto : SolicitudProyecto  Private  Solicitud de tipo proyecto a la que pertenecen los objetivos. Es una FK a la tabla SolicitudProyecto |
| lang : String  Private  Idioma en el que está expresado el valor del campo objetivos de la solicitud de tipo proyecto. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo objetivos asociado a una solicitud de tipo proyecto y expresado en el idioma indicado por el campo lang de esta tabla. |
...
#### Entidad Intereses de proyecto de una solicitud de tipo proyecto: "SolicitudProyectoIntereses"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo "justificacion e intereses perseguidos" de una solicitud de tipo proyecto. Su valor se introduce a través de un campo de texto libre y es un campo opcional.

| **ATTRIBUTES** |
| --- |
| solicitudProyecto : SolicitudProyecto  Private  Solicitud de tipo proyecto a la que pertenece el valor del campo intereses. Es una FK a la tabla SolicitudProyecto |
| lang : String  Private  Idioma en el que está expresado el valor del campo justificación e intereses de una solicitud de tipo proyecto. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo "justificación e intereses" asociado a una solicitud de tipo proyecto. Está expresado en el idioma indicado por el caapo "lang" de esta tabla. |
...
#### Entidad Resultados previstos de una solicitud de tipo proyecto: "SolicitudProyectoResultadosPrevistos"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo "resultados previstos" de una solicitud de tipo proyecto. Los resultados previstos en una solicitud de tipo proyecto se introducen a través de un campo de texto libre. Es un campo opcional.

| **ATTRIBUTES** |
| --- |
| solicitudProyecto : SolicitudProyecto  Private  Solicitud de tipo proyecto a la que pertenecen los resultados previstos. Es una FK a la tabla SolicitudProyecto |
| lang : String  Private  Idioma en el que está expresado el valor del campo resultados previstos de una solicitud de tipo proyecto. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo "resultados previstos" asociado a una solicitud de tipo proyecto. Está expresado en el idioma indicado por el campo "lang" de esta tabla. |
...
| Association (direction: Unspecified) | |
| Source: Public (Class) RolProyectoNombre  Cardinality: [1..\*] | Target: Public (Class) RolProyecto   Cardinality: [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) RolProyectoDescripcion  Cardinality: [0..\*] | Target: Public (Class) RolProyecto   Cardinality: [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) RolProyectoAbreviatura  Cardinality: [0..\*] | Target: Public (Class) RolProyecto   Cardinality: [1] |

#### Entidad Nombre del rol de equipo de proyecto: "RolProyectoNombre"

Entidad para poder almacenar el nombre identificativo del rol de los Equipos de Proyecto en los idiomas soportados por la aplicación. Es el nombre visible en los desplegables del interface de usuario.

|  |
| --- |
| **ATTRIBUTES** |
| rolProyecto : RolProyecto Private  Identificador del rol de proyecto a la que pertenece el nombre. Es una FK a la tabla "rol proyecto". |
| lang : String Private  Identifica al idioma en el que esta almacenado el nombre. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String Private  Nombre del rol de proyecto en el idioma indicado por el campo "lang". Es un campo de texto libre con un máximo de 50 caracteres. Es un campo obligatorio del rol de proyecto en al menos uno de los idiomas. |
...
#### Entidad Descripción rol de equipo de proyecto: "RolProyectoDescripcion"

Entidad para poder almacenar la descripción rol de los Equipos de Proyecto en los idiomas soportados por la aplicación.

|  |
| --- |
| **ATTRIBUTES** |
| rolProyecto : RolProyecto Private  Identificador del rol de proyecto a la que pertenece la descripción. Es una FK a la tabla "rol proyecto". |
| lang : String Private  Identifica al idioma en el que esta almacenado la descripción. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String Private  Descripción del rol de proyecto en el idioma indicado por el campo "lang". Es un campo de texto libre con un máximo de 250 caracteres. |
...
#### Entidad Abreviatura rol de equipo de proyecto: "RolProyectoAbreviatura"

Entidad para poder almacenar la abreviatura rol de los Equipos de Proyecto en los idiomas soportados por la aplicación.

|  |
| --- |
| **ATTRIBUTES** |
| rolProyecto : RolProyecto Private  Identificador del rol de proyecto a la que pertenece la abreviatura. Es una FK a la tabla "rol proyecto". |
| lang : String Private  Identifica al idioma en el que esta almacenado la descripción. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String Private  Abreviaura del rol de proyecto en el idioma indicado por el campo "lang". Es un campo de texto libre con un máximo de 5caracteres. Es un campo obligatorio del rol de proyecto en al menos uno de los idiomas. |
...
| Association (direction: Unspecified) | |
| Source: Public (Class)RolSocioNombre  Cardinality: [1..\*] | Target: Public (Class) RolSocio   Cardinality: [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) RolSocioDescripcion  Cardinality: [0..\*] | Target: Public (Class) RolSocio  Cardinality: [1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) RolSocioAbreviatura  Cardinality: [0..\*] | Target: Public (Class) RolSocio  Cardinality: [1] |

#### Entidad Nombre del rol de socio: "RolSocioNombre"

Entidad para poder almacenar el nombre identificativo del rol de los Socios en los idiomas soportados por la aplicación. Es el nombre visible en los desplegables del interface de usuario.

|  |
| --- |
| **ATTRIBUTES** |
| rolSocio : RolSocio Private  Identificador del rol de Socio a la que pertenece el nombre. Es una FK a la tabla "rol socio". |
| lang : String Private  Identifica al idioma en el que esta almacenado el nombre. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String Private  Nombre del rol de socio en el idioma indicado por el campo "lang". Es un campo de texto libre con un máximo de 50 caracteres. Es un campo obligatorio del rol de socio en al menos uno de los idiomas. |
...
#### Entidad Descripción rol de socio: "RolSocioDescripcion"

Entidad para poder almacenar la descripción rol de los Socios en los idiomas soportados por la aplicación.

|  |
| --- |
| **ATTRIBUTES** |
| rolSocio : RolSocio Private  Identificador del rol de socio a la que pertenece la descripción. Es una FK a la tabla "rol socio". |
| lang : String Private  Identifica al idioma en el que esta almacenado la descripción. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String Private  Descripción del rol de socio en el idioma indicado por el campo "lang". Es un campo de texto libre con un máximo de 250 caracteres. |
...
#### Entidad Abreviatura rol de socio: "RolSocioAbreviatura"

Entidad para poder almacenar la abreviatura identificativa del rol de los Socios en los idiomas soportados por la aplicación.

|  |
| --- |
| **ATTRIBUTES** |
| rolSocio : RolSocio Private  Identificador del rol de socio a la que pertenece la abreviatura. Es una FK a la tabla "rol socio". |
| lang : String Private  Identifica al idioma en el que esta almacenado la descripción. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String Private  Abreviaura del rol de socio en el idioma indicado por el campo "lang". Es un campo de texto libre con un máximo de 5 caracteres. Es un campo obligatorio del rol de socio en al menos uno de los idiomas. |
...
| --- | --- |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoPeriodoJustificacion  Cardinality:  [1] | Target: Public (Class) SolicitudProyectoPeriodoJustificacionObservaciones  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
...
#### Entidad Observaciones de un periodo de justificación de un socio para una solicitud de proyecto: "SolicitudProyectoPeriodoJustificacionObservaciones"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo observaciones de un periodo de justificación para un socio de proyecto indicado en una solicitud de tipo proyecto. Este campo observaciones se introduce a través de un campo de texto libre y es opcional.

| **ATTRIBUTES** |
| --- |
| solicitudProyectoPeriodoJustificacion : SolicitudProyectoPeriodoJustificacion  Private  Periodo de justificación del socio de la solicitud de tipo proyecto al que pertenecen las observaciones. Es una FK a la tabla SolicitudProyectoPeriodoJustificacion |
| lang : String  Private  Idioma en el que está expresado el valor del campo observaciones de un periodo de justificación de un socio (para una solicitud de tipo proyecto). Es un código de 2 caracteres:   * es * en * eu |
| values\_ : String  Private  Valor del campo observaciones de un periodo de justificación de un socio expresado en el idioma indicado en el campo "lang". |
...
| --- | --- |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoPresupuesto  Cardinality:  [1] | Target: Public (Class) SolicitudProyectoPresupuestoObservaciones  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudProyectoPresupuesto  Cardinality:  [0..\*] | Target: Public (Class) SolicitudProyectoEntidad  Cardinality:  [0..1] |
| Association (direction: Unspecified) | |
...
#### Entidad Observaciones del desglose de presupuesto de una solicitud de proyecto: "SolicitudProyectoPresupuestoObservaciones"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo observaciones de un ítem del presupuesto de una solicitud de tipo proyecto. Este campo observaciones se introduce a través de un campo de texto libre y es opcional.

| **ATTRIBUTES** |
| --- |
| solicitudProyectoPresupuesto : SolicitudProyectoPresupuesto  Private  Ítem del presupuesto de una solicitud de proyecto al que pertenecen las observaciones. Es una FK a la tabla SolicitudProyectoPresupuesto |
| lang : String  Private  Idioma en el que está expresado el valor del campo observaciones de un apunte del presupuesto de una solicitud de tipo proyecto. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo observaciones de un apunte del presupuesto de una solicitud de tipo proyecto. Está expresado en el idioma indicado por el campo lang. |
...
| id : Long  Private  Identificador único de la tabla. Secuencia. Clave primaria. |
| solicitud : Solicitud  Private  Solicitud genérica a la que pertenece el registro. Es una FK a la tabla "solicitud". |
| universidadRef : String  Private  Campo para recoger la referencia de la Universidad a la que pertenece el solicitante. Esta referencia se corresponde con el identificador de la entidad que representa a la Universidad en el sistema de gestión de empresas corporativo. |
| areaANEPRef : String  Private  Área ANEP especificada en la solicitud. Las áreas ANEP se implementan como una Clasificación (modelo lógico ESB-SGO). Se corresponde con el identificador del área en la tabla Clasificación. |
| universidad : String  Private  Nombre de la universidad a la que pertenece la persona que realiza la solicitud (solicitante). Si la solicitud es introducida directamente por la persona solicitante, no dispondrá en el interface gráfico del buscador de entidades (a través del que quedaría cumplimentado el campo "universidad ref") sino que debe introducir el nombre de la universidad como un literal. Será la unidad de gestión, en el proceso de validación de la solicitud, quien traducirá ese texto a la referencia de la entidad universidad (campo "universidad ref"), a través del buscador de entidades. |
| tutorRef : String  Private  Referencia a la persona especificada como tutor/a en la solicitud. Es el identificador de la persona en el sistema de gestión de personas corporativo. |

| **ASSOCIATIONS** | |
| --- | --- |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudRRHH  Cardinality:  [1] | Target: Public (Class) SolicitudRRHHIObservaciones  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudRRHH  Cardinality:  [0..\*] | Target: Public (Class) Clasificacion  Cardinality:  [0..1] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudRRHH  Cardinality:  [1] | Target: Public (Class) SolicitudRRHHResumen  Cardinality:  [1..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudRRHH  Cardinality:  [1] | Target: Public (Class) SolicitudRRHHTituloTrabajo  Cardinality:  [1..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudRRHH  Cardinality:  [1] | Target: Public (Class) SolicitudRRHHRequisitoNivelAcademico  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) SolicitudRRHH  Cardinality:  [1] | Target: Public (Class) SolicitudRRHHRequisitoCategoria  Cardinality:  [0..\*] |
| Association (direction: Unspecified) | |
| Source: Public (Class) Solicitud  Cardinality:  [1] | Target: Public (Class) SolicitudRRHH  Cardinality:  [1] |

#### Entidad Título del trabajo de una solicitud de RRHH: "SolicitudRRHHTituloTrabajo"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo "título del trabajo" de una solicitud de tipo RRHH. Es el título asociado al trabajo con el que se opta a la solicitud. El campo título del trabjo está incluido en el apartado Memoria del menú Datos de RRHH de una solicitud.

Su valor se introduce a través de un campo de texto libre y es un campo obligatorio.

| **ATTRIBUTES** |
| --- |
| solicitudRRHH : SolicitudRRHH  Private  Solicitud de RRHH a la que pertenece el campo título del trabajo. Es una FK a la tabla SolicitudRRHH |
| lang : String  Private  Idioma en el que está expresado el valor del campo título del trabajo de una solicitud de tipo RRHH. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo título del trabajo de la solicitud de RRHH. Está expresado en el idioma indicado por el campo lang. |
...
#### Entidad Resumen del trabajo de una solicitud de RRHH: "SolicitudRRHHResumen"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo "resumen" de una solicitud de tipo RRHH. Es el resumen del trabajo con el que se opta a la solicitud de RRHH. Este campo está disponible en el apartado Memoria del menú Datos RRHH de la Solicitud. Su valor se introduce a través de un campo de texto libre y es un campo obligatorio.

| **ATTRIBUTES** |
| --- |
| solicitudRRHH : SolicitudRRHH  Private  Solicitud de RRHH a la que pertenece el campo resumen. Es una FK a la tabla SolicitudRRHH |
| lang : String  Private  Idioma en el que está expresado el valor del campo resumen de una solicitud de tipo RRHH. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo resumen de la solicitud de RRHH. Está expresado en el idioma indicado por el campo lang. |
...
#### Entidad Observaciones del trabajo de una solicitud de RRHH: "SolicitudRRHHObservaciones"

Entidad para almacenar, en cada uno de los idiomas soportados por la aplicación, el valor del campo "observaciones" de una solicitud de tipo RRHH. Son las observaciones relativas al trabajo con el que se opta a la solicitud de RRHH. El campo está disponible en el apartado Memoria del menú Datos RRHH de una solicitud. Su valor se introduce a través de un campo de texto libre y es un campo obligatorio.

| **ATTRIBUTES** |
| --- |
| solicitudRRHH : SolicitudRRHH  Private  Solicitud de RRHH a la que pertenece el campo observaciones. Es una FK a la tabla SolicitudRRHH |
| lang : String  Private  Idioma en el que está expresado el valor del campo observaciones de una solicitud de tipo RRHH. Es un código de 2 caracteres:   * es * en * eu |
| value\_ : String  Private  Valor del campo observaciones de la solicitud de RRHH. Está expresado en el idioma indicado por el campo lang. |
...
#### Entidad Categorías de convocatoria para una solicitud de RRHH: "SolicitudRRRHHRequisitoCategoria"
...
| --- |
| id : Long  Private  Identificador único de la tabla. Secuencia. Clave primaria. |
| solicitudRRHH : SolicitudRRHH  Private  Solicitud de RRHH a la que pertenece el registro. Es una FK a la tabla Solicitud RRHH. |
| requisitoIPCategoria : RequisitoIPCategoria  Private  Identificador del requisito de categoría que debe cumplir la persona solicitante de acuerdo a la configuración establecida en la convocatoria. Es una FK a la tabla "requisito IP categoría" incluida en el modelo lógico CSP Convocatoria. |
| documentoRef : String  Private  Identificador o referencia del documento físico en el repositorio o sistema de almacenamiento propio o con el que se integre el SGI. |
...
| id : Long  Private  Identificador único de la tabla. Secuencia. Clave primaria. |
| solicitudRRHH : SolicitudRRHH  Private  Solicitud de RRHH a la que pertenece el registro. Es una FK a la tabla Solicitud RRHH. |
| requisitoIPNivelAcademico : RequisitoIPNivelAcademico  Private  Identificador del requisito de nivel académico que debe cumplir la persona solicitante de acuerdo a la configuración establecida en la convocatoria. Es una FK a la tabla "requisito IP nivel académico" incluida en el modelo lógico CSP Convocatoria. |
| documentoRef : String  Private  Identificador o referencia del documento físico en el repositorio o sistema de almacenamiento propio o con el que se integre el SGI. |
...
| id : Long  Private  Identificador único de la tabla. Secuencia. Clave primaria. |
| solicitud : Solicitud  Private  Solicitud a la que pertenece el registro. Es una FK a la tabla Solicitud. |
| nombre : String  Private  Nombre de la persona solicitante (externa). |
| apellidos : String  Private  Apellidos de la persona solicitante (externa). |
| tipoDocumentoRef : String  Private  Tipo de documento de identificación personal bajo el que se especifica el número de documento en el formulario de solicitud. Los tipos de documento de identificación personal se recogen a través de integración con el sistema de gestión corporativo. Es una referencia a la tabla Tipo documento incluida en el modelo lógico ESB SGP |
| numeroDocumento : String  Private  Número de documento de identificación personal de la persona solicitante (externa). |
| sexoRef : String  Private  Sexo de la persona solicitante (externa). El listado de sexos disponible será proporcionado a través de integración con el sistema de gestión de personas. Es una referencia al identificador correspondiente en el sistema de gestión de personas. |
| fechaNacimiento : TimeStamp  Private  Fecha de nacimiento de la persona solicitante (externa). |
| paisNacimientoRef : String  Private  País de nacimiento de la persona solicitante (externa). El listado de países disponible será proporcionado a través de integración con el sistema de gestión de personas. Es una referencia al identificador correspondiente en el sistema de gestión de personas. |
| telefono : String  Private  Campo que recoge el teléfono de contacto de la persona solicitante (externa). |
| email : String  Private  Dirección de emial de la persona solicitante (externa). |
| direccion : String  Private  Dirección postal de la persona solicitante (externa). |
| paisContactoRef : String  Private  País de contacto de la persona solicitante (externa). El listado de países disponible será proporcionado a través de integración con el sistema de gestión de personas. Es una referencia al identificador correspondiente en el sistema de gestión de personas. |
| comAutonomaRef : String  Private  Comunidad autónoma de la persona solicitante (externa). El listado de países disponible será proporcionado a través de integración con el sistema de gestión de personas. Es una referencia al identificador correspondiente en el sistema de gestión de personas. |
| provinciaRef : String  Private  Provincia de la persona solicitante (externa). El listado de provincias disponible será proporcionado a través de integración con el sistema de gestión de personas. Es una referencia al identificador correspondiente en el sistema de gestión de personas. |
| ciudad : String  Private  Ciudad de la persona solicitante (externa). |
| codigoPostal : String  Private  Código postal de la persona solicitante (externa). |
...
| ATTRIBUTES |
| --- |
| id : long  Private  Identificador único de la tabla. Clave primaria. Es el UUID generado como identificador único de la solicitud creada desde el acceso público (usuario/a externo/a). |
| solicitud : Solicitud  Private  Solicitud con la que se corresponde el UUID. Es una FK a la tabla Solicitud. |
