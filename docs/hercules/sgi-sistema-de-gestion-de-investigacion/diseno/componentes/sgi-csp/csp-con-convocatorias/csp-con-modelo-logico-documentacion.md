# CSP-CON - Modelo lógico - Documentación

* [Entidad Convocatoria](#CSPCONModelológicoDocumentación-EntidadConvocatoria)
* [Entidad Listados de áreas temáticas: "AreaTematica"](#CSPCONModelológicoDocumentación-EntidadListadosdeáreastemáticas:"AreaTematica")
* [Entidad Conceptos de gasto de investigación: "ConceptoGasto"](#CSPCONModelológicoDocumentación-EntidadConceptosdegastodeinvestigación:"ConceptoGasto")
* [Entidad Configuración de solicitudes de una convocatoria: "ConfiguracionSolicitud"](#CSPCONModelológicoDocumentación-EntidadConfiguracióndesolicitudesdeunaconvocatoria:"ConfiguracionSolicitud")
* [Entidad Áreas temáticas de una convocatoria: "ConvocatoriaAreaTematica"](#CSPCONModelológicoDocumentación-EntidadÁreastemáticasdeunaconvocatoria:"ConvocatoriaAreaTematica")
* [Entidad Conceptos de gasto de una convocatoria: "ConvocatoriaConceptoGasto"](#CSPCONModelológicoDocumentación-EntidadConceptosdegastodeunaconvocatoria:"ConvocatoriaConceptoGasto")
* [Entidad Correspondencia entre códigos económicos del SGE y conceptos de gasto para una convocatoria: "ConvocatoriaConceptoGastoCodigoEc"](#CSPCONModelológicoDocumentación-EntidadCorrespondenciaentrecódigoseconómicosdelSGEyconceptosdegastoparaunaconvocatoria:"ConvocatoriaConceptoGastoCodigoEc")
* [Entidad Documentos de una convocatoria: "ConvocatoriaDocumento"](#CSPCONModelológicoDocumentación-EntidadDocumentosdeunaconvocatoria:"ConvocatoriaDocumento")
* [Entidad Enlaces de una convocatoria: "ConvocatoriaEnlace"](#CSPCONModelológicoDocumentación-EntidadEnlacesdeunaconvocatoria:"ConvocatoriaEnlace")
* [Entidad Entidades convocantes de una convocatoria: "ConvocatoriaEntidadConvocante"](#CSPCONModelológicoDocumentación-EntidadEntidadesconvocantesdeunaconvocatoria:"ConvocatoriaEntidadConvocante")
* [Entidad Entidades financiadoras de una convocatoria: "ConvocatoriaEntidadFinanciadora"](#CSPCONModelológicoDocumentación-EntidadEntidadesfinanciadorasdeunaconvocatoria:"ConvocatoriaEntidadFinanciadora")
* [Entidad Entidad gestora de una convocatoria: "ConvocatoriaEntidadGestora"](#CSPCONModelológicoDocumentación-EntidadEntidadgestoradeunaconvocatoria:"ConvocatoriaEntidadGestora")
* [Entidad Fases de una convocatoria: "ConvocatoriaFase"](#CSPCONModelológicoDocumentación-EntidadFasesdeunaconvocatoria:"ConvocatoriaFase")
* [Entidad Hitos de una convocatoria: "ConvocatoriaHito"](#CSPCONModelológicoDocumentación-EntidadHitosdeunaconvocatoria:"ConvocatoriaHito")
* [Entidad Avisos de un hito de convocatoria: "ConvocatoriaHitoAviso"](#CSPCONModelológicoDocumentación-EntidadAvisosdeunhitodeconvocatoria:"ConvocatoriaHitoAviso")
* [Entidad Partidas presupuestarias de una convocatoria: "ConvocatoriaPartida"](#CSPCONModelológicoDocumentación-EntidadPartidaspresupuestariasdeunaconvocatoria:"ConvocatoriaPartida")
* [Entidad Calendario de periodos de justificación de una convocatoria: "ConvocatoriaPeriodoJustificacion"](#CSPCONModelológicoDocumentación-EntidadCalendariodeperiodosdejustificacióndeunaconvocatoria:"ConvocatoriaPeriodoJustificacion")
* [Entidad Calendario de periodos de seguimiento científico de una convocatoria: "ConvocatoriaPeriodoSeguimientoCientifico"](#CSPCONModelológicoDocumentación-EntidadCalendariodeperiodosdeseguimientocientíficodeunaconvocatoria:"ConvocatoriaPeriodoSeguimientoCientifico")
* [Entidad Configuración de documentos requeridos en las solicitudes de una convocatoria: "DocumentoRequeridoSolicitud"](#CSPCONModelológicoDocumentación-EntidadConfiguracióndedocumentosrequeridosenlassolicitudesdeunaconvocatoria:"DocumentoRequeridoSolicitud")
* [Entidad Fuentes de financiación: "FuenteFinanciacion"](#CSPCONModelológicoDocumentación-EntidadFuentesdefinanciación:"FuenteFinanciacion")
* [Entidad Planes o programas de investigación: "programa"](#CSPCONModelológicoDocumentación-EntidadPlanesoprogramasdeinvestigación:"programa")
* [Entidad Requisitos de convocatoria para los miembros de equipo: "RequisitoEquipo"](#CSPCONModelológicoDocumentación-EntidadRequisitosdeconvocatoriaparalosmiembrosdeequipo:"RequisitoEquipo")
* [Entidad Categorías en convocatoria para los miembros de equipo: "RequisitoEquipoCategoria"](#CSPCONModelológicoDocumentación-EntidadCategoríasenconvocatoriaparalosmiembrosdeequipo:"RequisitoEquipoCategoria")
* [Entidad Niveles académicos en convocatoria para los miembros de equipo: "RequisitoEquipoNivelAcademico"](#CSPCONModelológicoDocumentación-EntidadNivelesacadémicosenconvocatoriaparalosmiembrosdeequipo:"RequisitoEquipoNivelAcademico")
* [Entidad Requisitos de convocatoria para el rol IP: "RequisitoIP"](#CSPCONModelológicoDocumentación-EntidadRequisitosdeconvocatoriaparaelrolIP:"RequisitoIP")
* [Entidad Categorías en convocatoria para el rol IP: "RequisitoIPCategoria"](#CSPCONModelológicoDocumentación-EntidadCategoríasenconvocatoriaparaelrolIP:"RequisitoIPCategoria")
* [Entidad Nivel académico en convocatoria para el rol IP: "RequisitoIPNivelAcademico"](#CSPCONModelológicoDocumentación-EntidadNivelacadémicoenconvocatoriaparaelrolIP:"RequisitoIPNivelAcademico")
* [Entidad Listado de ámbitos geográfico: "TipoAmbitoGeografico"](#CSPCONModelológicoDocumentación-EntidadListadodeámbitosgeográfico:"TipoAmbitoGeografico")
* [Entidad Tipos de financiación: "TipoFinanciación"](#CSPCONModelológicoDocumentación-EntidadTiposdefinanciación:"TipoFinanciación")
* [Entidad Tipos de origen para una fuente de financiación: "TipoOrigenFuenteFinanciacion"](#CSPCONModelológicoDocumentación-EntidadTiposdeorigenparaunafuentedefinanciación:"TipoOrigenFuenteFinanciacion")
* [Entidad Tipos de régimen de concurrencia: "TipoRegimenConcurrencia"](#CSPCONModelológicoDocumentación-EntidadTiposderégimendeconcurrencia:"TipoRegimenConcurrencia")
* [Entidad Palabras clave de una convocatoria: "ConvocatoriaPalabraClave"](#CSPCONModelológicoDocumentación-EntidadPalabrasclavedeunaconvocatoria:"ConvocatoriaPalabraClave")
* [Entidad Configuración: "Configuracion"](#CSPCONModelológicoDocumentación-EntidadConfiguración:"Configuracion")
* [Enumerados del modelo CSP Convocatoria](#CSPCONModelológicoDocumentación-EnumeradosdelmodeloCSPConvocatoria)
  + [Enumerado Clasificación de items para CVN: "ClasificacionCVN"](#CSPCONModelológicoDocumentación-EnumeradoClasificacióndeitemsparaCVN:"ClasificacionCVN")
  + [Enumerado Tipo estado de convocatoria: "TipoEstadoConvocatoria"](#CSPCONModelológicoDocumentación-EnumeradoTipoestadodeconvocatoria:"TipoEstadoConvocatoria")
  + [Enumerado Tipo formulario de solicitud: "TipoFormularioSolicitud"](#CSPCONModelológicoDocumentación-EnumeradoTipoformulariodesolicitud:"TipoFormularioSolicitud")
  + [Enumerado Tipo de periodo de justificación: "TipoJustificacion"](#CSPCONModelológicoDocumentación-EnumeradoTipodeperiododejustificación:"TipoJustificacion")
  + [Enumerado Tipo de partida presupuestaria: "TipoPartida"](#CSPCONModelológicoDocumentación-EnumeradoTipodepartidapresupuestaria:"TipoPartida")
  + [Enumerado Tipo de periodo de seguimiento científico:"TipoSeguimiento"](#CSPCONModelológicoDocumentación-EnumeradoTipodeperiododeseguimientocientífico:"TipoSeguimiento")
