# CSP-CON - Servicios API

---

* [TipoAmbitoGeografico](#CSPCONServiciosAPI-TipoAmbitoGeografico)
* [TipoOrigenFuenteFinanciacion](#CSPCONServiciosAPI-TipoOrigenFuenteFinanciacion)
* [FuenteFinanciacion](#CSPCONServiciosAPI-FuenteFinanciacion)
* [TipoFinanciacion](#CSPCONServiciosAPI-TipoFinanciacion)
* [TipoRegimenConcurrencia](#CSPCONServiciosAPI-TipoRegimenConcurrencia)
* [ConvocatoriaEntidadGestora](#CSPCONServiciosAPI-ConvocatoriaEntidadGestora)
* [ConceptoGasto](#CSPCONServiciosAPI-ConceptoGasto)
* [Programa](#CSPCONServiciosAPI-Programa)
* [AreaTematica](#CSPCONServiciosAPI-AreaTematica)
* [ConvocatoriaAreaTematica](#CSPCONServiciosAPI-ConvocatoriaAreaTematica)
* [ConvocatoriaEntidadConvocante](#CSPCONServiciosAPI-ConvocatoriaEntidadConvocante)
* [ConvocatoriaEntidadFinanciadora](#CSPCONServiciosAPI-ConvocatoriaEntidadFinanciadora)
* [ConvocatoriaEnlace](#CSPCONServiciosAPI-ConvocatoriaEnlace)
* [ConvocatoriaFase](#CSPCONServiciosAPI-ConvocatoriaFase)
* [ConvocatoriaPeriodoJustificacion](#CSPCONServiciosAPI-ConvocatoriaPeriodoJustificacion)
* [ConvocatoriaPeriodoSeguimientoCientifico](#CSPCONServiciosAPI-ConvocatoriaPeriodoSeguimientoCientifico)
* [ConvocatoriaHito](#CSPCONServiciosAPI-ConvocatoriaHito)
* [ConvocatoriaDocumento](#CSPCONServiciosAPI-ConvocatoriaDocumento)
* [RequisitoIp](#CSPCONServiciosAPI-RequisitoIp)
* [RequisitoEquipo](#CSPCONServiciosAPI-RequisitoEquipo)
* [ConvocatoriaConceptoGasto](#CSPCONServiciosAPI-ConvocatoriaConceptoGasto)
* [ConvocatoriaConceptoGastoCodigoEc](#CSPCONServiciosAPI-ConvocatoriaConceptoGastoCodigoEc)
* [DocumentoRequeridoSolicitud](#CSPCONServiciosAPI-DocumentoRequeridoSolicitud)
* [ConfiguracionSolicitud](#CSPCONServiciosAPI-ConfiguracionSolicitud)
* [Convocatoria](#CSPCONServiciosAPI-Convocatoria)
...
| Método | URL | Parámetros | Respuesta | Permisos | Descripción |
| --- | --- | --- | --- | --- | --- |
| GET | /tipoorigenfuentefinanciaciones | q + s | Lista[TipoOrigenFuenteFinanciacion] | CSP-TFF-E CSP-TFF-C | Listado de TipoOrigenFuenteFinanciacion (sólo devuelve los activos) |
