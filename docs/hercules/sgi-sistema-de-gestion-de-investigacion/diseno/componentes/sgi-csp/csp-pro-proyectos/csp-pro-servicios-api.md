# CSP-PRO - Servicios API

* [Proyecto](#CSPPROServiciosAPI-Proyecto)
* [ProyectoEntidadFinanciadora](#CSPPROServiciosAPI-ProyectoEntidadFinanciadora)
* [ProyectoEntidadGestora](#CSPPROServiciosAPI-ProyectoEntidadGestora)
* [ProyectoFase](#CSPPROServiciosAPI-ProyectoFase)
* [ProyectoHito](#CSPPROServiciosAPI-ProyectoHito)
* [ProyectoPaqueteTrabajo](#CSPPROServiciosAPI-ProyectoPaqueteTrabajo)
* [ProyectoProrroga](#CSPPROServiciosAPI-ProyectoProrroga)
* [ProrrogaDocumento](#CSPPROServiciosAPI-ProrrogaDocumento)
* [ProyectoSocio](#CSPPROServiciosAPI-ProyectoSocio)
* [ProyectoSocioEquipo](#CSPPROServiciosAPI-ProyectoSocioEquipo)
* [ProyectoSocioPeriodoPago](#CSPPROServiciosAPI-ProyectoSocioPeriodoPago)
* [ProyectoPeriodoSeguimiento](#CSPPROServiciosAPI-ProyectoPeriodoSeguimiento)
* [ProyectoSocioPeriodoJustificacion](#CSPPROServiciosAPI-ProyectoSocioPeriodoJustificacion)
* [SocioPeriodoJustificacionDocumento](#CSPPROServiciosAPI-SocioPeriodoJustificacionDocumento)
* [Integración CVN](#CSPPROServiciosAPI-IntegraciónCVN)
...
| GET | /proyectos/{id}/entidadconvocantes/{entidadConvocanteId} | * id: identificador del Proyecto * entidadConvocanteId: identificador del ProyectoEntidadConvocanteDto | ProyectoEntidadConvocante | CSP-PRO-C CSP-PRO-E | Devuelve el ProyectoEntidadConvocanteDto con el entidadConvocanteId indicado |
