# CSP-PPEX - Modelo lógico - Documentación

### * [Entidades del modelo Participación en proyectos externos](#CSPPPEXModelológicoDocumentación-EntidadesdelmodeloParticipaciónenproyectosexternos) + [Entidad Solicitud de autorización de participación en proyecto externo: "autorizacion"](#CSPPPEXModelológicoDocumentación-EntidadSolicituddeautorizacióndeparticipaciónenproyectoexterno:"autorizacion") + [Entidad Certificados de autorización una solicitud de participación en proyecto externo: "CcertificadoAutorización"](#CSPPPEXModelológicoDocumentación-EntidadCertificadosdeautorizaciónunasolicituddeparticipaciónenproyectoexterno:"CcertificadoAutorización") + [Entidad Estados de una autorización: "EstadoAutorizacion"](#CSPPPEXModelológicoDocumentación-EntidadEstadosdeunaautorización:"EstadoAutorizacion") + [Entidad Notificación de registro de proyecto/contrato de CVN: "NotificacionProyectoExternoCVN"](#CSPPPEXModelológicoDocumentación-EntidadNotificaciónderegistrodeproyecto/contratodeCVN:"NotificacionProyectoExternoCVN") + [Entidad Entidades financiadoras del proyecto/contrato registrado en CVN: "NotificaciónCVNEntidadFinanciadora"](#CSPPPEXModelológicoDocumentación-EntidadEntidadesfinanciadorasdelproyecto/contratoregistradoenCVN:"NotificaciónCVNEntidadFinanciadora") * [Enumerados del modelo Participación en proyectos externos](#CSPPPEXModelológicoDocumentación-EnumeradosdelmodeloParticipaciónenproyectosexternos) + [Enumerado Estado de solicitud de autorización de participación en proyecto externo: "TipoEstadoAutorizacion"](#CSPPPEXModelológicoDocumentación-EnumeradoEstadodesolicituddeautorizacióndeparticipaciónenproyectoexterno:"TipoEstadoAutorizacion")
...
| tituloProyecto : String  Private  Título del proyecto externo para el se solicita autorización de participación. |
...
| observaciones : String  Private  Campo de texto libre para recoger cualquier observación que aplique sobre la solicitud de participación en proyecto externo. |
...
| documentoRef : String  Private  Referencia al fichero físico que contiene el documento de certificado. Es un identificador del sistema de archivos o sistesma de gestión documental a través del que SGI implementa la gestión de documentos (según implantación). |
| nombre : String  Private  Nombre del documento. |
...
| comentario : String  Private  Campo de texto libre para recoger cualquier comentario relativo al estado de la solicitud de participación en proyecto externo. |
