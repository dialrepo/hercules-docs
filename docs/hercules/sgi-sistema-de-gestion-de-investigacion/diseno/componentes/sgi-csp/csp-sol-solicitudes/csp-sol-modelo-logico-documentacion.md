# CSP-SOL - Módelo lógico - Documentación

* [Entidades del modelo de solicitud genérica](#CSPSOLMódelológicoDocumentación-Entidadesdelmodelodesolicitudgenérica)
  + [Entidad Solicitud](#CSPSOLMódelológicoDocumentación-EntidadSolicitud)
  + [Entidad Histórico de estados de una solicitud: "EstadoSolicitud"](#CSPSOLMódelológicoDocumentación-EntidadHistóricodeestadosdeunasolicitud:"EstadoSolicitud")
  + [Entidad Documentos de una solicitud: "SolicitudDocumento"](#CSPSOLMódelológicoDocumentación-EntidadDocumentosdeunasolicitud:"SolicitudDocumento")
  + [Entidad Hitos de una solicitud: "SolicitudHito"](#CSPSOLMódelológicoDocumentación-EntidadHitosdeunasolicitud:"SolicitudHito")
  + [Entidad Avisos para un hito de solicitud: "SolicitudHitoAviso"](#CSPSOLMódelológicoDocumentación-EntidadAvisosparaunhitodesolicitud:"SolicitudHitoAviso")
  + [Entidad Modalidad de una solicitud: "SolicitudModalidad"](#CSPSOLMódelológicoDocumentación-EntidadModalidaddeunasolicitud:"SolicitudModalidad")
  + [Entidad Palabras clave de una solicitud: "SolicitudPalabraClave"](#CSPSOLMódelológicoDocumentación-EntidadPalabrasclavedeunasolicitud:"SolicitudPalabraClave")
* [Enumerados del modelo de solicitud genérica](#CSPSOLMódelológicoDocumentación-Enumeradosdelmodelodesolicitudgenérica)
  + [Enumerado Listado de estados de solicitud: "TipoEstadoSolicitud"](#CSPSOLMódelológicoDocumentación-EnumeradoListadodeestadosdesolicitud:"TipoEstadoSolicitud")
* [Entidades del modelo Solicitudes de tipo proyecto](#CSPSOLMódelológicoDocumentación-EntidadesdelmodeloSolicitudesdetipoproyecto)
  + [Entidad Solicitud de tipo proyecto: "solicitudProyecto"](#CSPSOLMódelológicoDocumentación-EntidadSolicituddetipoproyecto:"solicitudProyecto")
  + [Entidad Roles de miembro de equipo: "RolProyecto"](#CSPSOLMódelológicoDocumentación-EntidadRolesdemiembrodeequipo:"RolProyecto")
  + [Entidad Colectivos para un rol de equipo: "RolProyectoColectivo"](#CSPSOLMódelológicoDocumentación-EntidadColectivosparaunroldeequipo:"RolProyectoColectivo")
  + [Entidad Roles de socio de proyecto: "RolSocio"](#CSPSOLMódelológicoDocumentación-EntidadRolesdesociodeproyecto:"RolSocio")
  + [Entidad Áreas de conocimiento de una solicitud de proyecto: "SolicitudProyectoArea"](#CSPSOLMódelológicoDocumentación-EntidadÁreasdeconocimientodeunasolicituddeproyecto:"SolicitudProyectoArea")
  + [Entidad Clasificaciones de una solicitud de proyecto: "SolicitudProyectoClasificacion"](#CSPSOLMódelológicoDocumentación-EntidadClasificacionesdeunasolicituddeproyecto:"SolicitudProyectoClasificacion")
  + [Entidad Entidades financiadoras de una solicitud de proyecto: "SolicitudProyectoEntidad"](#CSPSOLMódelológicoDocumentación-EntidadEntidadesfinanciadorasdeunasolicituddeproyecto:"SolicitudProyectoEntidad")
  + [Entidad Entidad financiadoras de una ajenas a la convocatoria de una solicitud de proyecto: "SolicitudProyectoEntidadFinanciadoraAjena"](#CSPSOLMódelológicoDocumentación-EntidadEntidadfinanciadorasdeunaajenasalaconvocatoriadeunasolicituddeproyecto:"SolicitudProyectoEntidadFinanciadoraAjena")
  + [Entidad Miembros de equipo de una solicitud de proyecto: "SolicitudProyectoEquipo"](#CSPSOLMódelológicoDocumentación-EntidadMiembrosdeequipodeunasolicituddeproyecto:"SolicitudProyectoEquipo")
  + [Entidad Miembros de equipo de un socio para una solicitud de proyecto: "SolicitudProyectoEquipoSocio"](#CSPSOLMódelológicoDocumentación-EntidadMiembrosdeequipodeunsocioparaunasolicituddeproyecto:"SolicitudProyectoEquipoSocio")
  + [Entidad Periodos de justificación de un socio para una solicitud de proyecto: "SolicitudProyectoPeriodoJustificacion"](#CSPSOLMódelológicoDocumentación-EntidadPeriodosdejustificacióndeunsocioparaunasolicituddeproyecto:"SolicitudProyectoPeriodoJustificacion")
  + [Entidad Periodos de pago de un socio para una solicitud de proyecto: "SolicitudProyectoPeriodoPago"](#CSPSOLMódelológicoDocumentación-EntidadPeriodosdepagodeunsocioparaunasolicituddeproyecto:"SolicitudProyectoPeriodoPago")
  + [Entidad Presupuesto para una solicitud de proyecto: "SolicitudProyectoPresupuesto"](#CSPSOLMódelológicoDocumentación-EntidadPresupuestoparaunasolicituddeproyecto:"SolicitudProyectoPresupuesto")
  + [Entidad Responsable económico para una solicitud de proyecto: "SolicitudProyectoResponsableEconomico"](#CSPSOLMódelológicoDocumentación-EntidadResponsableeconómicoparaunasolicituddeproyecto:"SolicitudProyectoResponsableEconomico")
  + [Entidad Socios para una solicitud de proyecto: "SolicitudProyectoSocio"](#CSPSOLMódelológicoDocumentación-EntidadSociosparaunasolicituddeproyecto:"SolicitudProyectoSocio")
* [Enumerado del modelo solicitudes tipo proyecto](#CSPSOLMódelológicoDocumentación-Enumeradodelmodelosolicitudestipoproyecto)
  + [Enumerado Tipos de equipo: "TipoEquipoProyecto"](#CSPSOLMódelológicoDocumentación-EnumeradoTiposdeequipo:"TipoEquipoProyecto")
  + [Enumerado Tipos de orden para un rol de equipo: "TipoOrden"](#CSPSOLMódelológicoDocumentación-EnumeradoTiposdeordenparaunroldeequipo:"TipoOrden")
  + [Enumerado Tipos de presupuesto para una solicitud: "TipoPresupuesto"](#CSPSOLMódelológicoDocumentación-EnumeradoTiposdepresupuestoparaunasolicitud:"TipoPresupuesto")
* [Entidades del modelo de solicitudes de tipo grupo](#CSPSOLMódelológicoDocumentación-Entidadesdelmodelodesolicitudesdetipogrupo)
  + [Entidad Solicitud de tipo grupo: "SolicitudGrupo"](#CSPSOLMódelológicoDocumentación-EntidadSolicituddetipogrupo:"SolicitudGrupo")
* [Enumerados del modelo de solicitudes de tipo grupo](#CSPSOLMódelológicoDocumentación-Enumeradosdelmodelodesolicitudesdetipogrupo)
  + [Enumerado Tipos de solicitudes de grupo: "TipoSolicitudGrupo"](#CSPSOLMódelológicoDocumentación-EnumeradoTiposdesolicitudesdegrupo:"TipoSolicitudGrupo")
* [Entidades del modelo de solicitudes de tipo RRHH](#CSPSOLMódelológicoDocumentación-EntidadesdelmodelodesolicitudesdetipoRRHH)
  + [Entidad Solicitud de tipo RRHH: "SolicitudRRRHH"](#CSPSOLMódelológicoDocumentación-EntidadSolicituddetipoRRHH:"SolicitudRRRHH")
  + [Entidad Categorías de convocatoria para una solicitud de RRHH: "SolicitudRRRHHRequisitoCategoría"](#CSPSOLMódelológicoDocumentación-EntidadCategoríasdeconvocatoriaparaunasolicituddeRRHH:"SolicitudRRRHHRequisitoCategoría")
  + [Entidad Niveles académicos de convocatoria para una solicitud de RRHH: "SolicitudRRRHHRequisitoNivelAcadémico"](#CSPSOLMódelológicoDocumentación-EntidadNivelesacadémicosdeconvocatoriaparaunasolicituddeRRHH:"SolicitudRRRHHRequisitoNivelAcadémico")
  + [Entidad Solicitante externo para una solicitud: "SolicitanteExterno"](#CSPSOLMódelológicoDocumentación-EntidadSolicitanteexternoparaunasolicitud:"SolicitanteExterno")
  + [Entidad solicitud externa: "SolicitudExterna"](#CSPSOLMódelológicoDocumentación-Entidadsolicitudexterna:"SolicitudExterna")
...
| tituloTrabajo : String  Private  Título del trabajo con el que se opta a la solicitud. Este campo está incluido en el apartado Memoria del interface gráfico. |
| resumen : String  Private  Campo de texto para recoger el resumen del trabajo con el que se opta a la solicitud (incluido en el apartado memoria del interface gráfico). |
| observaciones : String  Private  Campo de texto libre para incluir cualquier observación sobre el trabajo propuesto en la solicitud (incluido en el apartado memoria del interface gráfico). |
