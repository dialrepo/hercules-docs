...
* [CSP Grupo](#CSPGINModelológicoDocumentación-CSPGrupo)
  + [Modelo lógico CSP Grupo](#CSPGINModelológicoDocumentación-ModelológicoCSPGrupo)
* [Entidades del modelo CSP Grupo](#CSPGINModelológicoDocumentación-EntidadesdelmodeloCSPGrupo)
  + [Entidad grupo: "grupo"](#CSPGINModelológicoDocumentación-Entidadgrupo:"grupo")
  + [Entidad enlaces del grupo: "GrupoEnlace"](#CSPGINModelológicoDocumentación-Entidadenlacesdelgrupo:"GrupoEnlace")
  + [Entidad equipo del grupo "GrupoEquipo"](#CSPGINModelológicoDocumentación-Entidadequipodelgrupo"GrupoEquipo")
  + [Entidad equipo instrumental del grupo: "GrupoEquipoInstrumental"](#CSPGINModelológicoDocumentación-Entidadequipoinstrumentaldelgrupo:"GrupoEquipoInstrumental")
  + [Entidad histórico grupo especial: "GrupoEspecialInvestigacion"](#CSPGINModelológicoDocumentación-Entidadhistóricogrupoespecial:"GrupoEspecialInvestigacion")
  + [Entidad clasificación de las líneas de investigación del grupo: "GrupoLineaClasificacion"](#CSPGINModelológicoDocumentación-Entidadclasificacióndelaslíneasdeinvestigacióndelgrupo:"GrupoLineaClasificacion")
  + [Entidad línea de investigación del equipo instrumental del grupo: "GrupoLineaEquipoInstrumental"](#CSPGINModelológicoDocumentación-Entidadlíneadeinvestigacióndelequipoinstrumentaldelgrupo:"GrupoLineaEquipoInstrumental")
  + [Entidad línea de investigación del grupo: "GrupoLineaInvestigacion"](#CSPGINModelológicoDocumentación-Entidadlíneadeinvestigacióndelgrupo:"GrupoLineaInvestigacion")
  + [Entidad línea de investigación de los miembros del grupo: "GrupoLineaInvestigador"](#CSPGINModelológicoDocumentación-Entidadlíneadeinvestigacióndelosmiembrosdelgrupo:"GrupoLineaInvestigador")
  + [Entidad palabras clave del grupo: "GrupoPalabraClave"](#CSPGINModelológicoDocumentación-Entidadpalabrasclavedelgrupo:"GrupoPalabraClave")
  + [Entidad persona autorizada del grupo: "GrupoPersonaAutorizada"](#CSPGINModelológicoDocumentación-Entidadpersonaautorizadadelgrupo:"GrupoPersonaAutorizada")
  + [Entidad responsable económico del grupo: "GrupoResponsableEconomico"](#CSPGINModelológicoDocumentación-Entidadresponsableeconómicodelgrupo:"GrupoResponsableEconomico")
  + [Entidad histórico de tipos del grupo: "GrupoTipo"](#CSPGINModelológicoDocumentación-Entidadhistóricodetiposdelgrupo:"GrupoTipo")
  + [Entidad línea de investigación: LineaInvestigacion](#CSPGINModelológicoDocumentación-Entidadlíneadeinvestigación:LineaInvestigacion)
* [Enumerados del modelo CSP Grupo](#CSPGINModelológicoDocumentación-EnumeradosdelmodeloCSPGrupo)
  + [Enumerado tipo de dedicación: "Dedicacion"](#CSPGINModelológicoDocumentación-Enumeradotipodededicación:"Dedicacion")
  + [Enumerado tipo de grupo: "TipoGrupo"](#CSPGINModelológicoDocumentación-Enumeradotipodegrupo:"TipoGrupo")
...
| nombre : String Private  Es el nombre por el que se conoce al grupo de investigación. Es un campo obligatorio. |
...
| nombre : String Private  Nombre del equipo instrumental. Es un campo obligatorio. |
| descripcion : String Private  Descripción larga del equipo instrumental, para que sirve, que se puede hacer con él, etc. |
...
| **ATTRIBUTES** |
| id : Long Private  Identificador único del registro. Secuencia. Clave primaria. |
| nombre : String Private  Nombre o descripción de la línea de investigación. Es un campo obligatorio. |
