...
* [Invenciones](#PIIServiciosAPI-Invenciones)
* [Sectores de Aplicación](#PIIServiciosAPI-SectoresdeAplicación)
* [Tramos de Reparto](#PIIServiciosAPI-TramosdeReparto)
* [Tipos de Procedimiento](#PIIServiciosAPI-TiposdeProcedimiento)
* [Vías de Protección](#PIIServiciosAPI-VíasdeProtección)
* [Invención Documento](#PIIServiciosAPI-InvenciónDocumento)
* [Solicitudes de Protección](#PIIServiciosAPI-SolicitudesdeProtección)
* [Informe Patentabilidad](#PIIServiciosAPI-InformePatentabilidad)
* [Invención Inventores](#PIIServiciosAPI-InvenciónInventores)
* [Resultado Informe de Patentabilidad](#PIIServiciosAPI-ResultadoInformedePatentabilidad)
* [Tipos de Protección](#PIIServiciosAPI-TiposdeProtección)
* [Invención Gastos](#PIIServiciosAPI-InvenciónGastos)
