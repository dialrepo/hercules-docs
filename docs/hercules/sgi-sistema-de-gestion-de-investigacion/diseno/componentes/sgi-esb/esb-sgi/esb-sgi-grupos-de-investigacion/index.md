# ESB - SGI - Grupos de investigación

---

* [Sistema de Gestión Investigación](#ESBSGIGruposdeinvestigación-SistemadeGestiónInvestigación)
  + [Entidades](#ESBSGIGruposdeinvestigación-Entidades)
  + [Modelo lógico](#ESBSGIGruposdeinvestigación-Modelológico)
  + [API](#ESBSGIGruposdeinvestigación-API)
    - [Definición de los objetos](#ESBSGIGruposdeinvestigación-Definicióndelosobjetos)
      * [Grupo](#ESBSGIGruposdeinvestigación-Grupo)
      * [GrupoEquipo](#ESBSGIGruposdeinvestigación-GrupoEquipo)
      * [RolProyecto](#ESBSGIGruposdeinvestigación-RolProyecto)
      * [GrupoPalabraClave](#ESBSGIGruposdeinvestigación-GrupoPalabraClave)
      * [GrupoLineaInvestigacion](#ESBSGIGruposdeinvestigación-GrupoLineaInvestigacion)
      * [LineaInvestigacion](#ESBSGIGruposdeinvestigación-LineaInvestigacion)
      * [GrupoLineaClasificacion](#ESBSGIGruposdeinvestigación-GrupoLineaClasificacion)
    - [Servicios](#ESBSGIGruposdeinvestigación-Servicios)
...
[CSP - GIN - Diseño lógico](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-csp/csp-gin-grupos-de-investigacion/csp-gin-diseno-logico-diagrama)
...
| --- | --- | --- | --- | --- | --- |
| [ESB - SGI - Grupos de investigación - Consultar grupos de investigación modificados](/confluence/spaces/HERCULES/pages/597853372/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+Consultar+grupos+de+investigaci%C3%B3n+modificados) | GET | /grupos/modificados-ids | q+s  La query estará formada por:   * fechaModificacion: fecha a partir de la cual se quieren ver los cambios | Lista[String] | Listado de Identificadores de Grupo activos que han sido modificados en los datos generales (tabla GRUPO) o en algunas de las siguientes tablas con las que se relaciona:   * GRUPO\_EQUIPO * GRUPO\_PALABRA\_CLAVE * GRUPO\_ENLACE * GRUPO\_RESPONSABLE\_ECONOMICO * GRUPO\_EQUIPO\_INSTRUMENTAL * GRUPO\_LINEA\_INVESTIGACION * GRUPO\_LINEA\_INVESTIGADOR * GRUPO\_LINEA\_CLASIFICACION   Ejemplo:   * fechaModificacion=ge="2021-08-18T22:00:00Z" |
| [ESB - SGI - Grupos de investigación - Líneas de investigación - Listar clasificaciones](/confluence/spaces/HERCULES/pages/597853375/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+L%C3%ADneas+de+investigaci%C3%B3n+-+Listar+clasificaciones) | GET | /gruposlineasinvestigacion/{id}/clasificaciones |  | Lista[[GrupoLineaClasificacion](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134292538#ESBSGIGruposdeinvestigaci%C3%B3n-GrupoLineaClasificacion)] | Listado de clasificaciones de una línea de investigación dentro de un grupo de investigación. |
| [ESB - SGI - Grupos de investigación - Líneas de investigación - Consultar detalle](/confluence/spaces/HERCULES/pages/597853378/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+L%C3%ADneas+de+investigaci%C3%B3n+-+Consultar+detalle) | GET | /lineasinvestigacion/{id} |  | [LineaInvestigacion](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134292538#ESBSGIGruposdeinvestigaci%C3%B3n-LineaInvestigacion) | Detalle de una línea de investigación. |
| [ESB - SGI - Grupos de investigación - Listar líneas de investigación](/confluence/spaces/HERCULES/pages/597853373/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+Listar+l%C3%ADneas+de+investigaci%C3%B3n) | GET | /grupos/{id}/lineas-investigacion |  | Lista[[GrupoLineaInvestigacion](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134292538#ESBSGIGruposdeinvestigaci%C3%B3n-GrupoLineaInvestigacion)] | Listado de líneas de investigación de un Grupo. |
| [ESB - SGI - Grupos de investigación - Listar palabras clave](/confluence/spaces/HERCULES/pages/597853374/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+Listar+palabras+clave) | GET | /grupos/{id}/palabrasclave |  | Lista[[GrupoPalabraClave](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134292538#ESBSGIGruposdeinvestigaci%C3%B3n-GrupoPalabraClave)] | Listado de palabras clave de un Grupo. |
| [ESB - SGI - Grupos de investigación - Consultar miembros equipo](/confluence/spaces/HERCULES/pages/597853371/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+Consultar+miembros+equipo) | GET | /grupos/{id}/miembrosequipo |  | Lista[[GrupoEquipo](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134292538#ESBSGIGruposdeinvestigaci%C3%B3n-GrupoEquipo)] | Listado de miembros del equipo de un Grupo. |
| [ESB - SGI - Grupos de investigación - Consultar detalle](/confluence/spaces/HERCULES/pages/597853370/ESB+-+SGI+-+Grupos+de+investigaci%C3%B3n+-+Consultar+detalle) | GET | /grupos/{id} |  | [Grupo](https://confluence.um.es/confluence/pages/viewpage.action?pageId=134292538#ESBSGIGruposdeinvestigaci%C3%B3n-Grupo) | Datos generales de un Grupo. |