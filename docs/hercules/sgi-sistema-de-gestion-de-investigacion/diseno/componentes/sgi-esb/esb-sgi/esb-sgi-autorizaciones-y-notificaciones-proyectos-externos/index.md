# ESB - SGI - Autorizaciones y notificaciones Proyectos externos

---

* [Sistema de Gestión Investigación](#ESBSGIAutorizacionesynotificacionesProyectosexternos-SistemadeGestiónInvestigación)
  + [Entidades](#ESBSGIAutorizacionesynotificacionesProyectosexternos-Entidades)
  + [Modelo lógico](#ESBSGIAutorizacionesynotificacionesProyectosexternos-Modelológico)
  + [API](#ESBSGIAutorizacionesynotificacionesProyectosexternos-API)
    - [Definición de los objetos](#ESBSGIAutorizacionesynotificacionesProyectosexternos-Definicióndelosobjetos)
      * [Autorizacion](#ESBSGIAutorizacionesynotificacionesProyectosexternos-Autorizacion)
      * [NotificacionProyecto](#ESBSGIAutorizacionesynotificacionesProyectosexternos-NotificacionProyecto)
      * [EntidadFinanciadora](#ESBSGIAutorizacionesynotificacionesProyectosexternos-EntidadFinanciadora)
    - [Servicios](#ESBSGIAutorizacionesynotificacionesProyectosexternos-Servicios)
...
| --- | --- | --- | --- | --- | --- |
| [ESB - SGI - Notificaciones Proyectos externos - Dar de alta](/confluence/spaces/HERCULES/pages/597853369/ESB+-+SGI+-+Notificaciones+Proyectos+externos+-+Dar+de+alta) | POST | /notificaciones-proyectos |  | [NotificacionProyecto](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/esb-sgi/esb-sgi-autorizaciones-y-notificaciones-proyectos-externos#ESBSGIAutorizacionesynotificacionesProyectosexternos-NotificacionProyecto) | Recibe como parámetro los campos necesarios para crear un registro en el SGI de un proyecto notificado desde el CVN. |
| [ESB - SGI - Autorizaciones - Consultar detalle](/confluence/spaces/HERCULES/pages/597853366/ESB+-+SGI+-+Autorizaciones+-+Consultar+detalle) | GET | /autorizaciones/{id} |  | [Autorizacion](/hercules/sgi-sistema-de-gestion-de-investigacion/diseno/componentes/sgi-esb/esb-sgi/esb-sgi-autorizaciones-y-notificaciones-proyectos-externos#ESBSGIAutorizacionesynotificacionesProyectosexternos-Autorizacion) | Detalle de la autorización. |
| [ESB - SGI - Autorizaciones - Consultar autorizaciones modificadas](/confluence/spaces/HERCULES/pages/597853367/ESB+-+SGI+-+Autorizaciones+-+Consultar+autorizaciones+modificadas) | GET | /autorizaciones/modificadas-ids | q+s  La query estará formada por:   * fechaModificacion | Lista[String] | Listado de Identificadores de Autorizaciones cuyo estado actual sea "autorizada" y la fecha de dicho estado sea igual o superior a la fecha recibida como parámetro de entrada.  Ejemplo:   * fechaModificacion=ge="2021-08-18T22:00:00Z" |