# Informe enfocado a la solicitud de una acreditación de la ANECA
...
Para entender qué significa cada parámetro del configurador de comisiones se ha realizado un glosario explicando el significado de cada uno de los parámetros que lo componen, el enlace a GitHub es el siguiente: [https://github.com/hercules-rpa/glosario\_parametros\_acreditaciones.json](https://github.com/hercules-rpa/orquestador/blob/main/model/process/glosario_parametros_acreditaciones.json)