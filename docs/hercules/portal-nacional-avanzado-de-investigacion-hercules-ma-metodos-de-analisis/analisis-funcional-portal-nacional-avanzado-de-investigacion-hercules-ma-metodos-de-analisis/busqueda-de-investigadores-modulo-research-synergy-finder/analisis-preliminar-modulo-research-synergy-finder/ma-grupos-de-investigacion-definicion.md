# MA. Grupos de Investigación. Definición

* [Buscador](#MA.GruposdeInvestigación.Definición-Buscador)
  + [Facetas](#MA.GruposdeInvestigación.Definición-Facetas)
  + [Mini ficha](#MA.GruposdeInvestigación.Definición-Minificha)
* [Ficha](#MA.GruposdeInvestigación.Definición-Ficha)
  + [Pestañas](#MA.GruposdeInvestigación.Definición-Pestañas)
    - [Publicaciones](#MA.GruposdeInvestigación.Definición-Publicaciones)
    - [Proyectos](#MA.GruposdeInvestigación.Definición-Proyectos)
    - [Otros resultados (antes ROs)](#MA.GruposdeInvestigación.Definición-Otrosresultados(antesROs))
    - [Miembros](#MA.GruposdeInvestigación.Definición-Miembros)
    - [Áreas temáticas (calculadas de las publicaciones).](#MA.GruposdeInvestigación.Definición-Áreastemáticas(calculadasdelaspublicaciones).)
    - [Colaboraciones](#MA.GruposdeInvestigación.Definición-Colaboraciones)
...
* ### Publicaciones
  ...
  + Facetas y minificha. Las indicadas para el [buscador de publicaciones](https://confluence.um.es/confluence/pages/viewpage.action?pageId=312705247)
  + Gráfica.
...
* ### Proyectos
  ...
  + Facetas y minificha, las indicadas en [buscador proyectos](https://confluence.um.es/confluence/pages/viewpage.action?pageId=312705185)
  + Gráfica
...
* ### Otros resultados (antes ROs)
  ...
  + Facetas (las indicadas para el [buscador de ROs](https://confluence.um.es/confluence/pages/viewpage.action?pageId=319750153)).
  + Minificha (la indicada para el [buscador de ROs](https://confluence.um.es/confluence/pages/viewpage.action?pageId=319750153)).
  + Gráfica
    - ROs por año
    - Citas por año (cuando podamos obtener el dato)
    - La gráfica se actualiza al aplicar una faceta.
...
* ### Colaboraciones
  ...
  + Facetas y minifichas indicadas en el [buscador de Personal investigador](https://confluence.um.es/confluence/pages/viewpage.action?pageId=314671109))
  + Gráfica.
