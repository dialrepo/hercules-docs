# Calendario facturación (UM - SGI - ESB - SGE)

---

* [Ejecución económica](#Calendariofacturación(UMSGIESBSGE)-Ejecucióneconómica)
  + [Entidades](#Calendariofacturación(UMSGIESBSGE)-Entidades)
  + [Modelo lógico](#Calendariofacturación(UMSGIESBSGE)-Modelológico)
    - [Definición de los objetos](#Calendariofacturación(UMSGIESBSGE)-Definicióndelosobjetos)
      * [FacturaEmitida](#Calendariofacturación(UMSGIESBSGE)-FacturaEmitida)
      * [FacturaEmitidaDetalle](#Calendariofacturación(UMSGIESBSGE)-FacturaEmitidaDetalle)
      * [Detalle](#Calendariofacturación(UMSGIESBSGE)-Detalle)
      * [Columna](#Calendariofacturación(UMSGIESBSGE)-Columna)
      * [Documento](#Calendariofacturación(UMSGIESBSGE)-Documento)
      * [FacturaPrevistaEmitida](#Calendariofacturación(UMSGIESBSGE)-FacturaPrevistaEmitida)
    - [Columnas Facturas emitidas](#Calendariofacturación(UMSGIESBSGE)-ColumnasFacturasemitidas)
    - [Campos Factura emitida](#Calendariofacturación(UMSGIESBSGE)-CamposFacturaemitida)
    - [Ejemplos](#Calendariofacturación(UMSGIESBSGE)-Ejemplos)
      * [Columnas Facturas emitidas (/facturas-emitidas/columnas)](#Calendariofacturación(UMSGIESBSGE)-ColumnasFacturasemitidas(/facturas-emitidas/columnas))
      * [Facturas emitidas (/facturas-emitidas)](#Calendariofacturación(UMSGIESBSGE)-Facturasemitidas(/facturas-emitidas))
      * [Detalle factura emitida (/facturas-emitidas/{id})](#Calendariofacturación(UMSGIESBSGE)-Detallefacturaemitida(/facturas-emitidas/{id}))
      * [Consulta facturas previstas de emitir (/facturas-previstas-emitidas)](#Calendariofacturación(UMSGIESBSGE)-Consultafacturasprevistasdeemitir(/facturas-previstas-emitidas))
