# Ejecución económica (UM - SGI - ESB - SGE )

---

* [Ejecución económica](#Ejecucióneconómica(UMSGIESBSGE)-Ejecucióneconómica)
  + [Entidades](#Ejecucióneconómica(UMSGIESBSGE)-Entidades)
  + [Enumerados](#Ejecucióneconómica(UMSGIESBSGE)-Enumerados)
  + [Modelo lógico](#Ejecucióneconómica(UMSGIESBSGE)-Modelológico)
    - [Definición de los objetos](#Ejecucióneconómica(UMSGIESBSGE)-Definicióndelosobjetos)
      * [DatoEconomico](#Ejecucióneconómica(UMSGIESBSGE)-DatoEconomico)
      * [DatoEconomicoDetalle](#Ejecucióneconómica(UMSGIESBSGE)-DatoEconomicoDetalle)
      * [Columna](#Ejecucióneconómica(UMSGIESBSGE)-Columna)
      * [Documento](#Ejecucióneconómica(UMSGIESBSGE)-Documento)
      * [Campo](#Ejecucióneconómica(UMSGIESBSGE)-Campo)
      * [Comentario](#Ejecucióneconómica(UMSGIESBSGE)-Comentario)
      * [ClasificacionSGE](#Ejecucióneconómica(UMSGIESBSGE)-ClasificacionSGE)
    - [Servicios](#Ejecucióneconómica(UMSGIESBSGE)-Servicios)
    - [Columnas Ejecución económica](#Ejecucióneconómica(UMSGIESBSGE)-ColumnasEjecucióneconómica)
      * [Ejecución presupuestaria - Estado actual](#Ejecucióneconómica(UMSGIESBSGE)-Ejecuciónpresupuestaria-Estadoactual)
      * [Ejecución presupuestaria - Gastos](#Ejecucióneconómica(UMSGIESBSGE)-Ejecuciónpresupuestaria-Gastos)
      * [Ejecución presupuestaria - Ingresos](#Ejecucióneconómica(UMSGIESBSGE)-Ejecuciónpresupuestaria-Ingresos)
      * [Facturas y justificantes - Facturas y gastos](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Facturasygastos)
      * [Facturas y justificantes - Viajes y dietas](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Viajesydietas)
      * [Facturas y justificantes - Personal contratado](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Personalcontratado)
      * [Detalle operaciones - Gastos](#Ejecucióneconómica(UMSGIESBSGE)-Detalleoperaciones-Gastos)
      * [Detalle operaciones - Ingresos](#Ejecucióneconómica(UMSGIESBSGE)-Detalleoperaciones-Ingresos)
      * [Detalle operaciones - Modificaciones](#Ejecucióneconómica(UMSGIESBSGE)-Detalleoperaciones-Modificaciones)
    - [Columnas Validación de gastos](#Ejecucióneconómica(UMSGIESBSGE)-ColumnasValidacióndegastos)
    - [Campos Detalle dato económico](#Ejecucióneconómica(UMSGIESBSGE)-CamposDetalledatoeconómico)
      * [Facturas y justificantes - Facturas y gastos](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Facturasygastos.1)
      * [Facturas y justificantes - Viajes y dietas](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Viajesydietas.1)
      * [Facturas y justificantes - Personal contratado](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Personalcontratado.1)
    - [Campos Detalle dato económico - Validación de gastos](#Ejecucióneconómica(UMSGIESBSGE)-CamposDetalledatoeconómico-Validacióndegastos)
    - [Ejemplos](#Ejecucióneconómica(UMSGIESBSGE)-Ejemplos)
      * [Ejecución presupuestaria - Estado actual - Columnas (/ejecucion-economica/columnas)](#Ejecucióneconómica(UMSGIESBSGE)-Ejecuciónpresupuestaria-Estadoactual-Columnas(/ejecucion-economica/columnas))
      * [Ejecución presupuestaria - Estado actual (/ejecucion-economica)](#Ejecucióneconómica(UMSGIESBSGE)-Ejecuciónpresupuestaria-Estadoactual(/ejecucion-economica))
      * [Facturas y justificantes - Facturas y gastos - Columnas (reducida false) (/ejecucion-economica/columnas)](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Facturasygastos-Columnas(reducidafalse)(/ejecucion-economica/columnas))
      * [Facturas y justificantes - Facturas y gastos (reducida a false) (/ejecucion-economica)](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Facturasygastos(reducidaafalse)(/ejecucion-economica))
      * [Facturas y justificantes - Facturas y gastos - Detalle (/ejecucion-economica/{id})](#Ejecucióneconómica(UMSGIESBSGE)-Facturasyjustificantes-Facturasygastos-Detalle(/ejecucion-economica/{id}))
      * [Validaciones de gastos pendientes - Columnas (con reducida a true) (/gastos/columnas)](#Ejecucióneconómica(UMSGIESBSGE)-Validacionesdegastospendientes-Columnas(conreducidaatrue)(/gastos/columnas))
      * [Validaciones de gastos pendientes - Columnas (con reducida a false) (/gastos/columnas)](#Ejecucióneconómica(UMSGIESBSGE)-Validacionesdegastospendientes-Columnas(conreducidaafalse)(/gastos/columnas))
      * [Validaciones de gastos pendientes (con reducida a true) (/gastos)](#Ejecucióneconómica(UMSGIESBSGE)-Validacionesdegastospendientes(conreducidaatrue)(/gastos))
      * [Validaciones de gastos pendientes (con reducida a false) (/gastos)](#Ejecucióneconómica(UMSGIESBSGE)-Validacionesdegastospendientes(conreducidaafalse)(/gastos))
      * [Detalle gasto (/gastos/{id})](#Ejecucióneconómica(UMSGIESBSGE)-Detallegasto(/gastos/{id}))
