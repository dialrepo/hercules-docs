# Proyecto SGE y presupuesto (UM - SGI - ESB - SGE)

---

* [Proyecto SGE y presupuesto](#ProyectoSGEypresupuesto(UMSGIESBSGE)-ProyectoSGEypresupuesto)
  + [Entidades](#ProyectoSGEypresupuesto(UMSGIESBSGE)-Entidades)
  + [Modelo lógico](#ProyectoSGEypresupuesto(UMSGIESBSGE)-Modelológico)
  + - [Definición de los objetos](#ProyectoSGEypresupuesto(UMSGIESBSGE)-Definicióndelosobjetos)
      * [Proyecto](#ProyectoSGEypresupuesto(UMSGIESBSGE)-Proyecto)
      * [PresupuestoAnualidadPartida](#ProyectoSGEypresupuesto(UMSGIESBSGE)-PresupuestoAnualidadPartida)
      * [CodigoEconomicoGasto](#ProyectoSGEypresupuesto(UMSGIESBSGE)-CodigoEconomicoGasto)
      * [CodigoEconomicoIngreso](#ProyectoSGEypresupuesto(UMSGIESBSGE)-CodigoEconomicoIngreso)
      * [TipoFondo](#ProyectoSGEypresupuesto(UMSGIESBSGE)-TipoFondo)
    - [Servicios](#ProyectoSGEypresupuesto(UMSGIESBSGE)-Servicios)
...
| --- | --- | --- |
| **Nombre** | **Tipo** | **Descripción** |
| id | String | Cadena numérica o alfanumérica que identifica al tipo de fondo |
| nombre | String | Nombre o descripción del tipo de fondo europeo |
| programaObligatorio | Booleano | Valores:   * true * false   Indica si es necesario enviar el campo "programa/localizador" en el formulario de alta del proyecto económico |

**TipoFondo** Ampliar origen

```
{
"id": "RE",
"nombre": "AYUDA A LA RECUPERACIÓN PARA LA COHESIÓN Y LOS TERRITORIOS DE EUROPA",  
"programaObligatorio": true
}
```
...
| GET | /tipos-fondos |  | Lista[TipoFondo] |  | Servicio usado en el formulario de alta de proyecto económico.  Devuelve el listado de los tipos de fondo que se deberá de mostrar en el campo "Tipo de fondo europeo" del formulario de alta de proyecto económico.  Por cada tipo de fondo se devuelve los campos:   * identificador * nombre * programa obligatorio: Si el valor es "true" se necesitará indicar en el alta del proyecto económico el campo "programa/localizador". |
|  | | | | | |
