...
* [Sistema de gestión de empresas](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-Sistemadegestióndeempresas)
  ...
  + [API](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-API)
    - [Definición de los objetos](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-Definicióndelosobjetos)
      * [Empresa](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-Empresa)
      * [TipoIdentificador](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-TipoIdentificador)
      * [DatosTipoEmpresa](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-DatosTipoEmpresa)
      * [TipoTercero](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-TipoTercero)
      * [TipoEmpresa](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-TipoEmpresa)
      * [TipoEmpresaContabilidad](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-TipoEmpresaContabilidad)
      * [TipoTerceroReinoUnido](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-TipoTerceroReinoUnido)
      * [EmpresaClasificacion](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-EmpresaClasificacion)
      * [DatosContacto](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-DatosContacto)
    - [Servicios](#SistemaGestióndeOrganizaciones(UMSGIESBSGO)-Servicios)
