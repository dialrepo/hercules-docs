# ED y MA. Integraciones.

* [Arquitectura de integración con Hércules ED y MA](#EDyMA.Integraciones.-ArquitecturadeintegraciónconHérculesEDyMA)
* [ED - Enriquecimiento de datos. Servicios de integración y carga de datos.](#EDyMA.Integraciones.-ED-Enriquecimientodedatos.Serviciosdeintegraciónycargadedatos.)
  + [Personal investigador (Sistema de Gestión de Personas)](#EDyMA.Integraciones.-Personalinvestigador(SistemadeGestióndePersonas))
  + [Proyectos (Gestión de Proyectos)](#EDyMA.Integraciones.-Proyectos(GestióndeProyectos))
  + [Grupos (Grupos de Investigación)](#EDyMA.Integraciones.-Grupos(GruposdeInvestigación))
  + [Patentes (Protección Industrial e Intelectual)](#EDyMA.Integraciones.-Patentes(ProtecciónIndustrialeIntelectual))
  + [Sistema de Gestión de Empresas](#EDyMA.Integraciones.-SistemadeGestióndeEmpresas)
  + [Formación Académica](#EDyMA.Integraciones.-FormaciónAcadémica)
  + [Actividad Docente](#EDyMA.Integraciones.-ActividadDocente)
* [ED - Enriquecimiento de datos. Servicios de flujos de validación de información.](#EDyMA.Integraciones.-ED-Enriquecimientodedatos.Serviciosdeflujosdevalidacióndeinformación.)
* [MA - Métodos de Análisis. Servicios de integración y carga de datos.](#EDyMA.Integraciones.-MA-MétodosdeAnálisis.Serviciosdeintegraciónycargadedatos.)
  + [Personal investigador (Sistema de Gestión de Personas)](#EDyMA.Integraciones.-Personalinvestigador(SistemadeGestióndePersonas).1)
  + [Proyectos (Gestión de Proyectos)](#EDyMA.Integraciones.-Proyectos(GestióndeProyectos).1)
  + [Grupos (Grupos de Investigación)](#EDyMA.Integraciones.-Grupos(GruposdeInvestigación).1)
  + [Patentes (Protección Industrial e Intelectual)](#EDyMA.Integraciones.-Patentes(ProtecciónIndustrialeIntelectual).1)
  + [Sistema de Gestión de Empresas](#EDyMA.Integraciones.-SistemadeGestióndeEmpresas.1)
...
Hércules ED y Hércules MA ejecutan procesos de  *harvesting* utilizando el protocolo [OAI-PMH (Open Archive Initiative - Protocol for Metadata Harvesting)](http://openarchives.org/pmh/) contra un *data provider* que obtiene la información de los servicios que enumeramos en los siguientes apartados.
...
Se puede consultar una información técnica del *data provider* OAI-PMH en el repositorio GitHub del proyecto: [HerculesED/src/Hercules.ED.OAI\_PMH](https://github.com/HerculesCRUE/HerculesED/tree/main/src/Hercules.ED.OAI_PMH)
...
### [Personal investigador (Sistema de Gestión de Personas)](/hercules/apis-de-integracion/sgi-servicios-de-terceros-que-expone/sistema-de-gestion-de-personas)
...
### [Proyectos (Gestión de Proyectos)](/hercules/apis-de-integracion/sgi-servicios-propios-que-expone/gestion-proyectos)
...
### [Grupos (Grupos de Investigación)](/hercules/apis-de-integracion/sgi-servicios-propios-que-expone/sgi-grupos-de-investigacion)
...
### [Patentes (Protección Industrial e Intelectual)](/hercules/apis-de-integracion/sgi-servicios-propios-que-expone/proteccion-industrial-e-intelectual-patentes)
...
### [Sistema de Gestión de Empresas](https://confluence.um.es/confluence/pages/viewpage.action?pageId=421003313)
...
### [Formación Académica](https://confluence.um.es/confluence/pages/viewpage.action?pageId=421003309)
...
### [Actividad Docente](https://confluence.um.es/confluence/pages/viewpage.action?pageId=421003309)
