# SGI - Grupos de investigación

---

* [Sistema de Gestión Investigación](#SGIGruposdeinvestigación-SistemadeGestiónInvestigación)
  + [Entidades](#SGIGruposdeinvestigación-Entidades)
  + [API](#SGIGruposdeinvestigación-API)
    - [Definición de los objetos](#SGIGruposdeinvestigación-Definicióndelosobjetos)
      * [Grupo](#SGIGruposdeinvestigación-Grupo)
      * [GrupoEquipo](#SGIGruposdeinvestigación-GrupoEquipo)
      * [RolProyecto](#SGIGruposdeinvestigación-RolProyecto)
      * [GrupoPalabraClave](#SGIGruposdeinvestigación-GrupoPalabraClave)
    - [Servicios](#SGIGruposdeinvestigación-Servicios)
...
| --- | --- | --- | --- | --- |
| GET | /grupos/modificados-ids | q+s  La query estará formada por:   * fechaModificacion | Lista[Long] | Listado de Identificadores de Grupo activos que han sido modificados en los datos generales (tabla GRUPO) o en algunas de las siguientes tablas con las que se relaciona:   * GRUPO\_EQUIPO * GRUPO\_PALABRA\_CLAVE * GRUPO\_ENLACE * GRUPO\_RESPONSABLE\_ECONOMICO * GRUPO\_EQUIPO\_INSTRUMENTAL * GRUPO\_LINEA\_INVESTIGACION * GRUPO\_LINEA\_INVESTIGADOR * GRUPO\_LINEA\_CLASIFICACION   Se utilizarán los siguiente parámetros en la llamada al servicio   * fechaModificacion: se le pasará la fecha a partir de la cual se quieren ver los cambios   Ejemplo:   * fechaModificacion=ge="2021-08-18T22:00:00Z" |
