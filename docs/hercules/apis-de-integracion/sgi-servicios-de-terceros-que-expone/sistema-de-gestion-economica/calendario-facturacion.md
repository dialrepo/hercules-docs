...
* [Ejecución económica](#Calendariofacturación-Ejecucióneconómica)
  + [Entidades](#Calendariofacturación-Entidades)
  + [Modelo lógico](#Calendariofacturación-Modelológico)
  + [API](#Calendariofacturación-API)
    - [Definición de los objetos](#Calendariofacturación-Definicióndelosobjetos)
      * [FacturaEmitida](#Calendariofacturación-FacturaEmitida)
      * [FacturaEmitidaDetalle](#Calendariofacturación-FacturaEmitidaDetalle)
      * [Detalle](#Calendariofacturación-Detalle)
      * [Columna](#Calendariofacturación-Columna)
      * [Documento](#Calendariofacturación-Documento)
      * [FacturaPrevista](#Calendariofacturación-FacturaPrevista)
      * [FacturaPrevistaEmitida](#Calendariofacturación-FacturaPrevistaEmitida)
    - [Columnas Facturas emitidas](#Calendariofacturación-ColumnasFacturasemitidas)
    - [Campos Factura emitida](#Calendariofacturación-CamposFacturaemitida)
    - [Ejemplos](#Calendariofacturación-Ejemplos)
      * [Columnas Facturas emitidas (/facturas-emitidas/columnas)](#Calendariofacturación-ColumnasFacturasemitidas(/facturas-emitidas/columnas))
      * [Facturas emitidas (/facturas-emitidas)](#Calendariofacturación-Facturasemitidas(/facturas-emitidas))
      * [Detalle factura emitida (/facturas-emitidas/{id})](#Calendariofacturación-Detallefacturaemitida(/facturas-emitidas/{id}))
      * [Facturas previstas (/facturas-previstas)](#Calendariofacturación-Facturasprevistas(/facturas-previstas))
      * [Detalle Factura prevista (/facturas-previstas)](#Calendariofacturación-DetalleFacturaprevista(/facturas-previstas))
      * [Consulta facturas previstas de emitir (/facturas-previstas-emitidas)](#Calendariofacturación-Consultafacturasprevistasdeemitir(/facturas-previstas-emitidas))
