...
* [Ejecución económica](#Ejecucióneconómica-Ejecucióneconómica)
  + [Entidades](#Ejecucióneconómica-Entidades)
  + [Enumerados](#Ejecucióneconómica-Enumerados)
  + [Modelo lógico](#Ejecucióneconómica-Modelológico)
  + [API](#Ejecucióneconómica-API)
    - [Definición de los objetos](#Ejecucióneconómica-Definicióndelosobjetos)
      * [DatoEconomico](#Ejecucióneconómica-DatoEconomico)
      * [DatoEconomicoDetalle](#Ejecucióneconómica-DatoEconomicoDetalle)
      * [Columna](#Ejecucióneconómica-Columna)
      * [Documento](#Ejecucióneconómica-Documento)
      * [Comentario](#Ejecucióneconómica-Comentario)
      * [ClasificacionSGE](#Ejecucióneconómica-ClasificacionSGE)
    - [Columnas Ejecución económica](#Ejecucióneconómica-ColumnasEjecucióneconómica)
      * [Ejecución presupuestaria - Estado actual](#Ejecucióneconómica-Ejecuciónpresupuestaria-Estadoactual)
      * [Ejecución presupuestaria - Gastos](#Ejecucióneconómica-Ejecuciónpresupuestaria-Gastos)
      * [Ejecución presupuestaria - Ingresos](#Ejecucióneconómica-Ejecuciónpresupuestaria-Ingresos)
      * [Facturas y justificantes - Facturas y gastos](#Ejecucióneconómica-Facturasyjustificantes-Facturasygastos)
      * [Facturas y justificantes - Viajes y dietas](#Ejecucióneconómica-Facturasyjustificantes-Viajesydietas)
      * [Facturas y justificantes - Personal contratado](#Ejecucióneconómica-Facturasyjustificantes-Personalcontratado)
      * [Detalle operaciones - Gastos](#Ejecucióneconómica-Detalleoperaciones-Gastos)
      * [Detalle operaciones - Ingresos](#Ejecucióneconómica-Detalleoperaciones-Ingresos)
      * [Detalle operaciones - Modificaciones](#Ejecucióneconómica-Detalleoperaciones-Modificaciones)
    - [Columnas Validación de gastos](#Ejecucióneconómica-ColumnasValidacióndegastos)
    - [Campos Detalle dato económico](#Ejecucióneconómica-CamposDetalledatoeconómico)
      * [Facturas y justificantes - Facturas y gastos](#Ejecucióneconómica-Facturasyjustificantes-Facturasygastos.1)
      * [Facturas y justificantes - Viajes y dietas](#Ejecucióneconómica-Facturasyjustificantes-Viajesydietas.1)
      * [Facturas y justificantes - Personal contratado](#Ejecucióneconómica-Facturasyjustificantes-Personalcontratado.1)
    - [Campos Detalle dato económico - Validación de gastos](#Ejecucióneconómica-CamposDetalledatoeconómico-Validacióndegastos)
    - [Ejemplos](#Ejecucióneconómica-Ejemplos)
      * [Ejecución presupuestaria - Estado actual - Columnas (/ejecucion-economica/columnas)](#Ejecucióneconómica-Ejecuciónpresupuestaria-Estadoactual-Columnas(/ejecucion-economica/columnas))
      * [Ejecución presupuestaria - Estado actual (/ejecucion-economica)](#Ejecucióneconómica-Ejecuciónpresupuestaria-Estadoactual(/ejecucion-economica))
      * [Facturas y justificantes - Facturas y gastos - Columnas (reducida false) (/ejecucion-economica/columnas)](#Ejecucióneconómica-Facturasyjustificantes-Facturasygastos-Columnas(reducidafalse)(/ejecucion-economica/columnas))
      * [Facturas y justificantes - Facturas y gastos (reducida a false) (/ejecucion-economica)](#Ejecucióneconómica-Facturasyjustificantes-Facturasygastos(reducidaafalse)(/ejecucion-economica))
      * [Facturas y justificantes - Facturas y gastos - Detalle (/ejecucion-economica/{id})](#Ejecucióneconómica-Facturasyjustificantes-Facturasygastos-Detalle(/ejecucion-economica/{id}))
      * [Validaciones de gastos pendientes - Columnas (con reducida a true) (/gastos/columnas)](#Ejecucióneconómica-Validacionesdegastospendientes-Columnas(conreducidaatrue)(/gastos/columnas))
      * [Validaciones de gastos pendientes - Columnas (con reducida a false) (/gastos/columnas)](#Ejecucióneconómica-Validacionesdegastospendientes-Columnas(conreducidaafalse)(/gastos/columnas))
      * [Validaciones de gastos pendientes (con reducida a true) (/gastos)](#Ejecucióneconómica-Validacionesdegastospendientes(conreducidaatrue)(/gastos))
      * [Validaciones de gastos pendientes (con reducida a false) (/gastos)](#Ejecucióneconómica-Validacionesdegastospendientes(conreducidaafalse)(/gastos))
      * [Detalle gasto (/gastos/{id})](#Ejecucióneconómica-Detallegasto(/gastos/{id}))
