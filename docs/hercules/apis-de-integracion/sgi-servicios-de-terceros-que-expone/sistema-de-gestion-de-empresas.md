...
* [Sistema de gestión de empresas](#Sistemadegestióndeempresas-Sistemadegestióndeempresas)
  + [Entidades](#Sistemadegestióndeempresas-Entidades)
  + [Modelo lógico](#Sistemadegestióndeempresas-Modelológico)
  + [API](#Sistemadegestióndeempresas-API)
    - [Definición de los objetos](#Sistemadegestióndeempresas-Definicióndelosobjetos)
      * [Empresa](#Sistemadegestióndeempresas-Empresa)
      * [TipoIdentificador](#Sistemadegestióndeempresas-TipoIdentificador)
      * [DatosContacto](#Sistemadegestióndeempresas-DatosContacto)
    - [Servicios](#Sistemadegestióndeempresas-Servicios)
...
| GET | /empresas/modificadas-ids | q+s  La query estará formada por:   * fechaModificacion | Lista[String] | Listado de los identificadores de empresas que han sufrido cambios en los datos de identificativos de la empresa o en sus datos de contacto. |