...
* [Sistema de Gestión Personas](#Sistemadegestióndepersonas-SistemadeGestiónPersonas)
  + [Entidades](#Sistemadegestióndepersonas-Entidades)
  + [Enumerados](#Sistemadegestióndepersonas-Enumerados)
  + [Modelo lógico](#Sistemadegestióndepersonas-Modelológico)
    - [Definición de los objetos](#Sistemadegestióndepersonas-Definicióndelosobjetos)
      * [Persona](#Sistemadegestióndepersonas-Persona)
      * [Sexo](#Sistemadegestióndepersonas-Sexo)
      * [TipoDocumento](#Sistemadegestióndepersonas-TipoDocumento)
      * [Email](#Sistemadegestióndepersonas-Email)
      * [DatosPersonales](#Sistemadegestióndepersonas-DatosPersonales)
      * [DatosContacto](#Sistemadegestióndepersonas-DatosContacto)
      * [Vinculacion](#Sistemadegestióndepersonas-Vinculacion)
      * [VinculacionCategoriaProfesional](#Sistemadegestióndepersonas-VinculacionCategoriaProfesional)
      * [CategoriaProfesional](#Sistemadegestióndepersonas-CategoriaProfesional)
      * [DatosAcademicos](#Sistemadegestióndepersonas-DatosAcademicos)
      * [NivelAcademico](#Sistemadegestióndepersonas-NivelAcademico)
      * [Colectivo](#Sistemadegestióndepersonas-Colectivo)
      * [Fotografia](#Sistemadegestióndepersonas-Fotografia)
      * [Sexenio](#Sistemadegestióndepersonas-Sexenio)
      * [DireccionTesis](#Sistemadegestióndepersonas-DireccionTesis)
      * [TipoTrabajoDirigido](#Sistemadegestióndepersonas-TipoTrabajoDirigido)
    - [Servicios](#Sistemadegestióndepersonas-Servicios)
...
| Colectivo | Listado de colectivos que tiene la Universidad, sirvan como ejemplos de colectivos "personal de investigación", "personal de administración" ,"alumnos". Agrupación de personas sobre las que se van a realizar las búsquedas de personas ([RELACIONES VIGENTES UM.xlsx](/attachments/598147539/748847120.xlsx)). |
...
| Nombre | Tipo | Descripción |
| --- | --- | --- |
| paisContacto | Pais | Se devuelve la entidad Pais con todos sus campos. Ver definición en [SGI - ESB - SGO](/confluence/pages/createpage.action?spaceKey=TEMP001&title=SGI+-+ESB+-+SGO). |
| comAutonomaContacto | ComunidadAutonoma | Se devuelve la entidad ComunidadAutonoma con todos sus campos. Ver definición en [SGI - ESB - SGO](/confluence/pages/createpage.action?spaceKey=TEMP001&title=SGI+-+ESB+-+SGO). |
| provinciaContacto | Provincia | Se devuelve la entidad Provincia con todos sus campos. Ver definición en [SGI - ESB - SGO](/confluence/pages/createpage.action?spaceKey=TEMP001&title=SGI+-+ESB+-+SGO). |
...
| GET | /personas/formly/create |  | Formly |  | Devuelve el formulario (formly) a pintar para la pantalla de solicitar alta persona. Ver  [IU-GEN-0061- Solicitar alta de persona](/confluence/pages/createpage.action?spaceKey=TEMP001&title=IU-GEN-0061-+Solicitar+alta+de+persona). |
...
| GET | /formacion/{id} | tipoFormacion | Lista[Formación (del tipo solicitado)]  Ver entidades en <https://confluence.um.es/confluence/pages/viewpage.action?pageId=397534658> |  | Detalle sobre los datos de la Formación Recibida, dependiendo del ID de la persona y el tipo de formación.  Se utilizará el siguiente parámetro en la llamada al servicio:   * tipoFormacion: se le pasa el tipo de formación que se quiere recuperar, usando los códigos de CVN   Ejemplo:   * /formacion/22468643?tipoFormacion="020.050.000.000" |
|  | | | | | |
