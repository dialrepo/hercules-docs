...
* [Sistema de Gestión Económica de Protección Industrial e Intelectual](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-SistemadeGestiónEconómicadeProtecciónIndustrialeIntelectual)
  + [Entidades](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Entidades)
  + [Enumerados](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Enumerados)
  + [Modelo lógico](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Modelológico)
    - [Definición de los objetos](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Definicióndelosobjetos)
      * [Invencion](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Invencion)
      * [DatoEconomico](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-DatoEconomico)
      * [DatoEconomicoDetalle](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-DatoEconomicoDetalle)
      * [Columna](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Columna)
      * [Documento (se reutilizaría el mismo que el definido en UM - SGI - ESB - SGE - Ejecución económica)](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Documento(sereutilizaríaelmismoqueeldefinidoenUM-SGI-ESB-SGE-Ejecucióneconómica))
    - [Servicios](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Servicios)
    - [Columnas Ingresos](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-ColumnasIngresos)
    - [Ejemplos](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Ejemplos)
      * [Columnas de gastos (/gastos-invencion/columnas)](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Columnasdegastos(/gastos-invencion/columnas))
      * [Gastos (/gastos-invencion)](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Gastos(/gastos-invencion))
      * [Detalle gasto (/gastos-invencion/{id})](#Sistemadegestióneconómicadeprotecciónindustrialeintelectual-Detallegasto(/gastos-invencion/{id}))
...
Hay entidades que se reutilizan del modelo de Ejecución económica del SGE y pero se repiten aquí por claridad aunque ya están descritas en el API del SGE: [SGI - ESB - SGE - Ejecución económica](https://confluence.treelogic.com/pages/viewpage.action?pageId=103905017).
...
Hay objetos que se reutilizan del modelo de Ejecución económica del SGE y por tanto no se repiten aquí, están descritos en el API del SGE:  [UM - SGI - ESB - SGE - Ejecución económica](https://confluence.treelogic.com/pages/viewpage.action?pageId=108604695).
...
##### Documento (se reutilizaría el mismo que el definido en [UM - SGI - ESB - SGE - Ejecución económica](https://confluence.treelogic.com/pages/viewpage.action?pageId=108604695))
...
Hay servicios a los que no se hace mención en este API porque la funcionalidad que los precisa, por ejemplo, la recuperación del binario de cada documento asociado a un gasto, ha de reutilizar los que ya están definidos en el modelo de Ejecución económica del SGE y por tanto no se repiten aquí, están descritos en el API del SGE: [UM - SGI - ESB - SGE - Ejecución económica](https://confluence.treelogic.com/pages/viewpage.action?pageId=108604695).
